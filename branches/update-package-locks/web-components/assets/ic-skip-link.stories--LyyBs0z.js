var r=Object.freeze,m=Object.defineProperty;var l=(e,p)=>r(m(e,"raw",{value:r(p||e.slice())}));import{x as n}from"./lit-html-CWQq0DyO.js";const d={title:"Web Components/Skip link",component:"ic-skip-link"},t={render:()=>n`<ic-skip-link target="page-content"></ic-skip-link>
      ...
      <ic-button>Should receive next focus</ic-button>`,name:"Default"},i={render:()=>n`<ic-skip-link target="page-content" full-width="true"></ic-skip-link>
      <ic-top-navigation app-title="Application Name">
        <svg
          slot="app-icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <main id="page-content">Target element</main>
      <ic-button>Should receive next focus</ic-button>`,name:"Full width"};var u;const a={render:()=>n(u||(u=l([`<div style="display: flex; flex-direction: column; min-height: 100vh;">
        <div
          id="cookie-banner"
      ...
      <\/script>`]))),name:"Custom top position",parameters:{layout:"fullscreen"}},o={render:()=>n`<ic-skip-link target="page-content"></ic-skip-link>
      <div>
        ...
        <ic-footer
          ...
          caption="All content is available under the Open Government Licence v3.0, except source code and code examples which are available under the MIT Licence."
        ></ic-footer>
      </div>`,name:"Inline",parameters:{layout:"fullscreen"}},c={render:()=>n`<ic-skip-link
        target="page-content"
      ...
      <main id="page-content">Target element</main>
      <ic-button>Should receive next focus</ic-button>`,name:"Hide background"},g={fullWidth:!1,inline:!1,label:"Skip to main content",monochrome:!1,target:"",theme:"inherit",transparentBackground:!1},s={render:e=>n`<ic-skip-link
      ...
      <ic-button>Should receive next focus</ic-button>`,args:g,argTypes:{theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...s.parameters?.docs?.source}}};const v=["Default","FullWidth","CustomTopPosition","Inline","HideBackground","Playground"],k=Object.freeze(Object.defineProperty({__proto__:null,CustomTopPosition:a,Default:t,FullWidth:i,HideBackground:c,Inline:o,Playground:s,__namedExportsOrder:v,default:d},Symbol.toStringTag,{value:"Module"}));export{k as I};
