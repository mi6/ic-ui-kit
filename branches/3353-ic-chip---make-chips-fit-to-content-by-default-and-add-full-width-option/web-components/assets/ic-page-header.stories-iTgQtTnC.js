import{x as t}from"./lit-html-CWQq0DyO.js";const x={aligned:"left",border:!0,heading:"Latte recipe","reverse-order":!1,size:"medium",sticky:!1,"sticky-desktop-only":!1,subheading:"A Latte is a popular Italian coffee, made with espresso, steamed milk and a thin layer of foam.",theme:"inherit","--ic-page-header-text-primary":"","--ic-page-header-background":"","--ic-page-header-border":"","--ic-page-header-text-tertiary":"","--ic-page-header-placeholder-text-field":""},S={title:"Web Components/Page header",component:"ic-page-header",parameters:{layout:"fullscreen"}},a={render:e=>t`<ic-page-header
        aligned=${e.aligned}
        border=${e.border}
        heading=${e.heading}
      ...
      <ic-section-container aligned=${e.aligned}>
        ...
        <ic-typography
          ...
          ante non diam sodales hendrerit.</ic-typography
        >
      </ic-section-container>`,args:x,name:"Playground",parameters:{layout:"fullscreen"},argTypes:{aligned:{options:["center","full-width","left"],control:{type:"inline-radio"}},size:{options:["medium","small"],control:{type:"inline-radio"}},theme:{options:["inherit","dark","light"],control:{type:"radio"}},"--ic-page-header-text-primary":{control:{type:"color"}},"--ic-page-header-background":{control:{type:"color"}},"--ic-page-header-border":{control:{type:"color"}},"--ic-page-header-text-tertiary":{control:{type:"color"}},"--ic-page-header-placeholder-text-field":{control:{type:"color"}}}},i={render:()=>t`
    <ic-page-header heading="Page header">
      <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>
    </ic-page-header>
  `,name:"Heading with adornment"},n={render:()=>t`
    <ic-page-header
      aligned="left"
      heading="Page header"
  ...
  `,name:"Small"},o={render:()=>t`
    <ic-page-header heading="Page header" border="false">
      <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>
    </ic-page-header>
  `,name:"Without border"},s={render:()=>t`
    <ic-page-header
      aligned="center"
      heading="Page header"
      subheading="This is a simple page header component and this is the text."
  ...
  `,name:"Center aligned"},c={render:()=>t`
    <ic-page-header
      aligned="full-width"
      heading="Page header"
      subheading="This is a simple page header component and this is the text."
  ...
  `,name:"Sticky with content and footer"},p={render:()=>t`
    <ic-top-navigation app-title="ApplicationName">
      <svg
        slot="app-icon"
        xmlns="http://www.w3.org/2000/svg"
  ...
  `,name:"Sticky for large and extra-large breakpoints only"},h={render:()=>t`
    <ic-page-header
      heading="Page header"
  ...
  `,name:"With breadcrumbs"},u={render:()=>t`
    <ic-page-header
      heading="Page header"
      subheading="This is a page header component with additional functionality and this is the text."
      reverse-order
  ...
  `,name:"With breadcrumbs, input, actions and tabs"},f={render:()=>t`
    <ic-page-header
      heading="Coffee recipes"
  ...
  `,name:"With breadcrumbs, input, actions and stepper"},v={render:()=>t`
    <ic-page-header>
  ...
  `,name:"Component overrides"},w={render:()=>t`
    <ic-page-header
  ...
  `,name:"With breadcrumbs, input, actions and stepper and long title"},k={render:()=>t`
    <ic-page-header
      heading="Coffee recipes"
      subheading="This is a page header component that has breadcrumbs, an input area, actions & stepper."
      reverse-order="true"
  ...
  `,name:"Dark theme"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  ...
  \`,
  name: "Dark theme"
}`,...k.parameters?.docs?.source}}};const H=["Playground","HeadingWithAdornment","LeftAligned","Small","WithoutBorder","CenterAligned","FullWidth","Sticky","StickyWithContentAndFooter","StickyForLargeAndExtraLargeBreakpointsOnly","WithBreadcrumbs","WithActions","WithInput","WithStepper","WithTabs","WithBreadcrumbsInputActionsAndTabs","WithBreadcrumbsInputActionsAndStepper","ComponentOverrides","WithBreadcrumbsInputActionsAndStepperAndLongTitle","DarkTheme"],B=Object.freeze(Object.defineProperty({__proto__:null,CenterAligned:s,ComponentOverrides:v,DarkTheme:k,FullWidth:c,HeadingWithAdornment:i,LeftAligned:n,Playground:a,Small:r,Sticky:d,StickyForLargeAndExtraLargeBreakpointsOnly:p,StickyWithContentAndFooter:l,WithActions:u,WithBreadcrumbs:h,WithBreadcrumbsInputActionsAndStepper:f,WithBreadcrumbsInputActionsAndStepperAndLongTitle:w,WithBreadcrumbsInputActionsAndTabs:y,WithInput:g,WithStepper:m,WithTabs:b,WithoutBorder:o,__namedExportsOrder:H,default:S},Symbol.toStringTag,{value:"Module"}));export{B as I};
