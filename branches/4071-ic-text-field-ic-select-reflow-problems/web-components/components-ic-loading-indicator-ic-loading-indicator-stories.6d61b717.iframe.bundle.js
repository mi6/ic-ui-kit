...
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[4479,582,6199,6763],{"./src/components/ic-loading-indicator/ic-loading-indicator.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{ChangingLabel:()=>ChangingLabel,CircularDarkMode:()=>CircularDarkMode,CircularDeterminate:()=>CircularDeterminate,CircularIndeterminate:()=>CircularIndeterminate,CircularLongLabel:()=>CircularLongLabel,CircularVariantsDeterminate:()=>CircularVariantsDeterminate,CircularVariantsIndeterminate:()=>CircularVariantsIndeterminate,Icon:()=>Icon,IconDarkMode:()=>IconDarkMode,LinearDarkMode:()=>LinearDarkMode,LinearDeterminate:()=>LinearDeterminate,LinearIndeterminate:()=>LinearIndeterminate,LinearLongLabel:()=>LinearLongLabel,LinearVariantsDeterminate:()=>LinearVariantsDeterminate,LinearVariantsIndeterminate:()=>LinearVariantsIndeterminate,Monochrome:()=>Monochrome,NoLabel:()=>NoLabel,PlaygroundDeterminate:()=>PlaygroundDeterminate,PlaygroundIndeterminate:()=>PlaygroundIndeterminate,ProgressIndicatorForCompactStep:()=>ProgressIndicatorForCompactStep,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const defaultArgs={monochrome:!1,description:"Loading",fullWidth:!1,labelDuration:8e3,size:"medium",type:"linear",label:null,theme:"inherit"},defaultArgTypes={label:{control:{type:"text"}},size:{options:["small","medium","large","icon"],control:{type:"radio"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}},type:{options:["circular","linear"],control:{type:"radio"}}},__WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Loading",component:"ic-loading-indicator"},CircularIndeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator label="Loading..."></ic-loading-indicator>`,name:"Circular (indeterminate)"},CircularDeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator
    ...
    ></ic-loading-indicator>`,name:"Circular long label"},CircularVariantsIndeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
    ...
    </div>`,name:"Circular variants (indeterminate)"},CircularVariantsDeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      ...
      <ic-loading-indicator
        ...
        size="large"
      ></ic-loading-indicator>
    </div>`,name:"Circular variants (determinate)"},Icon={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator size="icon"></ic-loading-indicator>`,name:"Icon"},LinearIndeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator
      label="Loading..."
      type="linear"
    ></ic-loading-indicator>`,name:"Linear (indeterminate)"},LinearDeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator
      progress="30"
      min="0"
      max="100"
      label="Progress"
      type="linear"
    ></ic-loading-indicator>`,name:"Linear (determinate)"},LinearLongLabel={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator
      type="linear"
      label="This is a label for a loading indicator that is indeterminate and should wrap onto more than one line when it gets too long"
    ></ic-loading-indicator>`,name:"Linear long label"},LinearVariantsIndeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      <ic-loading-indicator
        label="Small"
        size="small"
        type="linear"
      ...
      <ic-loading-indicator
        ...
        full-width="true"
      ></ic-loading-indicator>
    </div>`,name:"Linear variants (indeterminate)"},LinearVariantsDeterminate={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      <ic-loading-indicator
        progress="30"
        min="0"
        max="100"
      ...
      <ic-loading-indicator
        ...
        full-width="true"
      ></ic-loading-indicator>
    </div>`,name:"Linear variants (determinate)"},CircularDarkMode={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      <ic-loading-indicator
        label="Small"
        size="small"
        theme="dark"
      ...
      <ic-loading-indicator
        ...
        theme="dark"
      ></ic-loading-indicator>
    </div>`,name:"Circular dark mode",parameters:{backgrounds:{default:"dark"}}},IconDarkMode={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator
      size="icon"
      theme="dark"
    ></ic-loading-indicator>`,name:"Icon dark mode",parameters:{backgrounds:{default:"dark"}}},LinearDarkMode={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      <ic-loading-indicator
        label="Default"
        type="linear"
        theme="dark"
      ...
      <ic-loading-indicator
        ...
        theme="dark"
      ></ic-loading-indicator>
    </div>`,name:"Linear dark mode",parameters:{backgrounds:{default:"dark"}}},Monochrome={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      <ic-loading-indicator
        label="Light"
        monochrome="true"
      ></ic-loading-indicator>
    ...
    </div>`,name:"Monochrome"},NoLabel={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display: grid; gap: 50px;">
      ...
      ><ic-loading-indicator
        ...
        type="linear"
      ></ic-loading-indicator>
    </div>`,name:"No label"},ChangingLabel={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-loading-indicator label-duration="4000"></ic-loading-indicator>
      <script>
    ...
    ></ic-loading-indicator>`,name:"Progress indicator for compact step",args:defaultArgs,argTypes:defaultArgTypes},PlaygroundIndeterminate={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div
      style="background-color: ${"dark"===args.theme?"var(--ic-color-page-background-dark)":"var(--ic-color-page-background-light)"}; padding: 16px;"
    >
      <ic-loading-indicator
