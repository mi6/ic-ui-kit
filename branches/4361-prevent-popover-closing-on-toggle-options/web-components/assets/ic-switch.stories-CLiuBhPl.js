var p=Object.freeze,f=Object.defineProperty;var u=(t,g)=>p(f(t,"raw",{value:p(g||t.slice())}));import{b as e}from"./lit-html-B6sBSybp.js";const L={label:"Custom Switch",helperText:"Custom helper text",disabled:!1,checked:!1,hideLabel:!1,size:"medium",theme:"inherit"},S={title:"Web Components/Switch",component:"ic-switch"},a={render:()=>e` <ic-switch label="Label"></ic-switch> `,name:"Default"},r={render:()=>e` <ic-switch label="Label"></ic-switch> `,name:"Name"},n={render:()=>e` <ic-switch checked="true" label="Label"></ic-switch> `,name:"Checked"},i={render:()=>e`
