var b=Object.freeze,V=Object.defineProperty;var n=(e,S)=>b(V(e,"raw",{value:b(S||e.slice())}));import{b as i}from"./lit-html-B6sBSybp.js";const F={open:!0,groupLabel:"View",description:"",disabled:!1,href:"/",keyboardShortcutLabel:"Cmd + C",label:"Copy code",variant:"default",iconSlot:!0,theme:"inherit"},L={title:"Web Components/Popover menu",component:"Popover Menu"};var v;const o={render:()=>i(v||(v=n([`
  ...
  name: "Playground"
}`,...d.parameters?.docs?.source}}};const M=["Default","MenuOnToggle","MenuNeverCloses","MaxHeight","LeftPlacement","TopPlacement","MultiplePopoversOnPage","AutoOpening","PositioningStrategy","SlottedAnchor","Playground"],Z=Object.freeze(Object.defineProperty({__proto__:null,AutoOpening:a,Default:o,LeftPlacement:u,MaxHeight:m,MenuNeverCloses:c,MenuOnToggle:t,MultiplePopoversOnPage:r,Playground:d,PositioningStrategy:p,SlottedAnchor:s,TopPlacement:l,__namedExportsOrder:M,default:L},Symbol.toStringTag,{value:"Module"}));export{Z as I};
