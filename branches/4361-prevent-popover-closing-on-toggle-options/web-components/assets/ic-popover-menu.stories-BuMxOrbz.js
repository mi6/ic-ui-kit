var s=Object.freeze,y=Object.defineProperty;var n=(e,k)=>s(y(e,"raw",{value:s(k||e.slice())}));import{b as i}from"./lit-html-B6sBSybp.js";const x={open:!0,groupLabel:"View",description:"",disabled:!1,href:"/",keyboardShortcutLabel:"Cmd + C",label:"Copy code",variant:"default",iconSlot:!0,theme:"inherit"},P={title:"Web Components/Popover menu",component:"Popover Menu"};var d;const o={render:()=>i(d||(d=n([`
  ...
  `]))),name:"Menu Remains Open"};var v;const c={render:()=>i(v||(v=n([`
    <style>
      ic-popover-menu {
        --max-height: 100px;
      }
  ...
  `]))),name:"Max height"};var h;const m={render:()=>i(h||(h=n([`
  ...
  `]))),name:"Left placement"};var g;const u={render:()=>i(g||(g=n([`
  ...
  `]))),name:"Top placement"};var w;const l={render:()=>i(w||(w=n([` <ic-link href="/">Link1</ic-link>
      ...
      </div>`]))),name:"Multiple popovers on page"};var f;const r={render:()=>i(f||(f=n([`
    <ic-button id="button-1" onclick="buttonClick()"
      >Show/Hide popover</ic-button
    >
    <script>
  ...
  `]))),name:"Auto opening"};var C;const a={render:()=>i(C||(C=n([`
    <script>
  ...
  `]))),name:"Positioning strategy"},p={render:e=>i`<div>
      <ic-popover-menu
        aria-label="popover"
        open=${e.open}
        theme=${e.theme}
  ...
  name: "Playground"
}`,...p.parameters?.docs?.source}}};const S=["Default","MenuRemainsOpen","MaxHeight","LeftPlacement","TopPlacement","MultiplePopoversOnPage","AutoOpening","PositioningStrategy","Playground"],L=Object.freeze(Object.defineProperty({__proto__:null,AutoOpening:r,Default:o,LeftPlacement:m,MaxHeight:c,MenuRemainsOpen:t,MultiplePopoversOnPage:l,Playground:p,PositioningStrategy:a,TopPlacement:u,__namedExportsOrder:S,default:P},Symbol.toStringTag,{value:"Module"}));export{L as I};
