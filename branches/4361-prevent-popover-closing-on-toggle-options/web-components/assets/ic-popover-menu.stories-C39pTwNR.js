var b=Object.freeze,F=Object.defineProperty;var n=(e,S)=>b(F(e,"raw",{value:b(S||e.slice())}));import{b as i}from"./lit-html-B6sBSybp.js";const M={open:!0,groupLabel:"View",description:"",disabled:!1,href:"/",keyboardShortcutLabel:"Cmd + C",label:"Copy code",variant:"default",iconSlot:!0,theme:"inherit"},V={title:"Web Components/Popover menu",component:"Popover Menu"};var v;const o={render:()=>i(v||(v=n([`
  ...
  `]))),name:"Default"};var h;const t={render:()=>i(h||(h=n([`
    ...
    <div>
      ...
      <ic-popover-menu submenu-id="abc" close-on-item-select="toggle">
        <ic-menu-item label="Edit"></ic-menu-item>
        <ic-menu-item label="Full Screen Mode" variant="toggle"></ic-menu-item>
        <ic-menu-item label="Find" submenu-trigger-for="abc123"></ic-menu-item>
        <ic-menu-item label="Delete" variant="destructive"></ic-menu-item>
      </ic-popover-menu>
  ...
  `]))),name:"Positioning strategy"};var P;const s={render:()=>i(P||(P=n([`
    <script>
      var icPopover = document.querySelector("ic-popover-menu");
      function buttonClick() {
        icPopover.open = !icPopover.open;
  ...
  `]))),name:"Slotted anchor"},d={render:e=>i`<div>
      <ic-popover-menu
        aria-label="popover"
        open=${e.open}
        theme=${e.theme}
    ...
    </div>`,args:M,argTypes:{variant:{options:["default","toggle","destructive"],control:{type:"radio"}},iconSlot:{mapping:{true:"icon",false:""}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <ic-button id="button-1" onclick="buttonClick()"
      >Show/Hide popover</ic-button
    >
  ...
  name: "Playground"
}`,...d.parameters?.docs?.source}}};const L=["Default","MenuOnToggle","MenuNeverCloses","MaxHeight","LeftPlacement","TopPlacement","MultiplePopoversOnPage","AutoOpening","PositioningStrategy","SlottedAnchor","Playground"],Z=Object.freeze(Object.defineProperty({__proto__:null,AutoOpening:a,Default:o,LeftPlacement:u,MaxHeight:m,MenuNeverCloses:c,MenuOnToggle:t,MultiplePopoversOnPage:r,Playground:d,PositioningStrategy:p,SlottedAnchor:s,TopPlacement:l,__namedExportsOrder:L,default:V},Symbol.toStringTag,{value:"Module"}));export{Z as I};
