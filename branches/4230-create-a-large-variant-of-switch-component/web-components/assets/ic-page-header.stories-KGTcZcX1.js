import{b as t}from"./lit-html-B6sBSybp.js";const x={aligned:"left",border:!0,heading:"Latte recipe","reverse-order":!1,size:"medium",sticky:!1,"sticky-desktop-only":!1,subheading:"A Latte is a popular Italian coffee, made with espresso, steamed milk and a thin layer of foam.",theme:"inherit","--ic-page-header-text-primary":"","--ic-page-header-background":"","--ic-page-header-border":"","--ic-page-header-text-tertiary":"","--ic-page-header-placeholder-text-field":""},S={title:"Web Components/Page header",component:"ic-page-header",parameters:{layout:"fullscreen"}},a={render:e=>t`<ic-page-header
        aligned=${e.aligned}
        border=${e.border}
        heading=${e.heading}
