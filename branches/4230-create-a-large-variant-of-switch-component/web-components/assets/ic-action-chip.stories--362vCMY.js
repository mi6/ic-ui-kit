import{b as i}from"./lit-html-B6sBSybp.js";const h={title:"Web Components/Action chip",component:"ic-action-chip"},a={render:()=>i`<ic-action-chip
      label="Small"
      size="small"
    ></ic-action-chip>
    <ic-action-chip label="Medium"></ic-action-chip>
    <ic-action-chip label="Large" size="large"></ic-action-chip>`,name:"Sizes"},t={render:()=>i`<ic-action-chip label="Outlined" variant="outlined"></ic-action-chip
      ><ic-action-chip
        label="Non transparent"
        variant="outlined"
        transparent-background="false"
      ></ic-action-chip>`,name:"Outlined"},e={render:()=>i`<ic-action-chip
      label="Default"
      disabled="true"
    ></ic-action-chip>
    ...
    <ic-action-chip
      ...
      disabled="true"
    >
    </ic-action-chip>`,name:"Disabled"},o={render:()=>i` <ic-action-chip label="With icon">
    <svg
      slot="icon"
      width="20"
      height="20"
  ...
  </ic-action-chip>`,name:"Icon"},c={render:()=>i` <ic-action-chip label="With badge" variant="outlined"
    ><ic-badge
      label="1"
      slot="badge"
      position="near"
      variant="success"
    ></ic-badge>
  </ic-action-chip>`,name:"Badge"},r={render:()=>i`<ic-action-chip
      label="Link"
      href="#"
      target="_blank"
    ></ic-action-chip>`,name:"Link"},l={render:()=>i`<div style="display: flex; flex-direction: column;">
  ...
  </div>`,name:"Theme and monochrome"},s="inline-radio",C={render:n=>i`<ic-action-chip
    label=${n.label}
    disabled=${n.disabled}
    href=${n.href}
    ...
    target=${n.target}
    theme=${n.theme}
    transparent-background=${n.transparentBackground}
    variant=${n.variant}
  >
    <svg
      slot="icon"
  ...
  </ic-action-chip>`,name:"Playground",args:{label:"Label",disabled:!1,href:"",monochrome:!1,size:"medium",target:"",theme:"inherit",transparentBackground:!0,variant:"filled"},argTypes:{size:{options:["small","medium","large"],control:{type:s}},theme:{options:["inherit","light","dark"],control:{type:s}},variant:{options:["filled","outlined"],control:{type:s}}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
...
}`,...C.parameters?.docs?.source}}};const p=["Sizes","Outlined","Disabled","Icon","Badge","Link","ThemeMonochrome","Playground"],g=Object.freeze(Object.defineProperty({__proto__:null,Badge:c,Disabled:e,Icon:o,Link:r,Outlined:t,Playground:C,Sizes:a,ThemeMonochrome:l,__namedExportsOrder:p,default:h},Symbol.toStringTag,{value:"Module"}));export{g as I};
