...
(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[4598],{"./node_modules/@storybook/addon-docs/dist/index.mjs":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{Xz:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.Xz,dk:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.dk,h_:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.h_,oG:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.oG});__webpack_require__("./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var _storybook_blocks__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@storybook/blocks/dist/index.mjs")},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{NF:()=>withMDXComponents,Zo:()=>MDXProvider,ah:()=>useMDXComponents,pC:()=>MDXContext});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const MDXContext=react__WEBPACK_IMPORTED_MODULE_0__.createContext({});function withMDXComponents(Component){return function boundMDXComponent(props){const allComponents=useMDXComponents(props.components);return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component,{...props,allComponents})}}function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0__.useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0__.useMemo((()=>"function"==typeof components?components(contextComponents):{...contextComponents,...components}),[contextComponents,components])}const emptyObject={};function MDXProvider({components,children,disableParentContext}){let allComponents;return allComponents=disableParentContext?"function"==typeof components?components({}):components||emptyObject:useMDXComponents(components),react__WEBPACK_IMPORTED_MODULE_0__.createElement(MDXContext.Provider,{value:allComponents},children)}},"./src/components/ic-toggle-button-group/ic-toggle-button-group.stories.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,appearance:()=>appearance,default:()=>ic_toggle_button_group_stories,disabled:()=>disabled,loading:()=>loading,selectType:()=>selectType,sizes:()=>sizes,withIcons:()=>withIcons});__webpack_require__("./node_modules/react/index.js");var lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-docs/dist/index.mjs"),lit_html=__webpack_require__("./node_modules/lit-html/lit-html.js");const readme_namespaceObject='# ic-toggle-button-group\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property          | Attribute          | Description                                                                                                                                          | Type                              | Default     |\n| ----------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ----------- |\n| `accessibleLabel` | `accessible-label` | The accessible label of the toggle button group component to provide context for screen reader users.                                                | `string`                          | `undefined` |\n| `appearance`      | `appearance`       | The appearance of the accordion group, e.g dark, or light.                                                                                           | `"dark" \\| "default" \\| "light"`  | `"default"` |\n| `disabled`        | `disabled`         | If `true`, the toggle button group will be set to the disabled state.                                                                                | `boolean`                         | `false`     |\n| `fullWidth`       | `full-width`       | If `true`, the toggle button group will fill the width of the container.                                                                             | `boolean`                         | `false`     |\n| `iconPlacement`   | `icon-placement`   | The placement of the icons in relation to the toggle button labels.                                                                                  | `"left" \\| "right" \\| "top"`      | `undefined` |\n| `loading`         | `loading`          | If `true`, the toggle button group will be in loading state.                                                                                         | `boolean`                         | `false`     |\n| `selectMethod`    | `select-method`    | If auto, controls are toggled as navigated to. If manual, controls must be actioned to change their toggled state. No effect if selectType is multi. | `"auto" \\| "manual"`              | `"manual"`  |\n| `selectType`      | `select-type`      | sets whether a single option can be toggled at a time, or whether multiple options can be toggled. If multi, then select method is always manual.    | `"multi" \\| "single"`             | `"single"`  |\n| `size`            | `size`             | The size of the toggle buttons to be displayed. This does not affect the font size of the accessible label.                                          | `"default" \\| "large" \\| "small"` | `"default"` |\n| `variant`         | `variant`          | The variant of the toggle button.                                                                                                                    | `"default" \\| "icon"`             | `"default"` |\n\n\n## Events\n\n| Event      | Description                               | Type                               |\n| ---------- | ----------------------------------------- | ---------------------------------- |\n| `icChange` | Emitted when a toggle-button is selected. | `CustomEvent<IcChangeEventDetail>` |\n\n\n----------------------------------------------\n\n\n';var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function _createMdxContent(props){const _components=Object.assign({h3:"h3"},(0,lib.ah)(),props.components);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.h_,{title:"Web Components/Toggle Button Group",component:"Toggle Button Group"}),"\n",(0,jsx_runtime.jsx)(dist.dk,{markdown:readme_namespaceObject}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"select-type",children:"Select type"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Select type",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`
      ...
      `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"sizes",children:"Sizes"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Sizes",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`
        <span>Default</span>
        <ic-toggle-button-group label="Label for single and manual" accessible-label="accessible label for the toggle button group">
        <ic-toggle-button label="First toggle"></ic-toggle-button>
        <ic-toggle-button label="Second toggle"></ic-toggle-button>
        <ic-toggle-button label="Third toggle"></ic-toggle-button>
        </ic-toggle-button-group>
        ...
        <ic-toggle-button-group
          ...
          size="small" accessible-label="accessible label for the toggle button group"
        >
        ...
        <ic-toggle-button-group
          ...
          size="large" accessible-label="accessible label for the toggle button group"
        >
        ...
        <ic-toggle-button-group
          label="Label for single and manual"
          full-width="true" accessible-label="accessible label for the toggle button group"
        >
        ...
        <ic-toggle-button-group
         style="width: 75%;" label="Label for single and manual" accessible-label="accessible label for the toggle button group"
        >
        ...
        <ic-toggle-button-group
          label="Label for single and manual"
         style="width: 40%;" accessible-label="accessible label for the toggle button group"
        >
          <ic-toggle-button label="Toggle"></ic-toggle-button>
          <ic-toggle-button>Toggle with a very very long label</ic-toggle-button>
        </ic-toggle-button-group>
      `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"appearance",children:"Appearance"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Appearance",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<span>Light</span>
        <div
        ...
        >
          ...
          <ic-toggle-button
            ...
            appearance="dark"
          ></ic-toggle-button>
        </ic-toggle-button-group> `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"disabled",children:"Disabled"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Disabled",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<span>Disabled</span>
        <ic-toggle-button-group
          label="Label for single and manual"
          disabled="true"
          accessible-label="accessible label for the toggle button group"
        >
          ...
          <ic-toggle-button
            ...
            disabled="true"
          ></ic-toggle-button>
        </ic-toggle-button-group>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"loading",children:"Loading"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Loading",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<span>Loading default</span>
        <ic-toggle-button-group
          label="Label for single and manual"
          loading="true"
          accessible-label="accessible label for the toggle button group"
        ...
        >
          ...
          <ic-toggle-button
            ...
            appearance="dark"
          ></ic-toggle-button>
        </ic-toggle-button-group> `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-icons",children:"With icons"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"With icons",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<span>Icon only</span>
        <ic-toggle-button-group
          label="Label for icon only"
          variant="icon"
        ...
        <br />
        <span>Icon top</span>
        <ic-toggle-button-group label="Label for icon top" icon-placement="top">
        ...
        </ic-toggle-button-group> `})})]})}const selectType=args=>lit_html.dy`
        <span>Single and manual</span>
        <ic-toggle-button-group
          select-type="single"
          label="Label for single and manual"
