var g=Object.freeze,w=Object.defineProperty;var i=(t,T)=>g(w(t,"raw",{value:g(T||t.slice())}));import{x as o}from"./lit-html-CWQq0DyO.js";const S={disableHover:!1,maxLines:3,placement:"bottom",label:"This is a description of the button",theme:"inherit",fixedPositioning:!1},k={title:"Web Components/Tooltip",component:"ic-tooltip"},e={render:()=>o`<ic-tooltip
      ...
      > `,name:"Default",height:"100px"};var f;const n={render:()=>o(f||(f=i([`<script>
        let display = true;
        document
    ...
    >`,name:"Disabled Hover",height:"100px"},a={render:()=>o` <div style="margin: 40px">
      ...
      >
    </div>`,name:"Top placements"},s={render:()=>o` <div style="margin: 40px">
      <ic-tooltip
      ...
      >
    </div>`,name:"Right placements"},c={render:()=>o` <div style="margin-left: 400px">
      <ic-tooltip
      ...
      >
    </div>`,name:"Left placements"},p={render:()=>o`<ic-tooltip
    ...
    >`,name:"Truncation",height:"100px"},d={render:()=>o`<div style="height: 100px;background-color:#333333;">
    ...
    </div>`,name:"Dark background"};var y;const b={render:()=>o(y||(y=i([`<script>
      ...
      </div> `]))),name:"Changing label"};var v;const u={render:()=>o(v||(v=i([` <script>
      ...
      </div>`]))),name:"Positioning strategy"};var x;const h={render:()=>o(x||(x=i([`<script>
        document
      ...
      > `]))),name:"IcShowTooltip event",height:"100px"},m={render:t=>o`<div style="margin: 250px">
      <ic-tooltip
        label=${t.label}
    ...
    </div> `,args:S,argTypes:{placement:{options:["bottom","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom-start","left-end","left","left-start"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...m.parameters?.docs?.source}}};const D=["Default","UsingExternalMethod","DisabledHover","TopPlacements","BottomPlacements","RightPlacements","LeftPlacements","Truncation","DarkBackground","ChangingLabel","PositioningStrategy","IcShowTooltipEvent","Playground"],$=Object.freeze(Object.defineProperty({__proto__:null,BottomPlacements:s,ChangingLabel:b,DarkBackground:d,Default:e,DisabledHover:l,IcShowTooltipEvent:h,LeftPlacements:c,Playground:m,PositioningStrategy:u,RightPlacements:r,TopPlacements:a,Truncation:p,UsingExternalMethod:n,__namedExportsOrder:D,default:k},Symbol.toStringTag,{value:"Module"}));export{$ as I};
