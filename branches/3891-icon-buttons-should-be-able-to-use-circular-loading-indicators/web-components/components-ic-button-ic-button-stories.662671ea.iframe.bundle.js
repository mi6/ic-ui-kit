      ...
      <div>
        ...
        <div style="display:flex; gap: 0.5rem; padding-bottom: 1rem">
          <ic-button
            ...
            id="testbutton"
            loading
            circular-loading-indicator="true"
            size="small"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-button>`,args:{disableTooltip:!1,disabled:!1,fullWidth:!1,href:"",loading:!1,monochrome:!1,size:"medium",theme:"inherit",tooltipPlacement:"bottom",transparentBackground:!1,variant:"icon-primary",circularLoadingIndicator:!1},argTypes:{variant:{options:["icon-primary","icon-secondary","icon-tertiary","icon-destructive"],control:{type:"select"}},size:{options:["medium","large","small"],control:{type:"inline-radio"}},theme:{options:["inherit","dark","light"],control:{type:"inline-radio"}},tooltipPlacement:{options:["top","right","bottom","left"],control:{type:"inline-radio"}}},name:"Playground - icon only"},Loading={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="padding: 6px">
