var v=Object.freeze,$=Object.defineProperty;var i=(t,S)=>v($(t,"raw",{value:v(S||t.slice())}));import{x as o}from"./lit-html-CWQq0DyO.js";const L={disableHover:!1,maxLines:3,placement:"bottom",label:"This is a description of the button",theme:"inherit",fixedPositioning:!1},I={...L,tooltipIconSlot:"tooltip-icon",tooltipIconAltText:"Check mark icon"},k={title:"Web Components/Tooltip",component:"ic-tooltip"},e={render:()=>o`<ic-tooltip
      ...
      > `,name:"Default",height:"100px"};var y;const n={render:()=>o(y||(y=i([`<script>
        let display = true;
        document
      ...
      >`]))),name:"Using external method",height:"100px"},l={render:()=>o`<ic-tooltip
    ...
    >`,name:"Disabled Hover",height:"100px"},a={render:()=>o` <div style="margin: 40px">
      <ic-tooltip
        placement="top-start"
        label="This is a description of the button"
      ...
      >
    </div>`,name:"Top placements"},c={render:()=>o` <div style="margin: 40px">
      <ic-tooltip
      ...
      >
    </div>`,name:"Bottom placements"},r={render:()=>o` <div style="margin: 40px">
      <ic-tooltip
      ...
      >
    </div>`,name:"Right placements"},s={render:()=>o` <div style="margin-left: 400px">
      <ic-tooltip
      ...
      >
    </div>`,name:"Left placements"},p={render:()=>o`
    <ic-tooltip
  ...
  `,name:"With Icon"},d={render:()=>o`<ic-tooltip
    ...
    >`,name:"Truncation",height:"100px"},b={render:()=>o`<div style="height: 100px;background-color:#333333;">
      <ic-tooltip
        label="This is a description of the button"
    ...
    </div>`,name:"Dark background"};var x;const u={render:()=>o(x||(x=i([`<script>
      ...
      </div> `]))),name:"Changing label"};var w;const h={render:()=>o(w||(w=i([` <script>
      ...
      </div>`]))),name:"Positioning strategy"};var T;const m={render:()=>o(T||(T=i([`<script>
        document
      ...
      > `]))),name:"IcShowTooltip event",height:"100px"},g={render:t=>o`<div style="margin: 250px">
      <ic-tooltip
        label=${t.label}
    ...
    </div> `,args:L,argTypes:{placement:{options:["bottom","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom-start","left-end","left","left-start"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"},f={render:t=>o`<div style="margin: 250px">
      <ic-tooltip
        label=${t.label}
      ...
      >
        <svg
          ...
          aria-label=${t.tooltipIconAltText}
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="currentColor"
    ...
    </div> `,args:I,argTypes:{placement:{options:["bottom","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom-start","left-end","left","left-start"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}},tooltipIconSlot:{options:["tooltip-icon",""],control:{type:"select"}},tooltipIconAltText:{control:{type:"text"}}},name:"Playground With Icon"};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
...
}`,...f.parameters?.docs?.source}}};const D=["Default","UsingExternalMethod","DisabledHover","TopPlacements","BottomPlacements","RightPlacements","LeftPlacements","TooltipWithSlottedIcon","Truncation","DarkBackground","ChangingLabel","PositioningStrategy","IcShowTooltipEvent","Playground","PlaygroundWithIcon"],B=Object.freeze(Object.defineProperty({__proto__:null,BottomPlacements:c,ChangingLabel:u,DarkBackground:b,Default:e,DisabledHover:l,IcShowTooltipEvent:m,LeftPlacements:s,Playground:g,PlaygroundWithIcon:f,PositioningStrategy:h,RightPlacements:r,TooltipWithSlottedIcon:p,TopPlacements:a,Truncation:d,UsingExternalMethod:n,__namedExportsOrder:D,default:k},Symbol.toStringTag,{value:"Module"}));export{B as I};
