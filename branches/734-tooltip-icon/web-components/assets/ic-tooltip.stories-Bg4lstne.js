var f=Object.freeze,L=Object.defineProperty;var g=(t,T)=>f(L(t,"raw",{value:f(T||t.slice())}));import{x as o}from"./lit-html-CWQq0DyO.js";const w={disableHover:!1,maxLines:3,placement:"bottom",label:"This is a description of the button",theme:"inherit",fixedPositioning:!1},$={...w,tooltipIconSlot:"tooltip-icon",tooltipIconAltText:"Check mark icon"},S={title:"Web Components/Tooltip",component:"ic-tooltip"},i={render:()=>o`<ic-tooltip
  ...
  `,name:"With Icon"},p={render:()=>o`<ic-tooltip
    ...
    >`,name:"Truncation",height:"100px"},d={render:()=>o`<div style="height: 100px;background-color:#333333;">
    ...
    </div>`,name:"Dark background"};var x;const b={render:()=>o(x||(x=g([`<script>
      ...
      </div> `]))),name:"Changing label"};var v;const u={render:()=>o(v||(v=g([` <script>
    ...
    </div> `,args:$,argTypes:{placement:{options:["bottom","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom-start","left-end","left","left-start"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}},tooltipIconSlot:{options:["tooltip-icon",""],control:{type:"select"}},tooltipIconAltText:{control:{type:"text"}}},name:"Playground With Icon"};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
...
}`,...m.parameters?.docs?.source}}};const k=["Default","UsingExternalMethod","DisabledHover","TopPlacements","BottomPlacements","RightPlacements","LeftPlacements","TooltipWithSlottedIcon","Truncation","DarkBackground","ChangingLabel","PositioningStrategy","Playground","PlaygroundWithIcon"],C=Object.freeze(Object.defineProperty({__proto__:null,BottomPlacements:a,ChangingLabel:b,DarkBackground:d,Default:i,DisabledHover:n,LeftPlacements:r,Playground:h,PlaygroundWithIcon:m,PositioningStrategy:u,RightPlacements:s,TooltipWithSlottedIcon:c,TopPlacements:l,Truncation:p,UsingExternalMethod:e,__namedExportsOrder:k,default:S},Symbol.toStringTag,{value:"Module"}));export{C as I};
