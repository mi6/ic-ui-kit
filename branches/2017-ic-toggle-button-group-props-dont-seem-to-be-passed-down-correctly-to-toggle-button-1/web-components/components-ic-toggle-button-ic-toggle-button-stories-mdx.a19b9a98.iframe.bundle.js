...
(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[9499],{"./node_modules/@storybook/addon-docs/dist/index.mjs":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{Hl:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.Hl,VY:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.VY,W8:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.W8,gG:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.gG});__webpack_require__("./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var _storybook_blocks__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@storybook/blocks/dist/index.mjs")},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{BN:()=>MDXContext,RP:()=>useMDXComponents,gz:()=>withMDXComponents,xA:()=>MDXProvider});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const MDXContext=react__WEBPACK_IMPORTED_MODULE_0__.createContext({});function withMDXComponents(Component){return function boundMDXComponent(props){const allComponents=useMDXComponents(props.components);return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component,{...props,allComponents})}}function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0__.useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0__.useMemo((()=>"function"==typeof components?components(contextComponents):{...contextComponents,...components}),[contextComponents,components])}const emptyObject={};function MDXProvider({components,children,disableParentContext}){let allComponents;return allComponents=disableParentContext?"function"==typeof components?components({}):components||emptyObject:useMDXComponents(components),react__WEBPACK_IMPORTED_MODULE_0__.createElement(MDXContext.Provider,{value:allComponents},children)}},"./src/components/ic-toggle-button/ic-toggle-button.stories.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,checked:()=>checked,default:()=>ic_toggle_button_stories,defaultStory:()=>defaultStory,disabled:()=>disabled,fullWidth:()=>fullWidth,iconOnly:()=>iconOnly,iconRight:()=>iconRight,iconTop:()=>iconTop,loading:()=>loading,monochrome:()=>monochrome,sizes:()=>sizes,withBadge:()=>withBadge,withIcon:()=>withIcon});__webpack_require__("./node_modules/react/index.js");var lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-docs/dist/index.mjs"),lit_html=__webpack_require__("./node_modules/lit-html/lit-html.js");const readme_namespaceObject='# ic-toggle-button\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property          | Attribute          | Description                                                                                                                             | Type                             | Default     |\n| ----------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ----------- |\n| `accessibleLabel` | `accessible-label` | The accessible label that will be applied to the toggle button. This is required for the icon variant of toggle buttons.                | `string`                         | `undefined` |\n| `checked`         | `checked`          | If `true`, the toggle button will be in a checked state.                                                                                | `boolean`                        | `false`     |\n| `disabled`        | `disabled`         | If `true`, the toggle button will be in disabled state.                                                                                 | `boolean`                        | `false`     |\n| `fullWidth`       | `full-width`       | If `true`, the toggle button will fill the width of the container.                                                                      | `boolean`                        | `false`     |\n| `iconPlacement`   | `icon-placement`   | The placement of the icon in relation to the toggle button label.                                                                       | `"left" \\| "right" \\| "top"`     | `"left"`    |\n| `label`           | `label`            | The label to display in the toggle button. This is required for the default variant of toggle buttons.                                  | `string`                         | `undefined` |\n| `loading`         | `loading`          | If `true`, the toggle button will be in loading state.                                                                                  | `boolean`                        | `false`     |\n| `monochrome`      | `monochrome`       | If `true`, the toggle button will display as black in the light theme, and white in dark theme.                                         | `boolean`                        | `false`     |\n| `size`            | `size`             | The size of the toggle button to be displayed.                                                                                          | `"large" \\| "medium" \\| "small"` | `"medium"`  |\n| `theme`           | `theme`            | Sets the theme color to the dark or light theme color. "inherit" will set the color based on the system settings or ic-theme component. | `"dark" \\| "inherit" \\| "light"` | `"inherit"` |\n| `variant`         | `variant`          | The variant of the toggle button.                                                                                                       | `"default" \\| "icon"`            | `"default"` |\n\n\n## Events\n\n| Event             | Description                                   | Type                                 |\n| ----------------- | --------------------------------------------- | ------------------------------------ |\n| `icToggleChecked` | Emitted when the user clicks a toggle button. | `CustomEvent<{ checked: boolean; }>` |\n\n\n## Slots\n\n| Slot      | Description                                                    |\n| --------- | -------------------------------------------------------------- |\n| `"badge"` | Badge component overlaying the top right of the toggle button. |\n| `"icon"`  | Content will be displayed alongside the toggle button label.   |\n\n\n## Dependencies\n\n### Depends on\n\n- [ic-button](../ic-button)\n\n### Graph\n```mermaid\ngraph TD;\n  ic-toggle-button --\x3e ic-button\n  ic-button --\x3e ic-loading-indicator\n  ic-button --\x3e ic-tooltip\n  ic-loading-indicator --\x3e ic-typography\n  ic-tooltip --\x3e ic-typography\n  style ic-toggle-button fill:#f9f,stroke:#333,stroke-width:4px\n```\n\n----------------------------------------------\n\n\n';var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function _createMdxContent(props){const _components=Object.assign({h3:"h3"},(0,lib.RP)(),props.components);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.W8,{title:"Web Components/Toggle button",component:"ic-toggle-button"}),"\n",(0,jsx_runtime.jsx)(dist.VY,{markdown:readme_namespaceObject}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"default",children:"Default"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Default",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button label="Toggle"></ic-toggle-button>
      ...
      <ic-toggle-button
        ...
        disabled="true"
        checked="true"
      ></ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-icon",children:"With icon"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With icon",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button label="Toggle">
      <svg
        slot="icon"
    ...
    </ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"sizes",children:"Sizes"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Sizes",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<div style="padding: 6px">
      ...
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-badge",children:"With badge"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With badge",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button label="Toggle">
      ...
      </ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"monochrome",children:"Monochrome"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Monochrome",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button
        label="Toggle"
        monochrome="true"
      ></ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"full-width",children:"Full width"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Full width",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button
        label="Toggle"
        full-width="true"
      ></ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"loading",children:"Loading"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Loading",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<div style="padding: 6px">
        ...
        </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon-only",children:"Icon only"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Icon only",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<div style="padding:6px 10px; width:fit-content">
        <ic-toggle-button
          variant="icon"
          size="small"
          accessible-label="Refresh the page"
      ...
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon-right",children:"Icon right"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Icon right",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button label="Toggle" icon-placement="right">
      <svg
        slot="icon"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
    ...
    </ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon-top",children:"Icon top"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Icon top",parameters:{loki:{skip:!0}},children:args=>lit_html.qy`<ic-toggle-button label="Toggle" icon-placement="top">
      <svg
        slot="icon"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
    ...
    </ic-toggle-button>`})})]})}const defaultStory=args=>lit_html.qy`<ic-toggle-button label="Toggle"></ic-toggle-button>
      <script>
        var toggle = document.querySelector("ic-toggle-button");
        toggle.addEventListener("icToggleChecked", function (event) {
          console.log(event.detail.checked);
        });
      </script>`;defaultStory.storyName="Default",defaultStory.parameters={storySource:{source:'args => html`<ic-toggle-button label="Toggle"></ic-toggle-button>\n      <script>\n        var toggle = document.querySelector("ic-toggle-button");\n        toggle.addEventListener("icToggleChecked", function (event) {\n          console.log(event.detail.checked);\n        });\n      <\/script>`'},loki:{skip:!0}};const checked=args=>lit_html.qy`<ic-toggle-button label="Toggle" checked="true"></ic-toggle-button>`;checked.storyName="Checked",checked.parameters={storySource:{source:'args => html`<ic-toggle-button label="Toggle" checked="true"></ic-toggle-button>`'},loki:{skip:!0}};const disabled=args=>lit_html.qy`<ic-toggle-button
        label="Toggle"
        disabled="true"
      ></ic-toggle-button>
      <ic-toggle-button
