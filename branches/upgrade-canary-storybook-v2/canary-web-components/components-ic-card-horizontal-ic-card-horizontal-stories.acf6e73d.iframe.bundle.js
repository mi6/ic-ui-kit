"use strict";(self.webpackChunk_ukic_canary_web_components=self.webpackChunk_ukic_canary_web_components||[]).push([[8569],{"./src/components/ic-card-horizontal/ic-card-horizontal.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Clickable:()=>Clickable,ClickableHref:()=>ClickableHref,CustomWidth:()=>CustomWidth,Default:()=>Default,Disabled:()=>Disabled,Icon:()=>Icon,Image:()=>Image,Message:()=>Message,Sizes:()=>Sizes,SlottedHeadingAndMessage:()=>SlottedHeadingAndMessage,Truncation:()=>Truncation,WrappedByLink:()=>WrappedByLink,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Horizontal Card",component:"Horizontal Card",parameters:{componentAPI:{data:__webpack_require__("./src/components/ic-card-horizontal/readme.md")}}},Default={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal heading="Card heading"></ic-card-horizontal>`,name:"Default"},Message={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal
    ...
    </ic-card-horizontal>`,name:"Icon"},Clickable={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal
      heading="Card heading"
      message="Card message"
      clickable="true"
    >
    ...
    </ic-card-horizontal>`,name:"Clickable"},ClickableHref={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal
      heading="Card heading"
      message="Card message"
      clickable="true"
    ...
    </ic-card-horizontal>`,name:"Clickable - href"},WrappedByLink={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<a href="/">
    ...
    ></a>`,name:"Wrapped by link"},Image={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal heading="Card heading" message="Card message">
      <svg
        slot="icon"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
    ...
    </ic-card-horizontal>`,name:"Image"},Sizes={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div>
      <ic-card-horizontal
        heading="Card heading"
    ...
    </div>`,name:"Sizes"},Truncation={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div>
      <ic-card-horizontal
    ...
    </div>`,name:"Truncation"},Disabled={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal
      heading="Card heading"
      message="Card message"
      clickable="true"
      disabled="true"
    ...
    </ic-card-horizontal>`,name:"Disabled"},SlottedHeadingAndMessage={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal>
    ...
    </ic-card-horizontal>`,name:"Slotted heading and message"},CustomWidth={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-card-horizontal
      heading="Card heading"
      message="Card message"
