"use strict";(self.webpackChunk_ukic_canary_web_components=self.webpackChunk_ukic_canary_web_components||[]).push([[3231],{"./src/components/ic-tree-view/ic-tree-view.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Basic:()=>Basic,DisabledTreeItems:()=>DisabledTreeItems,Expanded:()=>Expanded,Large:()=>Large,Light:()=>Light,Link:()=>Link,MaxContent:()=>MaxContent,Nested:()=>Nested,RouterItem:()=>RouterItem,SelectedTreeItem:()=>SelectedTreeItem,SlottedContent:()=>SlottedContent,Small:()=>Small,TruncationBehaviour:()=>TruncationBehaviour,WithIcons:()=>WithIcons,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var _readme_md__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/components/ic-tree-view/readme.md"),_ic_tree_item_readme_md__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/ic-tree-item/readme.md"),lit_html__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Tree view",component:"ic-tree-view",parameters:{componentAPI:{data:_readme_md__WEBPACK_IMPORTED_MODULE_0__+_ic_tree_item_readme_md__WEBPACK_IMPORTED_MODULE_1__}}},Basic={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
  ...
  `,name:"Basic"},Nested={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
  ...
  `,name:"Nested"},WithIcons={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
  ...
  `,name:"With icons"},Small={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
  ...
  `,name:"Small"},Large={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
  ...
  `,name:"Large"},Light={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px;">
  ...
  `,name:"Light",parameters:{backgrounds:{default:"dark"}}},DisabledTreeItems={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
  ...
  `,name:"Disabled tree items"},RouterItem={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
        <ic-tree-item>
  ...
  `,name:"Router item"},SlottedContent={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
      <div style="width:250px">
        <ic-tree-view>
    ...
    `,name:"Slotted content"},MaxContent={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
  ...
  `,name:"Max content"},TruncationBehaviour={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view
  ...
  `,name:"Truncation behaviour"},SelectedTreeItem={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
        <ic-tree-item label="Coffee"></ic-tree-item>
        <ic-tree-item label="Tea"></ic-tree-item>
  ...
  `,name:"Selected tree item"},Link={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
  ...
  `,name:"Link"},Expanded={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.qy`
    <div style="width:250px">
      <ic-tree-view heading="Menu">
