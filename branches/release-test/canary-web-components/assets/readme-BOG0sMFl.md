...
| `chevronButtonAriaLabel` | `chevron-button-aria-label` | The aria-label of the chevron button (displayed when `trigger="chevron"`). This will default to "Open drawer" / "Close drawer".                             | `string \| undefined`                    | `undefined`  |
| `closeButtonAriaLabel`   | `close-button-aria-label`   | The aria-label of the X (close) button (displayed when `trigger="controlled"`). This will default to "Close drawer".                                        | `string \| undefined`                    | `undefined`  |
...
| `trigger`                | `trigger`                   | The method in which the drawer is expanded.                                                                                                                 | `"chevron" \| "controlled"`              | `"chevron"`  |
...
| ------------------ | -------------------------------------------------- | ------------------------------------- |
| `icDrawerExpanded` | Emitted when the drawer is expanded and collapsed. | `CustomEvent<IcDrawerExpandedDetail>` |
...
| Slot                  | Description                                                              |
| --------------------- | ------------------------------------------------------------------------ |
| `"actions"`           | Content will be rendered in the action area at the bottom of the drawer. |
