var A=Object.freeze,R=Object.defineProperty;var a=(e,B)=>A(R(e,"raw",{value:A(B||e.slice())}));import{x as t}from"./lit-html-CWQq0DyO.js";const $={title:"Web Components/Text field",component:"ic-text-field"},q={debounce:0,disabled:!1,fullWidth:!1,helperText:"",hideCharCount:!1,hideLabel:!1,inputId:"ic-text-field-input-0",inputmode:"text",label:"Text Field",max:0,maxCharacters:0,maxCharactersMessage:"Custom max characters validation message",maxMessage:"Custom max validation message",min:0,minCharacters:0,minCharactersMessage:"Custom min characters validation message",minMessage:"Custom min validation message",name:"0",placeholder:"",readonly:!1,required:!1,resize:!1,rows:1,size:"medium",spellcheck:!1,theme:"inherit",type:"text",validationAriaLive:"default",validationInline:!1,validationStatus:"no status",validationText:"",value:""},i={render:()=>t`<ic-text-field label="What is your favourite coffee?"> </ic-text-field>
      <ic-text-field rows="6" label="What is your favourite coffee?">
      </ic-text-field>`,name:"Default"},n={render:()=>t`<ic-text-field autofocus label="What is your favourite coffee?">
    </ic-text-field>`,name:"Autofocus"},r={render:()=>t`<ic-text-field
      ...
      <ic-text-field
        ...
        placeholder="Placeholder"
      >
      </ic-text-field> `,name:"Placeholder and required"},l={render:()=>t`<ic-text-field
        label="What is your favourite coffee?"
        required
        placeholder="Placeholder"
      ...
      </ic-text-field>`,name:"Helper text"},o={render:()=>t`<ic-text-field
        label="What is your favourite coffee?"
        required
        placeholder="Placeholder"
        helper-text="Such as Arabica, Robusta or Liberica"
      ...
      </ic-text-field> `,name:"With icon"},s={render:()=>t`<ic-text-field
        value="Arabica"
        label="What is your favourite coffee?"
        required
        placeholder="Placeholder"
      ...
      </ic-text-field> `,name:"With value"},c={render:()=>t`<style>
        ic-text-field {
          --input-width: 400px;
        }
      </style>
      ...
      </ic-text-field> `,name:"Custom width"},d={render:()=>t`<div style="display: flex">
        <ic-text-field
          full-width="true"
          value="Arabica"
          max-characters="25"
      ...
      </ic-text-field> `,name:"Full width"},h={render:()=>t`<ic-text-field
        value="Arabica"
        label="What is your favourite coffee?"
        disabled
        placeholder="Placeholder"
      ...
      </ic-text-field> `,name:"Disabled"},u={render:()=>t`<ic-text-field
        value="Arabica"
        max-characters="25"
        label="What is your favourite coffee?"
        readonly
      ...
      <ic-text-field
        ...
        helper-text="Such as Arabica, Robusta or Liberica"
      >
      </ic-text-field> `,name:"Read only"},f={render:()=>t`<ic-text-field
      ...
      </ic-text-field>`,name:"Validation"};var M;const p={render:()=>t(M||(M=a([`<ic-text-field
        id="field-1"
        label="What is your favourite coffee?"
      ...
      <\/script>`]))),name:"Aria-live behaviour"},x={render:()=>t`<ic-text-field
      rows="6"
      value="Arabica"
      max-characters="25"
      resize
    ...
    </ic-text-field> `,name:"Text area with resize"};var H;const v={render:()=>t(H||(H=a([`
    <form>
    ...
    <\/script>
  `]))),name:"Form"},m={render:()=>t`<ic-text-field
        inputmode="numeric"
        label="How many coffees do you want?"
        helper-text="Our coffee machines have a maximum capacity of 4 coffees at a time."
        type="number"
      ...
      <ic-text-field
        ...
        max="4"
      >
      </ic-text-field>`,name:"Min and max"};var S;const g={render:()=>t(S||(S=a([`<script>
      ...
      <\/script>
      <ic-text-field label="What is your favourite coffee?"> </ic-text-field>`]))),name:"Logging icChange"};var W;const w={render:()=>t(W||(W=a([`<script>
        function handleIcChange(ev) {
          console.log(ev.detail.value, "icChange");
        }
        document
      ...
      <\/script>
      <ic-text-field label="What is your favourite coffee?"> </ic-text-field>`]))),name:"Logging icKeydown"},b={render:()=>t`<ic-text-field
        max-characters="2"
        label="What is your favourite coffee?"
      ...
      ></ic-text-field>`,name:"Maximum and minimum characters"},y={render:()=>t`<span lang="fr">
      <ic-text-field
    ...
    </span>`,name:"Internationalisation"},z="inline-radio";var P;const L={render:e=>t(P||(P=a([`<div
      ...
      <\/script>`])),e.theme==="light"?"white":e.theme==="dark"?"var(--ic-color-background-primary-dark)":"transparent",e.debounce,e.disabled,e.fullWidth,e.helperText,e.hideCharCount,e.hideLabel,e.inputId,e.inputmode,e.label,e.max,e.maxCharacters,e.maxCharactersMessage,e.maxMessage,e.min,e.minCharacters,e.minCharactersMessage,e.minMessage,e.name,e.placeholder,e.readonly,e.required,e.resize,e.rows,e.size,e.spellcheck,e.theme,e.type,e.validationAriaLive,e.validationInline,e.validationStatus==="no status"?"":e.validationStatus,e.validationText,e.value,e.showIconSlot&&t`<svg
            slot="icon"
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 0 24 24"
          ...
          >
            ...
            <path
              d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2z"
            />
          </svg>`),args:q,argTypes:{inputmode:{options:["none","text","tel","url","email","numeric","decimal","search"],control:{type:"select"}},size:{options:["medium","small"],control:{type:z}},type:{options:["email","password","tel","text","url","number","search"],control:{type:"select"}},validationAriaLive:{options:["default","polite","assertive","off"],control:{type:z}},validationStatus:{options:["no status","warning","error","success"],control:{type:"select"}},showIconSlot:{control:{type:"boolean"}},theme:{options:["inherit","light","dark"],control:{type:z}}},name:"Playground"};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...L.parameters?.docs?.source}}};const E=["Default","Autofocus","PlaceholderAndRequired","HelperText","WithIcon","WithValue","CustomWidth","FullWidth","Disabled","ReadOnly","Validation","AriaLiveBehaviour","TextAreaWithResize","Form","MinAndMax","LoggingIcChange","LoggingIcKeydown","MaximumAndMinimumCharacters","Internationalisation","Playground"],k=Object.freeze(Object.defineProperty({__proto__:null,AriaLiveBehaviour:p,Autofocus:n,CustomWidth:c,Default:i,Disabled:h,Form:v,FullWidth:d,HelperText:l,Internationalisation:y,LoggingIcChange:g,LoggingIcKeydown:w,MaximumAndMinimumCharacters:b,MinAndMax:m,PlaceholderAndRequired:r,Playground:L,ReadOnly:u,TextAreaWithResize:x,Validation:f,WithIcon:o,WithValue:s,__namedExportsOrder:E,default:$},Symbol.toStringTag,{value:"Module"}));export{k as I};
