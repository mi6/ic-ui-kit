/*! For license information please see components-ic-checkbox-group-ic-checkbox-group-stories.0c8392ce.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[9907,582,6199,6763],{"./src/components/ic-checkbox-group/ic-checkbox-group.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AriaLiveBehaviour:()=>AriaLiveBehaviour,ConditionalDynamic:()=>ConditionalDynamic,ConditionalStatic:()=>ConditionalStatic,Default:()=>Default,Disabled:()=>Disabled,Form:()=>Form,HelperText:()=>HelperText,HiddenCheckboxLabel:()=>HiddenCheckboxLabel,HiddenGroupLabel:()=>HiddenGroupLabel,Indeterminate:()=>Indeterminate,IndeterminateWithChildren:()=>IndeterminateWithChildren,Playground:()=>Playground,RTL:()=>RTL,Required:()=>Required,Sizes:()=>Sizes,SlottedLabel:()=>SlottedLabel,TextFieldValueChange:()=>TextFieldValueChange,Validation:()=>Validation,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var _storybook_preview_api__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("storybook/internal/preview-api"),lit_html__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Checkbox",component:"Checkbox"},Default={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_1__.qy`
  ...
  `,name:"Conditional static"},SlottedLabel={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_1__.qy`
  ...
  `,name:"Slotted Label"},HelperText={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_1__.qy`
    <ic-checkbox-group
      label="Coffee extras"
      name="group1"
  ...
  `,name:"Validation"},AriaLiveBehaviour={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_1__.qy`<ic-checkbox-group
        id="field-1"
        label="This is a label"
        name="1"
      ...
      </script>`,name:"Aria-live behaviour"},Form={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_1__.qy`
    <form>
      <ic-checkbox-group label="This is a label" name="group1">
        <ic-checkbox
          name="checkbox1"
