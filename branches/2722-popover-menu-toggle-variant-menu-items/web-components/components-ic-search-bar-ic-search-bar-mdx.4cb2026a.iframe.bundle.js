...
(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[6625,9603,582,6199,6763],{"./src/components/ic-search-bar/ic-search-bar.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{default:()=>MDXContent});__webpack_require__("./node_modules/react/index.js");var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/blocks/dist/index.mjs");const readme_namespaceObject='# ic-search-bar\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property                    | Attribute                     | Description                                                                                                                                                                  | Type                                          | Default                                                                                                    |\n| --------------------------- | ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |\n| `assistiveHintText`         | `assistive-hint-text`         | The hint text for the hidden assistive description element.                                                                                                                  | `string \\| undefined`                         | `"When autocomplete results are available use the up and down arrows to choose and press enter to select"` |\n| `autocapitalize`            | `autocapitalize`              | The automatic capitalisation of the text value as it is entered/edited by the user. Available options: "off", "none", "on", "sentences", "words", "characters".              | `string \\| undefined`                         | `"off"`                                                                                                    |\n| `autocomplete`              | `autocomplete`                | The state of autocompletion the browser can apply on the text value.                                                                                                         | `IcAutocompleteTypes \\| undefined`            | `"off"`                                                                                                    |\n| `autocorrect`               | `autocorrect`                 | The state of autocorrection the browser can apply when the user is entering/editing the text value.                                                                          | `"off" \\| "on" \\| undefined`                  | `"off"`                                                                                                    |\n| `autofocus`                 | `autofocus`                   | If `true`, the form control will have input focus when the page loads.                                                                                                       | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `charactersUntilSuggestion` | `characters-until-suggestion` | The number of characters until suggestions appear. The submit button will be disabled until the inputted value is equal to or greater than this number.                      | `number \\| undefined`                         | `2`                                                                                                        |\n| `debounce`                  | `debounce`                    | The amount of time, in milliseconds, to wait to trigger the `icChange` event after each keystroke.                                                                           | `number \\| undefined`                         | `0`                                                                                                        |\n| `disableAutoFiltering`      | `disable-auto-filtering`      | Specify whether to disable the built in filtering. For example, if options will already be filtered from external source. If `true`, all options provided will be displayed. | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `disabled`                  | `disabled`                    | If `true`, the disabled state will be set.                                                                                                                                   | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `emptyOptionListText`       | `empty-option-list-text`      | The text displayed when there are no options in the option list.                                                                                                             | `string \\| undefined`                         | `"No results found"`                                                                                       |\n| `focusOnLoad`               | `focus-on-load`               | If `true`, the search bar will be focused when component loaded.                                                                                                             | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `fullWidth`                 | `full-width`                  | Specify whether the search bar fills the full width of the container. If `true`, this overrides the --input-width CSS variable.                                              | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `helperText`                | `helper-text`                 | The helper text that will be displayed for additional field guidance.                                                                                                        | `string \\| undefined`                         | `""`                                                                                                       |\n| `hideLabel`                 | `hide-label`                  | If `true`, the label will be hidden and the required label value will be applied as an aria-label.                                                                           | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `label` _(required)_        | `label`                       | The label for the search bar.                                                                                                                                                | `string`                                      | `undefined`                                                                                                |\n| `labelField`                | `label-field`                 | The custom name for the label field to correspond with the IcMenuOption type.                                                                                                | `string \\| undefined`                         | `"label"`                                                                                                  |\n| `loading`                   | `loading`                     | Trigger loading state when fetching options asynchronously                                                                                                                   | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `loadingErrorLabel`         | `loading-error-label`         | Change the message displayed when external loading times out.                                                                                                                | `string \\| undefined`                         | `"Loading Error"`                                                                                          |\n| `loadingLabel`              | `loading-label`               | Change the message displayed whilst the options are being loaded externally.                                                                                                 | `string \\| undefined`                         | `"Loading..."`                                                                                             |\n| `name`                      | `name`                        | The name of the control, which is submitted with the form data.                                                                                                              | `string \\| undefined`                         | `this.inputId`                                                                                             |\n| `options`                   | --                            | The suggested search options.                                                                                                                                                | `IcMenuOption[] \\| undefined`                 | `[]`                                                                                                       |\n| `placeholder`               | `placeholder`                 | The placeholder value to display.                                                                                                                                            | `string \\| undefined`                         | `"Search"`                                                                                                 |\n| `readonly`                  | `readonly`                    | If `true`, the readonly state will be set.                                                                                                                                   | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `required`                  | `required`                    | If `true`, the search bar will require a value.                                                                                                                              | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `searchMode`                | `search-mode`                 | Specify the mode search bar uses to search. `navigation` allows for quick lookups of a set of values, `query` allows for more general searches.                              | `"navigation" \\| "query" \\| undefined`        | `"navigation"`                                                                                             |\n| `size`                      | `size`                        | The size of the search bar component.                                                                                                                                        | `"medium" \\| "small" \\| undefined`            | `"medium"`                                                                                                 |\n| `spellcheck`                | `spellcheck`                  | If `true`, the value of the search will have its spelling and grammar checked.                                                                                               | `boolean \\| undefined`                        | `false`                                                                                                    |\n| `theme`                     | `theme`                       | Sets the theme color to the dark or light theme color. "inherit" will set the color based on the system settings or ic-theme component.                                      | `"dark" \\| "inherit" \\| "light" \\| undefined` | `"inherit"`                                                                                                |\n| `timeout`                   | `timeout`                     | If using external filtering, set a timeout for when loading takes too long.                                                                                                  | `number \\| undefined`                         | `undefined`                                                                                                |\n| `value`                     | `value`                       | The value of the search input.                                                                                                                                               | `string \\| undefined`                         | `""`                                                                                                       |\n| `valueField`                | `value-field`                 | The custom name for the value field to correspond with the IcMenuOption type.                                                                                                | `string \\| undefined`                         | `"value"`                                                                                                  |\n\n\n## Events\n\n| Event              | Description                                                     | Type                                      |\n| ------------------ | --------------------------------------------------------------- | ----------------------------------------- |\n| `icChange`         | Emitted when the value has changed.                             | `CustomEvent<IcValueEventDetail>`         |\n| `icClear`          | Emitted when value is cleared with clear button                 | `CustomEvent<void>`                       |\n| `icInput`          | Emitted when a keyboard input occurred.                         | `CustomEvent<IcValueEventDetail>`         |\n| `icKeydown`        | Emitted when a keydown event occurred.                          | `CustomEvent<{ event: KeyboardEvent; }>`  |\n| `icMenuChange`     | Emitted when the state of the menu changes (i.e. open or close) | `CustomEvent<IcMenuChangeEventDetail>`    |\n| `icOptionSelect`   | Emitted when option is highlighted within the menu              | `CustomEvent<IcOptionSelectEventDetail>`  |\n| `icRetryLoad`      | Emitted when the \'retry loading\' button is clicked              | `CustomEvent<IcMultiValueEventDetail>`    |\n| `icSearchBarBlur`  | Emitted when blur is invoked from ic-search-bar                 | `CustomEvent<IcSearchBarBlurEventDetail>` |\n| `icSearchBarFocus` | Emitted when focus is invoked from ic-search-bar                | `CustomEvent<IcValueEventDetail>`         |\n| `icSubmitSearch`   | Emitted when the search value has been submitted                | `CustomEvent<IcValueEventDetail>`         |\n\n\n## Methods\n\n### `setFocus() => Promise<void>`\n\nSets focus on the native `input`.\n\n#### Returns\n\nType: `Promise<void>`\n\n\n\n\n## CSS Custom Properties\n\n| Name                | Description                |\n| ------------------- | -------------------------- |\n| `--ic-z-index-menu` | z-index of search bar menu |\n\n\n## Dependencies\n\n### Depends on\n\n- [ic-input-container](../ic-input-container)\n- [ic-input-label](../ic-input-label)\n- [ic-input-component-container](../ic-input-component-container)\n- [ic-button](../ic-button)\n- [ic-menu](../ic-menu)\n\n### Graph\n```mermaid\ngraph TD;\n  ic-search-bar --\x3e ic-input-container\n  ic-search-bar --\x3e ic-input-label\n  ic-search-bar --\x3e ic-input-component-container\n  ic-search-bar --\x3e ic-button\n  ic-search-bar --\x3e ic-menu\n  ic-input-label --\x3e ic-typography\n  ic-button --\x3e ic-typography\n  ic-button --\x3e ic-loading-indicator\n  ic-button --\x3e ic-tooltip\n  ic-loading-indicator --\x3e ic-typography\n  ic-tooltip --\x3e ic-typography\n  ic-menu --\x3e ic-loading-indicator\n  ic-menu --\x3e ic-typography\n  ic-menu --\x3e ic-button\n  style ic-search-bar fill:#f9f,stroke:#333,stroke-width:4px\n```\n\n----------------------------------------------\n\n\n';var ic_search_bar_stories=__webpack_require__("./src/components/ic-search-bar/ic-search-bar.stories.js");function _createMdxContent(props){return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.W8,{of:ic_search_bar_stories}),"\n",(0,jsx_runtime.jsx)(dist.oz,{children:readme_namespaceObject}),"\n",(0,jsx_runtime.jsx)(dist.om,{})]})}function MDXContent(props={}){const{wrapper:MDXLayout}={...(0,lib.R)(),...props.components};return MDXLayout?(0,jsx_runtime.jsx)(MDXLayout,{...props,children:(0,jsx_runtime.jsx)(_createMdxContent,{...props})}):_createMdxContent()}},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{R:()=>useMDXComponents,x:()=>MDXProvider});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const emptyComponents={},MDXContext=react__WEBPACK_IMPORTED_MODULE_0__.createContext(emptyComponents);function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0__.useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0__.useMemo((function(){return"function"==typeof components?components(contextComponents):{...contextComponents,...components}}),[contextComponents,components])}function MDXProvider(properties){let allComponents;return allComponents=properties.disableParentContext?"function"==typeof properties.components?properties.components(emptyComponents):properties.components||emptyComponents:useMDXComponents(properties.components),react__WEBPACK_IMPORTED_MODULE_0__.createElement(MDXContext.Provider,{value:allComponents},properties.children)}},"./node_modules/@storybook/blocks/dist sync recursive":module=>{function webpackEmptyContext(req){var e=new Error("Cannot find module '"+req+"'");throw e.code="MODULE_NOT_FOUND",e}webpackEmptyContext.keys=()=>[],webpackEmptyContext.resolve=webpackEmptyContext,webpackEmptyContext.id="./node_modules/@storybook/blocks/dist sync recursive",module.exports=webpackEmptyContext},"./node_modules/@storybook/core/dist/components sync recursive":module=>{function webpackEmptyContext(req){var e=new Error("Cannot find module '"+req+"'");throw e.code="MODULE_NOT_FOUND",e}webpackEmptyContext.keys=()=>[],webpackEmptyContext.resolve=webpackEmptyContext,webpackEmptyContext.id="./node_modules/@storybook/core/dist/components sync recursive",module.exports=webpackEmptyContext},"./node_modules/@storybook/core/dist/theming sync recursive":module=>{function webpackEmptyContext(req){var e=new Error("Cannot find module '"+req+"'");throw e.code="MODULE_NOT_FOUND",e}webpackEmptyContext.keys=()=>[],webpackEmptyContext.resolve=webpackEmptyContext,webpackEmptyContext.id="./node_modules/@storybook/core/dist/theming sync recursive",module.exports=webpackEmptyContext},"./src/components/ic-search-bar/ic-search-bar.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Basic:()=>Basic,CharactersUntilSuggestion:()=>CharactersUntilSuggestion,Default:()=>Default,Disabled:()=>Disabled,EmptyOptionListText:()=>EmptyOptionListText,ExternalFiltering:()=>ExternalFiltering,ExternalFilteringWithCustomLoadingMessages:()=>ExternalFilteringWithCustomLoadingMessages,ExternalFilteringWithLoading:()=>ExternalFilteringWithLoading,FullWidth:()=>FullWidth,HelperText:()=>HelperText,HiddenLabel:()=>HiddenLabel,HintText:()=>HintText,InAForm:()=>InAForm,LongOptionLabels:()=>LongOptionLabels,Playground:()=>Playground,QuerySearchMode:()=>QuerySearchMode,Small:()=>Small,WithCustomLabelAndValueFields:()=>WithCustomLabelAndValueFields,WithOptions:()=>WithOptions,WithOptionsNoFiltering:()=>WithOptionsNoFiltering,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Search bar",component:"ic-search-bar"},Default={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar label="What is your favourite coffee?">
      ...
      </script>`,name:"Basic"},WithCustomLabelAndValueFields={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
      ...
      </script>`,name:"With custom label and value fields"},WithOptions={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
        value="Flat White"
      ></ic-search-bar>
      <br />
      ...
      </script>`,name:"With options"},WithOptionsNoFiltering={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
      ...
      </script>`,name:"With options (no filtering)"},InAForm={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <form>
      <ic-search-bar
        name="search-01"
        label="What is your favourite coffee?"
      ></ic-search-bar>
    </form>`,name:"In a form"},HelperText={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
      ...
      </script>`,name:"Helper text"},Small={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
      label="What is your favourite coffee?"
      size="small"
    ></ic-search-bar>`,name:"Small"},HiddenLabel={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
      label="What is your favourite coffee?"
      hide-label
    ></ic-search-bar>`,name:"Hidden label"},Disabled={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
      label="What is your favourite coffee?"
      disabled
    ></ic-search-bar>`,name:"Disabled"},FullWidth={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
        full-width
        id="search2"
      ></ic-search-bar>
      ...
      </script>`,name:"Full width"},ExternalFiltering={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
      ...
      </script>`,name:"External filtering"},ExternalFilteringWithLoading={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="Search for coffee"
        placeholder="Type to search"
        debounce="300"
        disable-auto-filtering="true"
      ...
      <script>
        ...
        select.addEventListener("icChange", handleFilter);
        select.addEventListener("icRetryLoad", handleFilter);
      </script>`,name:"External filtering with loading"},ExternalFilteringWithCustomLoadingMessages={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="Search for coffee"
        placeholder="Type to search"
        debounce="300"
        disable-auto-filtering="true"
      ...
      <script>
        ...
        select.addEventListener("icChange", handleFilter);
        select.addEventListener("icRetryLoad", handleFilter);
      </script>`,name:"External filtering with custom loading messages"},QuerySearchMode={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
        search-mode="query"
      >
      </ic-search-bar>
      ...
      </script>`,name:"Query search mode"},EmptyOptionListText={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
      ...
      </script>`,name:"Empty option list text"},CharactersUntilSuggestion={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
      ...
      </script>`,name:"Characters until suggestion"},HintText={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar
        label="What is your favourite coffee?"
      ...
      </script>`,name:"Hint text"},LongOptionLabels={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-search-bar label="What is your favourite coffee?"></ic-search-bar>
      <script>
        document.querySelector("ic-search-bar").options = [
          {
