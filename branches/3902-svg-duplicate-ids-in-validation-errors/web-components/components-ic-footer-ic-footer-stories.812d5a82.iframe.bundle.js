...
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[7971,582,6199,6763],{"./src/components/ic-footer/ic-footer.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Brand:()=>Brand,Breakpoint:()=>Breakpoint,FooterWithNoCaptionOrLogoOrCopyright:()=>FooterWithNoCaptionOrLogoOrCopyright,FooterWithNoLinks:()=>FooterWithNoLinks,GroupedLinks:()=>GroupedLinks,Playground:()=>Playground,SlottedDescriptionAndCaption:()=>SlottedDescriptionAndCaption,UngroupedLinks:()=>UngroupedLinks,WithClassificationBanner:()=>WithClassificationBanner,WithLogoLinks:()=>WithLogoLinks,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Footer",component:"ic-footer"},Playground={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-footer
  ...
  </ic-footer>`,args:{aligned:"left",breakpoint:"medium",caption:"All content is available under the Open Government Licence v3.0, except source code and code examples which are available under the MIT Licence.",copyright:!0,description:"The ICDS is maintained by the Design Practice Team. If you've got a question or want to feedback, please get in touch.",groupLinks:!0},name:"Playground",argTypes:{aligned:{options:["center","full-width","left"],control:{type:"select"}},breakpoint:{options:["extra large","extra small","large","medium","small"],control:{type:"select"}}}},UngroupedLinks={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <ic-footer
