import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";import{n as i,t as a}from"./taggedTemplateLiteral-2dP4OITE.js";var o=e({AutoOpening:()=>M,BackgroundClosePrevented:()=>w,DisableHeightConstraint:()=>O,DisableWidthConstraint:()=>k,EventsExample:()=>E,HiddenCloseButton:()=>j,Playground:()=>N,Popover:()=>D,Scrollable:()=>T,ShowHideInteractiveElements:()=>A,Sizes:()=>x,SlottedContent:()=>S,SlottedTabs:()=>C,__namedExportsOrder:()=>P,default:()=>b}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F=t((()=>{n(),i(),y={closeOnBackdropClick:!0,destructive:!1,dismissLabel:`Dismiss`,disableHeightConstraint:!1,disableWidthConstraint:!1,hideCloseButton:!1,hideDefaultControls:!1,heading:`This is a dialog`,label:`Dialog`,open:!0,size:`medium`,theme:`inherit`},b={title:`Web Components/Dialog`,component:`ic-dialog`},x={render:()=>r(s||=a([`
    <script>
