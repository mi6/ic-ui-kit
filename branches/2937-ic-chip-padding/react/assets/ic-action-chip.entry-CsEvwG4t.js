import{a9 as S,ab as e,ac as A,ad as R}from"./iframe-TsSXbcUi.js";import{O as F}from"./OpenInNew-cdeed5ce-B20lTUtf.js";import{r as l,o as O,a as T,i as h,b as M}from"./helpers-0f85537f-CRTrRzaZ.js";import"./preload-helper-PPVm8Dsz.js";const D=`/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */
...
`,G=D,H=class{constructor(n){S(this,n),this.disabled=!1,this.download=!1,this.monochrome=!1,this.size="medium",this.theme="inherit",this.transparentBackground=!0,this.type="button",this.variant="filled"}watchDisabledHandler(){l(this.disabled,this.el)}disconnectedCallback(){var n;(n=this.hostMutationObserver)===null||n===void 0||n.disconnect()}componentWillLoad(){l(this.disabled,this.el)}componentDidLoad(){O([{prop:this.label,propName:"label"}],"Chip"),this.hostMutationObserver=new MutationObserver(n=>T(n,["icon","badge"],this)),this.hostMutationObserver.observe(this.el,{childList:!0})}async setFocus(){var n;(n=this.chipEl)===null||n===void 0||n.focus()}render(){const{disabled:n,download:i,form:p,formaction:b,formenctype:m,formmethod:u,formnovalidate:f,formtarget:v,href:t,hreflang:g,label:x,monochrome:y,referrerpolicy:k,rel:w,size:r,target:a,theme:c,transparentBackground:z,type:C,variant:d}=this,s=t?"a":"button",o=s==="button",E=o?{disabled:n,form:p,formaction:b,formenctype:m,formmethod:u,formnovalidate:f,formtarget:v,type:C}:{download:i!==!1?i:null,href:t,hreflang:g,referrerpolicy:k,rel:w,target:a};return e(A,{key:"095711b5abc9fe760f9c14245a1ce327696818a2",class:{[`ic-theme-${c}`]:c!=="inherit"}},e(s,Object.assign({key:"8b352bcd66bb27be4eff90246371eac0bfa266cb",class:{chip:!0,disabled:o&&n,monochrome:y,"non-transparent":d==="outlined"&&!z,[`${r}`]:!0,[`${d}`]:!0},ref:I=>this.chipEl=I},E),h(this.el,"icon")&&e("div",{key:"cac34c4420e0b92337b4421088389e79dc2d3e78",class:"icon"},e("slot",{key:"fbbdfcf2089a6a31785a33ddc74c66ad433ebe4c",name:"icon"})),e("div",{key:"575739cf84d834669a868d3078c41991246b7f38",class:{label:!0,[`${r}`]:!0}},e("ic-typography",{key:"b9a1b6828f921c225faadff9fb0d1e98dca6f955",variant:"label",class:{label:!0,"in-ag-grid":M(this.el)}},e("span",{key:"fce66f05c9f3af170cda306ef025dc0609ab3518"},x))),!o&&a==="_blank"&&e("span",{key:"f138ff7884e95758215b308f74875cc96aa0fe3a",class:"open-in-new-icon",innerHTML:F}),h(this.el,"badge")&&e("slot",{key:"507327587b32918bf6f97b54e1648b29942bac05",name:"badge"})))}static get delegatesFocus(){return!0}get el(){return R(this)}static get watchers(){return{disabled:["watchDisabledHandler"]}}};H.style=G;export{H as ic_action_chip};
