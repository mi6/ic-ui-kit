import{b as n}from"./lit-html-B6sBSybp.js";const u={title:"Web Components/Card Horizontal",component:"ic-card-horizontal"},o={render:()=>n`<ic-card-horizontal heading="Card heading"></ic-card-horizontal>`,name:"Default"},i={render:()=>n`<ic-card-horizontal
  ...
  name: "Custom width"
}`,...b.parameters?.docs?.source}}};const z=["Default","Message","Icon","InteractionButton","Subheading","SubheadingSlot","Adornment","Badge","Clickable","ClickableHref","WrappedByLink","ImageLeft","ImageRight","Sizes","Density","Truncation","Disabled","SlottedContent","CustomWidth"],C=Object.freeze(Object.defineProperty({__proto__:null,Adornment:e,Badge:g,Clickable:r,ClickableHref:p,CustomWidth:b,Default:o,Density:w,Disabled:y,Icon:l,ImageLeft:h,ImageRight:d,InteractionButton:t,Message:i,Sizes:f,SlottedContent:v,Subheading:a,SubheadingSlot:s,Truncation:m,WrappedByLink:c,__namedExportsOrder:z,default:u},Symbol.toStringTag,{value:"Module"}));export{C as I};
