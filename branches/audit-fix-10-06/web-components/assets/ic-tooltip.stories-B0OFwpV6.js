var v=Object.freeze,$=Object.defineProperty;var i=(t,S)=>v($(t,"raw",{value:v(S||t.slice())}));import{b as o}from"./lit-html-B6sBSybp.js";const L={disableHover:!1,maxLines:3,placement:"bottom",label:"This is a description of the button",theme:"inherit",fixedPositioning:!1},k={...L,iconSlot:"icon",tooltipIconAltText:"Check mark icon"},I={title:"Web Components/Tooltip",component:"ic-tooltip"},e={render:()=>o`<ic-tooltip
  ...
  `,name:"With Icon"},d={render:()=>o`<ic-tooltip
    ...
    </div> `,args:k,argTypes:{placement:{options:["bottom","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom-start","left-end","left","left-start"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}},iconSlot:{options:["icon",""],control:{type:"select"}},tooltipIconAltText:{control:{type:"text"}}},name:"Playground With Icon"};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
