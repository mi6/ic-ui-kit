/*! For license information please see components-ic-toggle-button-ic-toggle-button-stories-mdx.2315e884.iframe.bundle.js.LICENSE.txt */
(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[5105],{"./node_modules/@storybook/addon-docs/dist/index.mjs":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{Xz:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.Xz,dk:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.dk,h_:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.h_,oG:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.oG});__webpack_require__("./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var _storybook_blocks__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@storybook/blocks/dist/index.mjs")},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{NF:()=>withMDXComponents,Zo:()=>MDXProvider,ah:()=>useMDXComponents,pC:()=>MDXContext});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const MDXContext=react__WEBPACK_IMPORTED_MODULE_0__.createContext({});function withMDXComponents(Component){return function boundMDXComponent(props){const allComponents=useMDXComponents(props.components);return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component,{...props,allComponents})}}function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0__.useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0__.useMemo((()=>"function"==typeof components?components(contextComponents):{...contextComponents,...components}),[contextComponents,components])}const emptyObject={};function MDXProvider({components,children,disableParentContext}){let allComponents;return allComponents=disableParentContext?"function"==typeof components?components({}):components||emptyObject:useMDXComponents(components),react__WEBPACK_IMPORTED_MODULE_0__.createElement(MDXContext.Provider,{value:allComponents},children)}},"./src/components/ic-toggle-button/ic-toggle-button.stories.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,appearanceDark:()=>appearanceDark,appearanceLight:()=>appearanceLight,checked:()=>checked,default:()=>ic_toggle_button_stories,defaultStory:()=>defaultStory,disabled:()=>disabled,fullWidth:()=>fullWidth,iconOnly:()=>iconOnly,iconRight:()=>iconRight,iconTop:()=>iconTop,loading:()=>loading,sizes:()=>sizes,withBadge:()=>withBadge,withIcon:()=>withIcon});__webpack_require__("./node_modules/react/index.js");var lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-docs/dist/index.mjs"),lit_html=__webpack_require__("./node_modules/lit-html/lit-html.js");const readme_namespaceObject='# ic-toggle-button\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property          | Attribute          | Description                                                                                                              | Type                              | Default     |\n| ----------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------ | --------------------------------- | ----------- |\n| `accessibleLabel` | `accessible-label` | The accessible label that will be applied to the toggle button. This is required for the icon variant of toggle buttons. | `string`                          | `undefined` |\n| `appearance`      | `appearance`       | The appearance of the toggle button.                                                                                     | `"dark" \\| "default" \\| "light"`  | `"default"` |\n| `disabled`        | `disabled`         | If `true`, the toggle button will be in disabled state.                                                                  | `boolean`                         | `false`     |\n| `fullWidth`       | `full-width`       | If `true`, the toggle button will fill the width of the container.                                                       | `boolean`                         | `false`     |\n| `iconPlacement`   | `icon-placement`   | The placement of the icon in relation to the toggle button label.                                                        | `"left" \\| "right" \\| "top"`      | `undefined` |\n| `label`           | `label`            | The label to display in the toggle button. This is required for the default variant of toggle buttons.                   | `string`                          | `undefined` |\n| `loading`         | `loading`          | If `true`, the toggle button will be in loading state.                                                                   | `boolean`                         | `false`     |\n| `size`            | `size`             | The size of the toggle button to be displayed.                                                                           | `"default" \\| "large" \\| "small"` | `"default"` |\n| `toggleChecked`   | `toggle-checked`   | If `true`, the toggle button will be in a checked state.                                                                 | `boolean`                         | `false`     |\n| `variant`         | `variant`          | The variant of the toggle button.                                                                                        | `"default" \\| "icon"`             | `"default"` |\n\n\n## Events\n\n| Event             | Description                                   | Type                                 |\n| ----------------- | --------------------------------------------- | ------------------------------------ |\n| `icToggleChecked` | Emitted when the user clicks a toggle button. | `CustomEvent<{ checked: boolean; }>` |\n\n\n## Slots\n\n| Slot      | Description                                                    |\n| --------- | -------------------------------------------------------------- |\n| `"badge"` | Badge component overlaying the top right of the toggle button. |\n| `"icon"`  | Content will be displayed alongside the toggle button label.   |\n\n\n## Dependencies\n\n### Depends on\n\n- [ic-button](../ic-button)\n\n### Graph\n```mermaid\ngraph TD;\n  ic-toggle-button --\x3e ic-button\n  ic-button --\x3e ic-loading-indicator\n  ic-button --\x3e ic-tooltip\n  ic-loading-indicator --\x3e ic-typography\n  ic-tooltip --\x3e ic-typography\n  style ic-toggle-button fill:#f9f,stroke:#333,stroke-width:4px\n```\n\n----------------------------------------------\n\n\n';var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function _createMdxContent(props){const _components=Object.assign({h3:"h3"},(0,lib.ah)(),props.components);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.h_,{title:"Web Components/Toggle button",component:"ic-toggle-button"}),"\n",(0,jsx_runtime.jsx)(dist.dk,{markdown:readme_namespaceObject}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"default",children:"Default"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Default",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<ic-toggle-button label="Toggle"></ic-toggle-button>
      ...
      </script>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"checked",children:"Checked"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Checked",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<ic-toggle-button
        label="Toggle"
        toggle-checked="true"
    ...
    >
      <ic-toggle-button label="Toggle" appearance="light"></ic-toggle-button>
        ...
        label="Toggle"
        full-width="true"
      ></ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"loading",children:"Loading"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Loading",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<ic-toggle-button label="Toggle" loading="true"></ic-toggle-button>
        <ic-toggle-button
          label="Toggle"
          loading="true"
          toggle-checked="true"
        ></ic-toggle-button>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon-only",children:"Icon only"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Icon only",parameters:{loki:{skip:!0}},children:args=>lit_html.dy`<ic-toggle-button
        variant="icon"
    ...
    >
      <ic-toggle-button label="Toggle" appearance="light"></ic-toggle-button>
        ...
        label="Toggle"
        full-width="true"
      ></ic-toggle-button>`;fullWidth.storyName="Full width",fullWidth.parameters={storySource:{source:'args => html`<ic-toggle-button\n        label="Toggle"\n        full-width="true"\n      ></ic-toggle-button>`'},loki:{skip:!0}};const loading=args=>lit_html.dy`<ic-toggle-button label="Toggle" loading="true"></ic-toggle-button>
        <ic-toggle-button
          label="Toggle"
          loading="true"
          toggle-checked="true"
        ></ic-toggle-button>`;loading.storyName="Loading",loading.parameters={storySource:{source:'args => html`<ic-toggle-button label="Toggle" loading="true"></ic-toggle-button>\n        <ic-toggle-button\n          label="Toggle"\n          loading="true"\n          toggle-checked="true"\n        ></ic-toggle-button>`'},loki:{skip:!0}};const iconOnly=args=>lit_html.dy`<ic-toggle-button
        variant="icon"
        accessible-label="Refresh the page"
      >
        <svg
      ...
      </ic-toggle-button>`;iconOnly.storyName="Icon only",iconOnly.parameters={storySource:{source:'args => html`<ic-toggle-button\n        variant="icon"\n        accessible-label="Refresh the page"\n      >\n        <svg\n          xmlns="http://www.w3.org/2000/svg"\n          height="24px"\n          viewBox="0 0 24 24"\n          width="24px"\n          fill="#000000"\n        >\n          <path d="M0 0h24v24H0V0z" fill="none" />\n          <path\n            d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"\n          />\n        </svg>\n      </ic-toggle-button>\n      <ic-toggle-button\n        variant="icon"\n        disabled="true"\n        accessible-label="Refresh the page"\n      >\n        <svg\n          xmlns="http://www.w3.org/2000/svg"\n          height="24px"\n          viewBox="0 0 24 24"\n          width="24px"\n          fill="#000000"\n        >\n          <path d="M0 0h24v24H0V0z" fill="none" />\n          <path\n            d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"\n          />\n        </svg>\n      </ic-toggle-button>`'},loki:{skip:!0}};const iconRight=args=>lit_html.dy`<ic-toggle-button label="Toggle" icon-placement="right">
      <svg
        slot="icon"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
...
//# sourceMappingURL=components-ic-toggle-button-ic-toggle-button-stories-mdx.2315e884.iframe.bundle.js.map