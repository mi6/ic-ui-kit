...
(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[3169],{"./node_modules/@storybook/addon-docs/dist/index.mjs":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{Hl:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.Hl,VY:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.VY,W8:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.W8,gG:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.gG,oz:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.oz});__webpack_require__("./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var _storybook_blocks__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@storybook/blocks/dist/index.mjs")},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{BN:()=>MDXContext,RP:()=>useMDXComponents,gz:()=>withMDXComponents,xA:()=>MDXProvider});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const MDXContext=react__WEBPACK_IMPORTED_MODULE_0__.createContext({});function withMDXComponents(Component){return function boundMDXComponent(props){const allComponents=useMDXComponents(props.components);return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component,{...props,allComponents})}}function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0__.useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0__.useMemo((()=>"function"==typeof components?components(contextComponents):{...contextComponents,...components}),[contextComponents,components])}const emptyObject={};function MDXProvider({components,children,disableParentContext}){let allComponents;return allComponents=disableParentContext?"function"==typeof components?components({}):components||emptyObject:useMDXComponents(components),react__WEBPACK_IMPORTED_MODULE_0__.createElement(MDXContext.Provider,{value:allComponents},children)}},"./src/components/ic-loading-indicator/ic-loading-indicator.stories.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,changingLabel:()=>changingLabel,circularDarkMode:()=>circularDarkMode,circularDeterminate:()=>circularDeterminate,circularIndeterminate:()=>circularIndeterminate,circularLongLabel:()=>circularLongLabel,circularVariantsDeterminate:()=>circularVariantsDeterminate,circularVariantsIndeterminate:()=>circularVariantsIndeterminate,default:()=>ic_loading_indicator_stories,defaultArgTypes:()=>defaultArgTypes,defaultArgs:()=>defaultArgs,icon:()=>icon,iconDarkMode:()=>iconDarkMode,linearDarkMode:()=>linearDarkMode,linearDeterminate:()=>linearDeterminate,linearIndeterminate:()=>linearIndeterminate,linearLongLabel:()=>linearLongLabel,linearVariantsDeterminate:()=>linearVariantsDeterminate,linearVariantsIndeterminate:()=>linearVariantsIndeterminate,monochrome:()=>monochrome,noLabel:()=>noLabel,playgroundDeterminate:()=>playgroundDeterminate,playgroundIndeterminate:()=>playgroundIndeterminate,progressIndicatorForCompactStep:()=>progressIndicatorForCompactStep});__webpack_require__("./node_modules/react/index.js");var lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-docs/dist/index.mjs"),lit_html=__webpack_require__("./node_modules/lit-html/lit-html.js");const readme_namespaceObject='# ic-loading\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property        | Attribute        | Description                                                                                                                             | Type                                       | Default      |\n| --------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ------------ |\n| `description`   | `description`    | The description that will be set as the aria-label of the loading indicator when not using a visible label.                             | `string`                                   | `"Loading"`  |\n| `fullWidth`     | `full-width`     | If `true`, when linear, the full-width variant (i.e. without a border radius) will be displayed.                                        | `boolean`                                  | `false`      |\n| `label`         | `label`          | The label to be displayed beneath the loading indicator. Display a changing label by supplying an array of messages.                    | `string \\| string[]`                       | `undefined`  |\n| `labelDuration` | `label-duration` | The time in milliseconds before the label changes.                                                                                      | `number`                                   | `8000`       |\n| `max`           | `max`            | The maximum value that the progress value can take. Used to calculate the proportional width of the progress bar.                       | `number`                                   | `100`        |\n| `min`           | `min`            | The minimum value that the progress value can take. Used to calculate the proportional width of the progress bar.                       | `number`                                   | `0`          |\n| `monochrome`    | `monochrome`     | If `true`, the element will display as black and white.                                                                                 | `boolean`                                  | `false`      |\n| `progress`      | `progress`       | The current amount of progress made. If not provided, component acts as an indeterminate loading indicator.                             | `number`                                   | `undefined`  |\n| `size`          | `size`           | The size of the loading indicator.                                                                                                      | `"icon" \\| "large" \\| "medium" \\| "small"` | `"medium"`   |\n| `theme`         | `theme`          | Sets the theme color to the dark or light theme color. "inherit" will set the color based on the system settings or ic-theme component. | `"dark" \\| "inherit" \\| "light"`           | `"inherit"`  |\n| `type`          | `type`           | The type of indicator, either linear or circular.                                                                                       | `"circular" \\| "linear"`                   | `"circular"` |\n\n\n## Shadow Parts\n\n| Part                     | Description |\n| ------------------------ | ----------- |\n| `"ic-loading-container"` |             |\n\n\n## CSS Custom Properties\n\n| Name                  | Description                        |\n| --------------------- | ---------------------------------- |\n| `--circular-diameter` | Diameter of the circular-indicator |\n\n\n## Dependencies\n\n### Used by\n\n - [ic-button](../ic-button)\n - [ic-menu](../ic-menu)\n - [ic-step](../ic-step)\n - [ic-toast](../ic-toast)\n\n### Depends on\n\n- [ic-typography](../ic-typography)\n\n### Graph\n```mermaid\ngraph TD;\n  ic-loading-indicator --\x3e ic-typography\n  ic-button --\x3e ic-loading-indicator\n  ic-menu --\x3e ic-loading-indicator\n  ic-step --\x3e ic-loading-indicator\n  ic-toast --\x3e ic-loading-indicator\n  style ic-loading-indicator fill:#f9f,stroke:#333,stroke-width:4px\n```\n\n----------------------------------------------\n\n\n';var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const defaultArgs={monochrome:!1,description:"Loading",fullWidth:!1,labelDuration:8e3,size:"medium",type:"circular",label:null,theme:"inherit"},defaultArgTypes={label:{control:{type:"text"}},size:{options:["small","medium","large","icon"],control:{type:"radio"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}},type:{options:["circular","linear"],control:{type:"radio"}}};function _createMdxContent(props){const _components=Object.assign({h3:"h3"},(0,lib.RP)(),props.components);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.W8,{title:"Web Components/Loading",component:"ic-loading-indicator"}),"\n",(0,jsx_runtime.jsx)(dist.VY,{markdown:readme_namespaceObject}),"\n","\n","\n",(0,jsx_runtime.jsx)(_components.h3,{id:"circular-indeterminate",children:"Circular (indeterminate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Circular (indeterminate)",children:args=>lit_html.qy`<ic-loading-indicator label="Loading..."></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"circular-determinate",children:"Circular (determinate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Circular (determinate)",children:args=>lit_html.qy`<ic-loading-indicator
      ...
      ></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"circular-variants-indeterminate",children:"Circular variants (indeterminate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Circular variants (indeterminate)",children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
      ...
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"circular-variants-determinate",children:"Circular variants (determinate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Circular variants (determinate)",children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          progress="30"
          min="0"
          max="100"
        ...
        <ic-loading-indicator
          ...
          size="large"
        ></ic-loading-indicator>
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon",children:"Icon"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Icon",children:args=>lit_html.qy`<ic-loading-indicator size="icon"></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"linear-indeterminate",children:"Linear (indeterminate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Linear (indeterminate)",children:args=>lit_html.qy`<ic-loading-indicator
        label="Loading..."
        type="linear"
      ></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"linear-determinate",children:"Linear (determinate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Linear (determinate)",children:args=>lit_html.qy`<ic-loading-indicator
        progress="30"
        min="0"
        max="100"
        label="Progress"
        type="linear"
      ></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"linear-long-label",children:"Linear long label"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Linear long label",children:args=>lit_html.qy`<ic-loading-indicator
        type="linear"
        label="This is a label for a loading indicator that is indeterminate and should wrap onto more than one line when it gets too long"
      ></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"linear-variants-indeterminate",children:"Linear variants (indeterminate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Linear variants (indeterminate)",children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          label="Small"
          size="small"
          type="linear"
        ...
        <ic-loading-indicator
          ...
          full-width="true"
        ></ic-loading-indicator>
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"linear-variants-determinate",children:"Linear variants (determinate)"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Linear variants (determinate)",children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          progress="30"
          min="0"
          max="100"
        ...
        <ic-loading-indicator
          ...
          full-width="true"
        ></ic-loading-indicator>
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"circular-dark-mode",children:"Circular dark mode"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Circular dark mode",parameters:{backgrounds:{default:"dark"}},children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          label="Small"
          size="small"
          theme="dark"
        ...
        <ic-loading-indicator
          ...
          theme="dark"
        ></ic-loading-indicator>
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon-dark-mode",children:"Icon dark mode"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Icon dark mode",parameters:{backgrounds:{default:"dark"}},children:args=>lit_html.qy`<ic-loading-indicator
        size="icon"
        theme="dark"
      ></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"linear-dark-mode",children:"Linear dark mode"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Linear dark mode",parameters:{backgrounds:{default:"dark"}},children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          label="Default"
          type="linear"
          theme="dark"
        ...
        <ic-loading-indicator
          ...
          theme="dark"
        ></ic-loading-indicator>
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"monochrome",children:"Monochrome"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Monochrome",children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          label="Light"
          monochrome="true"
        ></ic-loading-indicator>
      ...
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"no-label",children:"No label"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"No label",children:args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        ...
        ><ic-loading-indicator
          ...
          type="linear"
        ></ic-loading-indicator>
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"changing-label",children:"Changing label"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Changing label",children:args=>lit_html.qy`<ic-loading-indicator label-duration="4000"></ic-loading-indicator>
        <script>
          document.querySelector("ic-loading-indicator").label = [
            "Loading...",
            "Still loading...",
          ];
        </script> `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"progress-indicator-for-compact-step",children:"Progress indicator for compact step"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Progress indicator for compact step",args:defaultArgs,argTypes:defaultArgTypes,children:args=>lit_html.qy`<ic-loading-indicator
        size="small"
        inner-label="3"
        progress="30"
        min="0"
        max="100"
      ></ic-loading-indicator>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"playground---indeterminate",children:"Playground - indeterminate"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{args:defaultArgs,argTypes:defaultArgTypes,name:"Playground - indeterminate",children:args=>lit_html.qy`<div
      ...
      </div>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"playground---determinate",children:"Playground - determinate"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{args:{...defaultArgs,max:100,min:0,progress:30},argTypes:defaultArgTypes,name:"Playground - determinate",children:args=>lit_html.qy`<div
        style="background-color: ${"dark"===args.theme?"#393939":"#FFFFFF"}; padding: 16px;"
      >
        <ic-loading-indicator
          monochrome=${args.monochrome}
      ...
      ></ic-loading-indicator>`;linearLongLabel.storyName="Linear long label",linearLongLabel.parameters={storySource:{source:'args => html`<ic-loading-indicator\n        type="linear"\n        label="This is a label for a loading indicator that is indeterminate and should wrap onto more than one line when it gets too long"\n      ></ic-loading-indicator>`'}};const linearVariantsIndeterminate=args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        ...
        <ic-loading-indicator
          ...
          theme="dark"
        ></ic-loading-indicator>
      </div>`;circularDarkMode.storyName="Circular dark mode",circularDarkMode.parameters={storySource:{source:'args => html`<div style="display: grid; gap: 50px;">\n        <ic-loading-indicator\n          label="Small"\n          size="small"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          label="Default"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          label="Large"\n          size="large"\n          theme="dark"\n        ></ic-loading-indicator>\n      </div>`'},backgrounds:{default:"dark"}};const iconDarkMode=args=>lit_html.qy`<ic-loading-indicator
        size="icon"
        theme="dark"
      ></ic-loading-indicator>`;iconDarkMode.storyName="Icon dark mode",iconDarkMode.parameters={storySource:{source:'args => html`<ic-loading-indicator\n        size="icon"\n        theme="dark"\n      ></ic-loading-indicator>`'},backgrounds:{default:"dark"}};const linearDarkMode=args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          label="Default"
          type="linear"
          theme="dark"
        ...
        <ic-loading-indicator
          ...
          theme="dark"
        ></ic-loading-indicator>
      </div>`;linearDarkMode.storyName="Linear dark mode",linearDarkMode.parameters={storySource:{source:'args => html`<div style="display: grid; gap: 50px;">\n        <ic-loading-indicator\n          label="Default"\n          type="linear"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          label="Large"\n          size="large"\n          type="linear"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          label="Full-width"\n          type="linear"\n          full-width="true"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          progress="30"\n          min="0"\n          max="100"\n          label="Default"\n          type="linear"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          progress="30"\n          min="0"\n          max="100"\n          label="Large"\n          size="large"\n          type="linear"\n          theme="dark"\n        ></ic-loading-indicator>\n        <ic-loading-indicator\n          progress="30"\n          min="0"\n          max="100"\n          label="Full-width"\n          type="linear"\n          full-width="true"\n          theme="dark"\n        ></ic-loading-indicator>\n      </div>`'},backgrounds:{default:"dark"}};const monochrome=args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator
          label="Light"
          monochrome="true"
        ></ic-loading-indicator>
      ...
      </div>`;monochrome.storyName="Monochrome",monochrome.parameters={storySource:{source:'args => html`<div style="display: grid; gap: 50px;">\n        <ic-loading-indicator\n          label="Light"\n          monochrome="true"\n        ></ic-loading-indicator>\n        <div style="background-color: black">\n          <ic-loading-indicator\n            label="Dark"\n            theme="dark"\n            monochrome="true"\n          ></ic-loading-indicator>\n        </div>\n        <ic-loading-indicator\n          size="icon"\n          monochrome="true"\n        ></ic-loading-indicator>\n        <div\n          style="background-color: black; display: flex; justify-content: center"\n        >\n          <ic-loading-indicator\n            size="icon"\n            theme="dark"\n            monochrome="true"\n          ></ic-loading-indicator>\n        </div>\n        <ic-loading-indicator\n          label="Light"\n          type="linear"\n          monochrome="true"\n        ></ic-loading-indicator>\n        <div style="background-color: black; padding: var(--ic-space-xs)">\n          <ic-loading-indicator\n            label="Dark"\n            type="linear"\n            theme="dark"\n            monochrome="true"\n          ></ic-loading-indicator>\n        </div>\n      </div>`'}};const noLabel=args=>lit_html.qy`<div style="display: grid; gap: 50px;">
        <ic-loading-indicator description="Loading"></ic-loading-indicator
        ><ic-loading-indicator
          progress="30"
          min="0"
        ...
        ><ic-loading-indicator
          ...
          type="linear"
        ></ic-loading-indicator>
      </div>`;noLabel.storyName="No label",noLabel.parameters={storySource:{source:'args => html`<div style="display: grid; gap: 50px;">\n        <ic-loading-indicator description="Loading"></ic-loading-indicator\n        ><ic-loading-indicator\n          progress="30"\n          min="0"\n          max="100"\n          description="Loading"\n        ></ic-loading-indicator\n        ><ic-loading-indicator\n          description="Loading"\n          type="linear"\n        ></ic-loading-indicator\n        ><ic-loading-indicator\n          progress="30"\n          min="0"\n          max="100"\n          description="Loading"\n          type="linear"\n        ></ic-loading-indicator>\n      </div>`'}};const changingLabel=args=>lit_html.qy`<ic-loading-indicator label-duration="4000"></ic-loading-indicator>
        <script>
          document.querySelector("ic-loading-indicator").label = [
            "Loading...",
            "Still loading...",
          ];
        </script> `;changingLabel.storyName="Changing label",changingLabel.parameters={storySource:{source:'args => html`<ic-loading-indicator label-duration="4000"></ic-loading-indicator>\n        <script>\n          document.querySelector("ic-loading-indicator").label = [\n            "Loading...",\n            "Still loading...",\n          ];\n        <\/script> `'}};const progressIndicatorForCompactStep=args=>lit_html.qy`<ic-loading-indicator
        size="small"
        inner-label="3"
        progress="30"
        min="0"
        max="100"
      ></ic-loading-indicator>`;progressIndicatorForCompactStep.storyName="Progress indicator for compact step",progressIndicatorForCompactStep.argTypes=defaultArgTypes,progressIndicatorForCompactStep.args=defaultArgs,progressIndicatorForCompactStep.parameters={storySource:{source:'args => html`<ic-loading-indicator\n        size="small"\n        inner-label="3"\n        progress="30"\n        min="0"\n        max="100"\n      ></ic-loading-indicator>`'}};const playgroundIndeterminate=args=>lit_html.qy`<div
        style="background-color: ${"dark"===args.theme?"#393939":"#FFFFFF"}; padding: 16px;"
      >
        <ic-loading-indicator
          monochrome=${args.monochrome}
