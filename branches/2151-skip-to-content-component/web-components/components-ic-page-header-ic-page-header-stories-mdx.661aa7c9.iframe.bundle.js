...
(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[4307],{"./node_modules/@storybook/addon-docs/dist/index.mjs":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{Hl:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.Hl,VY:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.VY,W8:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.W8,gG:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.gG,oz:()=>_storybook_blocks__WEBPACK_IMPORTED_MODULE_1__.oz});__webpack_require__("./node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs");var _storybook_blocks__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/@storybook/blocks/dist/index.mjs")},"./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.d(__webpack_exports__,{BN:()=>MDXContext,RP:()=>useMDXComponents,gz:()=>withMDXComponents,xA:()=>MDXProvider});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const MDXContext=react__WEBPACK_IMPORTED_MODULE_0__.createContext({});function withMDXComponents(Component){return function boundMDXComponent(props){const allComponents=useMDXComponents(props.components);return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component,{...props,allComponents})}}function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0__.useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0__.useMemo((()=>"function"==typeof components?components(contextComponents):{...contextComponents,...components}),[contextComponents,components])}const emptyObject={};function MDXProvider({components,children,disableParentContext}){let allComponents;return allComponents=disableParentContext?"function"==typeof components?components({}):components||emptyObject:useMDXComponents(components),react__WEBPACK_IMPORTED_MODULE_0__.createElement(MDXContext.Provider,{value:allComponents},children)}},"./src/components/ic-page-header/ic-page-header.stories.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,centerAligned:()=>centerAligned,componentOverrides:()=>componentOverrides,darkTheme:()=>darkTheme,default:()=>ic_page_header_stories,defaultArgs:()=>defaultArgs,fullWidth:()=>fullWidth,headingWithAdornment:()=>headingWithAdornment,leftAligned:()=>leftAligned,playground:()=>playground,small:()=>small,sticky:()=>sticky,stickyForLargeAndExtraLargeBreakpointsOnly:()=>stickyForLargeAndExtraLargeBreakpointsOnly,stickyWithContentAndFooter:()=>stickyWithContentAndFooter,withActions:()=>withActions,withBreadcrumbs:()=>withBreadcrumbs,withBreadcrumbsInputActionsAndStepper:()=>withBreadcrumbsInputActionsAndStepper,withBreadcrumbsInputActionsAndStepperAndLongTitle:()=>withBreadcrumbsInputActionsAndStepperAndLongTitle,withBreadcrumbsInputActionsAndTabs:()=>withBreadcrumbsInputActionsAndTabs,withInput:()=>withInput,withStepper:()=>withStepper,withTabs:()=>withTabs,withoutBorder:()=>withoutBorder});__webpack_require__("./node_modules/react/index.js");var lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-docs/dist/index.mjs"),lit_html=__webpack_require__("./node_modules/lit-html/lit-html.js");const readme_namespaceObject='# ic-page-header\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property            | Attribute             | Description                                                                                                                                       | Type                                 | Default     |\n| ------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ----------- |\n| `aligned`           | `aligned`             | The alignment of the page header.                                                                                                                 | `"center" \\| "full-width" \\| "left"` | `"left"`    |\n| `border`            | `border`              | If `true`, a border will be displayed along the bottom of the page header.                                                                        | `boolean`                            | `true`      |\n| `heading`           | `heading`             | The title to render on the page header.                                                                                                           | `string`                             | `undefined` |\n| `reverseOrder`      | `reverse-order`       | If `true`, the reading pattern and tab order will change in the action area for viewport widths of above 576px and when actions have not wrapped. | `boolean`                            | `false`     |\n| `size`              | `size`                | The size of the page header component.                                                                                                            | `"medium" \\| "small"`                | `"medium"`  |\n| `sticky`            | `sticky`              | If `true`, the page header will be sticky at all breakpoints.                                                                                     | `boolean`                            | `false`     |\n| `stickyDesktopOnly` | `sticky-desktop-only` | If `true`, the page header will only be sticky for viewport widths of 992px and above.                                                            | `boolean`                            | `false`     |\n| `subheading`        | `subheading`          | The subtitle to render on the page header.                                                                                                        | `string`                             | `undefined` |\n| `theme`             | `theme`               | Sets the theme color to the dark or light theme color. "inherit" will set the color based on the system settings or ic-theme component.           | `"dark" \\| "inherit" \\| "light"`     | `"inherit"` |\n\n\n## Slots\n\n| Slot                  | Description                                                                                                                                                |\n| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |\n| `"actions"`           | Content will be rendered in the action area, adjacent to the title area.                                                                                   |\n| `"breadcrumbs"`       | Content will be rendered in the breadcrumb area, above the title and action areas.                                                                         |\n| `"heading"`           | Content will be rendered in the title area, in place of the heading.                                                                                       |\n| `"heading-adornment"` | Content will be rendered in the title area, adjacent to the heading.                                                                                       |\n| `"input"`             | Content will be rendered in the input area, below the title area and adjacent to the action area.                                                          |\n| `"stepper"`           | Content will be rendered in the navigation area, below the title and action areas. Note: stepper slot cannot be used when the tabs slot is being used.     |\n| `"subheading"`        | Content will be rendered in the title area, in place of the subheading.                                                                                    |\n| `"tabs"`              | Content will be rendered in the navigation area, below the title and action areas. Note: the stepper slot cannot be used when the tabs slot is being used. |\n\n\n## CSS Custom Properties\n\n| Name                       | Description            |\n| -------------------------- | ---------------------- |\n| `--ic-z-index-page-header` | z-index of page-header |\n\n\n## Dependencies\n\n### Depends on\n\n- [ic-section-container](../ic-section-container)\n- [ic-typography](../ic-typography)\n- [ic-horizontal-scroll](../ic-horizontal-scroll)\n\n### Graph\n```mermaid\ngraph TD;\n  ic-page-header --\x3e ic-section-container\n  ic-page-header --\x3e ic-typography\n  ic-page-header --\x3e ic-horizontal-scroll\n  ic-horizontal-scroll --\x3e ic-button\n  ic-button --\x3e ic-loading-indicator\n  ic-button --\x3e ic-tooltip\n  ic-loading-indicator --\x3e ic-typography\n  ic-tooltip --\x3e ic-typography\n  style ic-page-header fill:#f9f,stroke:#333,stroke-width:4px\n```\n\n----------------------------------------------\n\n\n';var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const defaultArgs={aligned:"left",border:!0,heading:"Latte recipe","reverse-order":!1,size:"medium",sticky:!1,"sticky-desktop-only":!1,subheading:"A Latte is a popular Italian coffee, made with espresso, steamed milk and a thin layer of foam.",theme:"inherit","--ic-page-header-text-primary":"","--ic-page-header-background":"","--ic-page-header-border":"","--ic-page-header-text-tertiary":"","--ic-page-header-placeholder-text-field":""};function _createMdxContent(props){const _components=Object.assign({h3:"h3",p:"p",ul:"ul",li:"li"},(0,lib.RP)(),props.components);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.W8,{title:"Web Components/Page header",component:"ic-page-header",parameters:{layout:"fullscreen"}}),"\n",(0,jsx_runtime.jsx)(dist.VY,{markdown:readme_namespaceObject}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"playground",children:"Playground"}),"\n","\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{args:defaultArgs,name:"Playground",parameters:{layout:"fullscreen"},argTypes:{aligned:{options:["center","full-width","left"],control:{type:"inline-radio"}},size:{options:["medium","small"],control:{type:"inline-radio"}},theme:{options:["inherit","dark","light"],control:{type:"radio"}},"--ic-page-header-text-primary":{control:{type:"color"}},"--ic-page-header-background":{control:{type:"color"}},"--ic-page-header-border":{control:{type:"color"}},"--ic-page-header-text-tertiary":{control:{type:"color"}},"--ic-page-header-placeholder-text-field":{control:{type:"color"}}},children:args=>lit_html.qy`<ic-page-header
      ...
      ${""!==args["--ic-page-header-placeholder-text-field"]?`--ic-page-header-placeholder-text-field: ${args["--ic-page-header-placeholder-text-field"]};`:""}"
        ...
        <ic-section-container aligned=${args.aligned}>
          ...
          <ic-typography
            ...
            nec, ultricies sed, dolor.</ic-typography
          >
          <ic-typography
          ...
          <ic-typography
            ...
            adipiscing ante non diam sodales hendrerit.</ic-typography
          >
          <ic-typography
            >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non
            risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"small",children:"Small"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Small",children:lit_html.qy`
      <ic-page-header
        aligned="left"
        heading="Page header"
        subheading="This is a simple page header component and this is the text."
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"without-border",children:"Without border"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Without border",children:lit_html.qy`
      <ic-page-header heading="Page header" border="false">
        <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>
      </ic-page-header>
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"center-aligned",children:"Center aligned"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Center aligned",children:lit_html.qy`
      <ic-page-header
        aligned="center"
        heading="Page header"
        subheading="This is a simple page header component and this is the text."
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"sticky",children:"Sticky"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Sticky",children:lit_html.qy`
      <ic-page-header
        sticky
        heading="Page header"
        subheading="This is a simple page header component and this is the text."
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"sticky-with-content-and-footer",children:"Sticky with content and footer"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Sticky with content and footer",children:lit_html.qy`
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-breadcrumbs",children:"With breadcrumbs"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With breadcrumbs",children:lit_html.qy`
      <ic-page-header
        heading="Page header"
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-actions",children:"With actions"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With actions",children:lit_html.qy`
      <ic-page-header
        heading="Page header"
        subheading="This is a page header component with additional functionality and this is the text."
        reverse-order
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-input",children:"With input"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With input",children:lit_html.qy`
      <ic-page-header
        heading="Page header"
        subheading="This is a page header component with additional functionality and this is the text."
      >
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-stepper",children:"With stepper"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With stepper",children:lit_html.qy`
      <ic-page-header
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-tabs",children:"With tabs"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With tabs",children:lit_html.qy`
      <ic-page-header
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-breadcrumbs-input-actions-and-tabs",children:"With breadcrumbs, input, actions and tabs"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"With breadcrumbs, input, actions and tabs",children:lit_html.qy`
      <ic-page-header
        heading="Coffee recipes"
    ...
    `})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"dark-theme",children:"Dark theme"}),"\n",(0,jsx_runtime.jsx)(dist.Hl,{children:(0,jsx_runtime.jsx)(dist.gG,{name:"Dark theme",children:lit_html.qy`
      <ic-page-header
        heading="Coffee recipes"
        subheading="This is a page header component that has breadcrumbs, an input area, actions & stepper."
        reverse-order="true"
    ...
    `})})]})}const playground=args=>lit_html.qy`<ic-page-header
          aligned=${args.aligned}
          border=${args.border}
          heading=${args.heading}
          reverse-order=${args["reverse-order"]}
      ...
      ${""!==args["--ic-page-header-placeholder-text-field"]?`--ic-page-header-placeholder-text-field: ${args["--ic-page-header-placeholder-text-field"]};`:""}"
        ...
        <ic-section-container aligned=${args.aligned}>
          ...
          <ic-typography
            ...
            adipiscing ante non diam sodales hendrerit.</ic-typography
          >
        </ic-section-container>`;playground.storyName="Playground",playground.argTypes={aligned:{options:["center","full-width","left"],control:{type:"inline-radio"}},size:{options:["medium","small"],control:{type:"inline-radio"}},theme:{options:["inherit","dark","light"],control:{type:"radio"}},"--ic-page-header-text-primary":{control:{type:"color"}},"--ic-page-header-background":{control:{type:"color"}},"--ic-page-header-border":{control:{type:"color"}},"--ic-page-header-text-tertiary":{control:{type:"color"}},"--ic-page-header-placeholder-text-field":{control:{type:"color"}}},playground.args=defaultArgs,playground.parameters={storySource:{source:'args => html`<ic-page-header\n          aligned=${args.aligned}\n          border=${args.border}\n          heading=${args.heading}\n          reverse-order=${args["reverse-order"]}\n          size=${args.size}\n          sticky=${args.sticky}\n          sticky-desktop-only=${args["sticky-desktop-only"]}\n          subheading=${args.subheading}\n          theme=${args.theme}\n          style="\n      ${args["--ic-page-header-text-primary"] !== "" ? `--ic-page-header-text-primary: ${args["--ic-page-header-text-primary"]};` : ""}\n      ${args["--ic-page-header-background"] !== "" ? `--ic-page-header-background: ${args["--ic-page-header-background"]};` : ""}\n      ${args["--ic-page-header-border"] !== "" ? `--ic-page-header-border: ${args["--ic-page-header-border"]};` : ""}\n      ${args["--ic-page-header-text-tertiary"] !== "" ? `--ic-page-header-text-tertiary: ${args["--ic-page-header-text-tertiary"]};` : ""}\n      ${args["--ic-page-header-placeholder-text-field"] !== "" ? `--ic-page-header-placeholder-text-field: ${args["--ic-page-header-placeholder-text-field"]};` : ""}"\n        >\n          <ic-breadcrumb-group slot="breadcrumbs">\n            <ic-breadcrumb\n              current="true"\n              page-title="Drinks"\n              href="#"\n            ></ic-breadcrumb>\n            <ic-breadcrumb page-title="Coffees" href="#"> </ic-breadcrumb>\n            <ic-breadcrumb page-title="Latte" href="#"></ic-breadcrumb>\n          </ic-breadcrumb-group>\n          <ic-chip slot="heading-adornment" label="Beta" size="large"></ic-chip>\n          <ic-button slot="actions" variant="primary"\n            >Create coffee\n            <svg\n              slot="left-icon"\n              width="24"\n              height="24"\n              viewBox="0 0 24 24"\n              fill="none"\n              xmlns="http://www.w3.org/2000/svg"\n            >\n              <path\n                d="M19 13H13V19H11V13H5V11H11V5H13V11H19V13Z"\n                fill="currentColor"\n              />\n            </svg>\n          </ic-button>\n          <ic-button slot="actions" variant="tertiary">Filter coffee</ic-button>\n          <ic-stepper slot="stepper">\n            <ic-step heading="Warm kettle" type="completed"></ic-step>\n            <ic-step\n              heading="Warm milk"\n              subheading="Optional"\n              type="completed"\n            ></ic-step>\n            <ic-step heading="Pour milk" type="current" current></ic-step>\n          </ic-stepper>\n        </ic-page-header>\n        <ic-section-container aligned=${args.aligned}>\n          <ic-typography\n            >Example page content to test out the sticky prop.</ic-typography\n          >\n          <ic-typography\n            >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non\n            risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing\n            nec, ultricies sed, dolor.</ic-typography\n          >\n          <ic-typography\n            >Cras elementum ultrices diam. Maecenas ligula massa, varius a,\n            semper congue, euismod non, mi. Proin porttitor, orci nec nonummy\n            molestie, enim est eleifend mi, non fermentum diam nisl sit amet\n            erat.</ic-typography\n          >\n          <ic-typography\n            >Duis semper. Duis arcu massa, scelerisque vitae, consequat in,\n            pretium a, enim. Pellentesque congue. Ut in risus volutpat libero\n            pharetra tempor. Cras vestibulum bibendum augue.</ic-typography\n          >\n          <ic-typography\n            >Praesent egestas leo in pede. Praesent blandit odio eu enim.\n            Pellentesque sed dui ut augue blandit sodales. Vestibulum ante ipsum\n            primis in faucibus orci luctus et ultrices posuere cubilia Curae;\n            Aliquam nibh.</ic-typography\n          >\n          <ic-typography\n            >Mauris ac mauris sed pede pellentesque fermentum. Maecenas\n            adipiscing ante non diam sodales hendrerit.</ic-typography\n          >\n          <ic-typography\n            >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non\n            risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing\n            nec, ultricies sed, dolor.</ic-typography\n          >\n          <ic-typography\n            >Cras elementum ultrices diam. Maecenas ligula massa, varius a,\n            semper congue, euismod non, mi. Proin porttitor, orci nec nonummy\n            molestie, enim est eleifend mi, non fermentum diam nisl sit amet\n            erat.</ic-typography\n          >\n          <ic-typography\n            >Duis semper. Duis arcu massa, scelerisque vitae, consequat in,\n            pretium a, enim. Pellentesque congue. Ut in risus volutpat libero\n            pharetra tempor. Cras vestibulum bibendum augue.</ic-typography\n          >\n          <ic-typography\n            >Praesent egestas leo in pede. Praesent blandit odio eu enim.\n            Pellentesque sed dui ut augue blandit sodales. Vestibulum ante ipsum\n            primis in faucibus orci luctus et ultrices posuere cubilia Curae;\n            Aliquam nibh.</ic-typography\n          >\n          <ic-typography\n            >Mauris ac mauris sed pede pellentesque fermentum. Maecenas\n            adipiscing ante non diam sodales hendrerit.</ic-typography\n          >\n          <ic-typography\n            >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non\n            risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing\n            nec, ultricies sed, dolor.</ic-typography\n          >\n          <ic-typography\n            >Cras elementum ultrices diam. Maecenas ligula massa, varius a,\n            semper congue, euismod non, mi. Proin porttitor, orci nec nonummy\n            molestie, enim est eleifend mi, non fermentum diam nisl sit amet\n            erat.</ic-typography\n          >\n          <ic-typography\n            >Duis semper. Duis arcu massa, scelerisque vitae, consequat in,\n            pretium a, enim. Pellentesque congue. Ut in risus volutpat libero\n            pharetra tempor. Cras vestibulum bibendum augue.</ic-typography\n          >\n          <ic-typography\n            >Praesent egestas leo in pede. Praesent blandit odio eu enim.\n            Pellentesque sed dui ut augue blandit sodales. Vestibulum ante ipsum\n            primis in faucibus orci luctus et ultrices posuere cubilia Curae;\n            Aliquam nibh.</ic-typography\n          >\n          <ic-typography\n            >Mauris ac mauris sed pede pellentesque fermentum. Maecenas\n            adipiscing ante non diam sodales hendrerit.</ic-typography\n          >\n        </ic-section-container>`'},layout:"fullscreen"};const headingWithAdornment=()=>lit_html.qy`
      <ic-page-header heading="Page header">
        <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>
      </ic-page-header>
    `;headingWithAdornment.storyName="Heading with adornment",headingWithAdornment.parameters={storySource:{source:'html`\n      <ic-page-header heading="Page header">\n        <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>\n      </ic-page-header>\n    `'}};const leftAligned=()=>lit_html.qy`
      <ic-page-header
        aligned="left"
        heading="Page header"
        subheading="This is a simple page header component and this is the text."
