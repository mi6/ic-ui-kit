...
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[1531,3707,6529,9773,582,6199,6763],{"./src/components/ic-skip-link/ic-skip-link.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,FullWidth:()=>FullWidth,HideBackground:()=>HideBackground,Inline:()=>Inline,Playground:()=>Playground,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Skip link",component:"ic-skip-link"},Default={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-skip-link target="#page-content"></ic-skip-link>
      ...
      <ic-button>Should receive last focus</ic-button>`,name:"Inline"},HideBackground={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-skip-link
        target="#page-content"
