/*! For license information please see components-ic-accordion-ic-accordion-stories.ee4adc7c.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[2427,3707,6895,6591],{"./src/components/ic-accordion/ic-accordion.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,Disabled:()=>Disabled,Expanded:()=>Expanded,GroupTitle:()=>GroupTitle,Icon:()=>Icon,LightText:()=>LightText,Parent:()=>Parent,Playground:()=>Playground,SingleExpansion:()=>SingleExpansion,Sizes:()=>Sizes,SlottedHeadings:()=>SlottedHeadings,WithPopoverContent:()=>WithPopoverContent,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Accordion",component:"ic-accordion"},Default={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-accordion heading="Accordion 1">
      ...
      </ic-accordion>`,name:"Icon"},GroupTitle={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-accordion-group group-title="Title of the Accordion Group">
    ...
    </ic-accordion-group>`,name:"Group Title"},Sizes={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-accordion-group group-title="Small Accordion Group" size="small">
        <ic-accordion heading="Accordion 1">
          <svg
            slot="icon"
            width="20"
    ...
    </ic-accordion-group>`,name:"Single expansion"},LightText={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-accordion-group
      group-title="Title of the Accordion Group"
      appearance="light"
    >
      <ic-accordion heading="Accordion 1">
    ...
    </ic-accordion-group>`,name:"Light text",parameters:{backgrounds:{default:"dark"}}},Parent={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy` <ic-accordion-group group-title="Title of the Accordion Group">
      <ic-accordion heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text
        </ic-typography>
