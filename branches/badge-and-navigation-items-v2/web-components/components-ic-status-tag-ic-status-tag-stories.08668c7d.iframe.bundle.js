/*! For license information please see components-ic-status-tag-ic-status-tag-stories.08668c7d.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[2615,3707,6895,6591],{"./src/components/ic-status-tag/ic-status-tag.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Announced:()=>Announced,Danger:()=>Danger,Neutral:()=>Neutral,Playground:()=>Playground,Size:()=>Size,Success:()=>Success,Warning:()=>Warning,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Status tag",component:"ic-status-tag"},Neutral={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `,name:"Warning"},Danger={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    ...
    <ic-status-tag
      ...
      variant="outlined"
    ></ic-status-tag>
  `,name:"Danger"},Size={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
