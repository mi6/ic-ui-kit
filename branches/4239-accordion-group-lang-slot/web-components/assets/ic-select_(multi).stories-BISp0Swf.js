var S=Object.freeze,Q=Object.defineProperty;var e=(a,K)=>S(Q(a,"raw",{value:S(K||a.slice())}));import{x as l}from"./lit-html-CWQq0DyO.js";const U={disabled:!1,"full-width":!1,"helper-text":"Select some options from the list","hide-label":!1,loading:!1,loadingLabel:"Loading...",label:"What are your favourite types of coffee?",placeholder:"Select an option",readonly:!1,required:!1,size:"medium",validationAriaLive:"polite",validationStatus:"no status","validation-text":"","show-clear-button":!1,theme:"inherit"},X={title:"Web Components/Select/Multi",component:"ic-select"};var E;const t={render:()=>l(E||(E=e([`<ic-select
        id="select-default"
      ...
      <\/script>`]))),name:"Default"};var q;const n={render:()=>l(q||(q=e([`<ic-select
        label="What are your favourite types of coffee?"
        id="select-async"
        multiple
        loading
      ...
      <\/script>`]))),name:"Async default"};var W;const c={render:()=>l(W||(W=e([`<ic-select
      ...
      <\/script>`]))),name:"Default value"};var x;const o={render:()=>l(x||(x=e([`<ic-select
        id="select-clear"
        label="What are your favourite types of coffee?"
        multiple
        show-clear-button
      ...
      <\/script>`]))),name:"With clear button"};var k;const i={render:()=>l(k||(k=e([`<ic-select
      ...
      <\/script>`]))),name:"With descriptions"};var $;const s={render:()=>l($||($=e([`<ic-select
        label="What are your favourite types of coffee?"
        multiple
      ...
      <\/script>`]))),name:"Helper text"};var z;const r={render:()=>l(z||(z=e([`<ic-select
      ...
      <\/script>`]))),name:"Custom placeholder"};var D;const u={render:()=>l(D||(D=e([`<ic-select
      ...
      <\/script>`]))),name:"Custom components"};var V;const v={render:()=>l(V||(V=e([`<div style="display: flex; flex-direction: column; gap: 16px;">
      <ic-select
      ...
      <\/script>
    </div>`]))),name:"Sizes"};var H;const d={render:()=>l(H||(H=e([`<ic-select
        id="select-disabled"
        label="What are your favourite types of coffee?"
        multiple
        disabled
      ...
      <\/script>`]))),name:"Disabled"};var R;const p={render:()=>l(R||(R=e([`<ic-select
      ...
      <\/script>`]))),name:"Disabled options"};var O;const m={render:()=>l(O||(O=e([`<ic-select
      ...
      <\/script>`]))),name:"Full width"};var B;const b={render:()=>l(B||(B=e([`<ic-select
      ...
      <\/script>`]))),name:"Hidden label"};var Z;const h={render:()=>l(Z||(Z=e([`<ic-select
        id="select-required"
        label="What are your favourite types of coffee?"
        multiple
        required
      ...
      <\/script>`]))),name:"Required"};var I;const f={render:()=>l(I||(I=e([`<ic-select
        id="select-read-only"
        label="What are your favourite types of coffee?"
        multiple
        readonly
      ...
      <\/script>`]))),name:"Read-only"};var _;const g={render:()=>l(_||(_=e([`<ic-select
        id="select-groups"
        label="What are your favourite types of coffee?"
        multiple
      ></ic-select>
      ...
      <\/script>`]))),name:"Groups"};var P;const C={render:()=>l(P||(P=e([`<ic-select
      ...
      <\/script>`]))),name:"Recommended"};var T;const y={render:()=>l(T||(T=e([`<ic-select
        id="select-success"
        label="What are your favourite types of coffee?"
        multiple
      ...
      <\/script>`]))),name:"Validation"};var G;const M={render:()=>l(G||(G=e([`<ic-select
        id="select-scroll"
        label="What are your favourite types of coffee?"
        multiple
      ></ic-select>
      ...
      <\/script>`]))),name:"Scroll behaviour"};var N;const F={render:()=>l(N||(N=e([`<ic-select
        id="select-loading"
        label="What are your favourite types of coffee?"
        multiple
        loading
      ...
      <\/script>`]))),name:"Loading with error"};var j;const L={render:()=>l(j||(j=e([`
    <form>
      <ic-select
        id="select-form"
        label="What are your favourite types of coffee?"
    ...
    <\/script>
  `]))),name:"In form"},A="inline-radio";var J;const w={render:a=>l(J||(J=e([` <ic-select
      ...
      <\/script>`])),a.disabled,a["full-width"],a["helper-text"],a["hide-label"],a.loading,a["loading-label"],a.label,a.placeholder,a.readonly,a.required,a["show-clear-button"],a.size,a.validationAriaLive,a.validationStatus==="no status"?"":a.validationStatus,a["validation-text"],a.theme,a.showIcon&&l` <svg
          slot="icon"
        ...
        >
          ...
          />
        </svg>`),name:"Playground",args:U,argTypes:{validationAriaLive:{options:["polite","assertive","off"],control:{type:A}},validationStatus:{defaultValue:"no status",options:["no status","error","success","warning"],control:{type:"select"}},size:{options:["small","medium","large"],control:{type:A}},showIcon:{control:{type:"boolean"}},theme:{options:["inherit","light","dark"],control:{type:A}}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
...
}`,...w.parameters?.docs?.source}}};const Y=["Default","AsyncDefault","DefaultValue","WithClearButton","WithDescriptions","HelperText","CustomPlaceholder","CustomComponents","Sizes","Disabled","DisabledOptions","FullWidth","HiddenLabel","Required","ReadOnly","Groups","Recommended","Validation","ScrollBehaviour","LoadingWithError","InForm","Playground"],ae=Object.freeze(Object.defineProperty({__proto__:null,AsyncDefault:n,CustomComponents:u,CustomPlaceholder:r,Default:t,DefaultValue:c,Disabled:d,DisabledOptions:p,FullWidth:m,Groups:g,HelperText:s,HiddenLabel:b,InForm:L,LoadingWithError:F,Playground:w,ReadOnly:f,Recommended:C,Required:h,ScrollBehaviour:M,Sizes:v,Validation:y,WithClearButton:o,WithDescriptions:i,__namedExportsOrder:Y,default:X},Symbol.toStringTag,{value:"Module"}));export{ae as I};
