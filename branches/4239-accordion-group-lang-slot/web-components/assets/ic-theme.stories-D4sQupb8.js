import{x as a}from"./lit-html-CWQq0DyO.js";const l={brandColor:"rgba(27, 60, 121, 1)",theme:"light"},c={theme:"light",componentTheme:"light"},r={title:"Web Components/Theme",component:"ic-theme"},e={render:()=>a` <ic-theme brand-color="rgba(27, 60, 121, 1)">
      <ic-button
        variant="primary"
        id="default-btn"
    ...
    </ic-theme>`,name:"Switch brand"},o="inline-radio",n={render:i=>a` <ic-theme brand-color=${i.brandColor} theme=${i.theme}>
      <div style="padding-top:10px">
        <ic-top-navigation
          app-title="ApplicationName"
          status="alpha"
    ...
    </ic-theme>`,name:"Playground",args:l,parameters:{layout:"fullscreen"},argTypes:{theme:{options:["system","light","dark"],control:{type:o}}}},t={render:i=>a`<div
      style="background-color: ${i.theme=="dark"?"black":i.theme=="light"?"white":null};width:450px;height:150px"
    >
      <ic-theme theme=${i.theme}>
        <div
          style="background-color: ${i.componentTheme=="dark"?"black":i.componentTheme=="light"?"white":null};width:250px"
        >
          <ic-typography theme=${i.componentTheme}>Theme test</ic-typography>
        </div>
      </ic-theme>
    </div>`,name:"Theme visualisation playground",args:c,parameters:{layout:"fullscreen"},argTypes:{theme:{options:["system","light","dark"],control:{type:o}},componentTheme:{options:["inherit","light","dark"],control:{type:o}}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
...
}`,...t.parameters?.docs?.source}}};const s=["SwitchBrand","Playground","ThemeVisualisationPlayground"],d=Object.freeze(Object.defineProperty({__proto__:null,Playground:n,SwitchBrand:e,ThemeVisualisationPlayground:t,__namedExportsOrder:s,default:r},Symbol.toStringTag,{value:"Module"}));export{d as I,n as P,e as S,t as T};
