import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";import{n as i,t as a}from"./taggedTemplateLiteral-pWa2IaV6.js";var o=e({AccessibleButtonLabelSlot:()=>b,Default:()=>u,Disabled:()=>_,Expanded:()=>d,GroupTitle:()=>p,Icon:()=>f,Parent:()=>g,Playground:()=>S,SingleExpansion:()=>h,Sizes:()=>m,SlottedHeadings:()=>y,WithPopoverContent:()=>v,__namedExportsOrder:()=>C,default:()=>l}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w=t((()=>{n(),i(),c={accessibleButtonLabel:`accordions`,expanded:!1,label:`Accordion group`,singleExpansion:!1,size:`medium`,disabled:!1,heading:`Accordion 1`,message:`This is an example of the main body text.`,theme:`inherit`,expandedAccordion:!1,sizeAccordion:`medium`,themeAccordion:`inherit`},l={title:`Web Components/Accordion`,component:`ic-accordion`},u={render:()=>r` <ic-accordion heading="Accordion 1">
      ...
      </ic-accordion>`,name:`Default`},d={render:()=>r` <ic-accordion expanded="true" heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text.
        </ic-typography>
      </ic-accordion>
      ...
      </ic-accordion>`,name:`Expanded`},f={render:()=>r` <ic-accordion heading="Accordion 1">
        <svg
          slot="icon"
          width="20"
          height="1em"
      ...
      </ic-accordion>`,name:`Icon`},p={render:()=>r` <ic-accordion-group label="Title of the Accordion Group">
    ...
    </ic-accordion-group>`,name:`Group Title`},m={render:()=>r` <ic-accordion-group label="Small Accordion Group" size="small">
        <ic-accordion heading="Accordion 1">
          <svg
            slot="icon"
            width="20"
      ...
      </ic-accordion-group>`,name:`Sizes`},h={render:()=>r` <ic-accordion-group
    ...
    >
    ...
    </ic-accordion-group>`,name:`Single expansion`},g={render:()=>r` <ic-accordion-group label="Title of the Accordion Group">
      <ic-accordion heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text
        </ic-typography>
    ...
    </ic-accordion-group>`,name:`Parent`},_={render:()=>r` <ic-accordion heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text.
        </ic-typography>
      </ic-accordion>
      ...
      </ic-accordion>`,name:`Disabled`},v={render:()=>r(s||=a([`
    ...
    <\/script>
  `])),name:`With popover content`},y={render:()=>r`<ic-accordion-group>
    ...
    </ic-accordion-group>`,name:`Slotted headings`},b={render:()=>r` <ic-accordion-group label="Title of the Accordion Group">
    ...
    </ic-accordion-group>`,name:`Accessible button label slot`},x=`inline-radio`,S={render:e=>r`<ic-accordion-group
      accessible-button-label=${e.accessibleButtonLabel}
      label=${e.label}
      expanded=${e.expanded}
      single-expansion=${e.singleExpansion}
      size=${e.size}
      theme=${e.theme}
    >
      <ic-accordion
        heading=${e.heading}
        disabled=${e.disabled}
        expanded=${e.expandedAccordion}
        size=${e.sizeAccordion}
        message=${e.message}
        theme=${e.themeAccordion}
      >
        <svg
          slot="icon"
          width="20"
    ...
    </ic-accordion-group>`,args:c,name:`Playground`,argTypes:{size:{options:[`small`,`medium`,`large`],control:{type:x}},theme:{options:[`inherit`,`light`,`dark`],control:{type:x}},sizeAccordion:{options:[`small`,`medium`,`large`],control:{type:x}},themeAccordion:{options:[`inherit`,`light`,`dark`],control:{type:x}}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
...
}`,...S.parameters?.docs?.source}}},C=[`Default`,`Expanded`,`Icon`,`GroupTitle`,`Sizes`,`SingleExpansion`,`Parent`,`Disabled`,`WithPopoverContent`,`SlottedHeadings`,`AccessibleButtonLabelSlot`,`Playground`]}));w();export{b as AccessibleButtonLabelSlot,u as Default,_ as Disabled,d as Expanded,p as GroupTitle,f as Icon,g as Parent,S as Playground,h as SingleExpansion,m as Sizes,y as SlottedHeadings,v as WithPopoverContent,C as __namedExportsOrder,l as default,w as n,o as t};