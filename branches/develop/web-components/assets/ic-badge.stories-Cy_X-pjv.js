import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";import{n as i,t as a}from"./taggedTemplateLiteral-pWa2IaV6.js";var o=e({AI:()=>g,AccessibleLabel:()=>S,Custom:()=>_,Error:()=>d,HideBadge:()=>x,Info:()=>h,Light:()=>m,MaxNumber:()=>v,Neutral:()=>p,Playground:()=>C,PositionInline:()=>b,PositionNear:()=>y,Success:()=>u,Warning:()=>f,__namedExportsOrder:()=>w,default:()=>l}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{n(),i(),c={accessibleLabel:`notification`,customColor:null,maxNumber:1e3,position:`far`,size:`medium`,label:`1`,type:`text`,variant:`neutral`,theme:`inherit`},l={title:`Web Components/Badge`,component:`ic-badge`},u={render:()=>r`<div style="padding:16px;">
      ...
      <div style="padding:16px">
        ...
        >
      </div>`,name:`Success`},d={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:`Error`},f={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:`Warning`},p={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:`Neutral`},m={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:`Light`},h={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:`Info`},g={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
      ...
      </div>`,name:`AI`},_={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:`Custom`},v={render:()=>r`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1000"
            slot="badge"
      ...
      <div style="padding:16px;">
        ...
        <ic-button variant="secondary"
          ...
          >Large</ic-button
        >
      </div>`,name:`Max number`},y={render:()=>r`<div style="padding:16px;">
      ...
      <div style="padding:16px;">
        ...
        <ic-chip label="Large Dot"
          ...
          ></ic-badge
        ></ic-chip>
      </div>`,name:`Position near`},b={render:()=>r`<ic-tab-context>
    ...
    </ic-tab-context>`,name:`Position inline`},x={render:()=>r(s||=a([`<script>
      ...
      <div style="padding:16px;">
        <ic-button variant="secondary" onclick="showHideBadge()"
          ...
          badge</ic-button
        >
      </div> `])),name:`Hide badge`},S={render:()=>r`<div style="padding:16px;">
      <ic-button variant="secondary" style="margin-right:16px"
        ><ic-badge
          label="1"
          slot="badge"
      ...
      <ic-chip label="Default dot" dismissible="true"
        ...
        ></ic-badge
      ></ic-chip>
    </div> `,name:`Accessible label`},C={render:e=>r`<ic-button variant="secondary">
      <ic-badge
        slot="badge"
        accessible-label=${e.accessibleLabel}
        custom-color=${e.customColor}
        max-number=${e.maxNumber}
        position=${e.position}
        size=${e.size}
        label=${e.label}
        type=${e.type}
      ...
      Default
    </ic-button>`,args:c,argTypes:{customColor:{control:{type:`text`}},position:{options:[`far`,`near`,`inline`],control:{type:`radio`}},size:{options:[`small`,`medium`,`large`],control:{type:`radio`}},type:{options:[`text`,`dot`,`icon`],control:{type:`radio`}},variant:{options:[`neutral`,`success`,`warning`,`error`,`info`,`ai`,`light`,`custom`],control:{type:`select`}},theme:{options:[`inherit`,`light`,`dark`],control:{type:`inline-radio`}}},name:`Playground`},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...C.parameters?.docs?.source}}},w=[`Success`,`Error`,`Warning`,`Neutral`,`Light`,`Info`,`AI`,`Custom`,`MaxNumber`,`PositionNear`,`PositionInline`,`HideBadge`,`AccessibleLabel`,`Playground`]}));T();export{g as AI,S as AccessibleLabel,_ as Custom,d as Error,x as HideBadge,h as Info,m as Light,v as MaxNumber,p as Neutral,C as Playground,b as PositionInline,y as PositionNear,u as Success,f as Warning,w as __namedExportsOrder,l as default,T as n,o as t};