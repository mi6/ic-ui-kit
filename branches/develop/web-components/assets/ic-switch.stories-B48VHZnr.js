var b=Object.freeze,f=Object.defineProperty;var u=(t,g)=>b(f(t,"raw",{value:b(g||t.slice())}));import{b as e}from"./lit-html-B6sBSybp.js";const S={label:"Custom Switch",helperText:"Custom helper text",disabled:!1,checked:!1,hideLabel:!1,size:"medium",theme:"inherit"},y={title:"Web Components/Switch",component:"ic-switch"},a={render:()=>e` <ic-switch label="Label"></ic-switch> `,name:"Default"},r={render:()=>e` <ic-switch label="Label"></ic-switch> `,name:"Name"},n={render:()=>e` <ic-switch checked="true" label="Label"></ic-switch> `,name:"Checked"},s={render:()=>e` <ic-switch size="small" label="Label"></ic-switch> `,name:"Small"},i={render:()=>e` <ic-switch disabled="true" label="Label"></ic-switch> `,name:"Disabled"},l={render:()=>e` <ic-switch disabled="true" label="Label"></ic-switch> `,name:"Disabled and name"},c={render:()=>e`
