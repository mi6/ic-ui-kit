import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";var i=e({CenterAligned:()=>f,ComponentOverrides:()=>w,DarkTheme:()=>E,FullWidth:()=>p,HeadingWithAdornment:()=>c,LeftAligned:()=>l,Playground:()=>s,Small:()=>u,Sticky:()=>m,StickyForLargeAndExtraLargeBreakpointsOnly:()=>g,StickyWithContentAndFooter:()=>h,WithActions:()=>v,WithBreadcrumbs:()=>_,WithBreadcrumbsInputActionsAndStepper:()=>C,WithBreadcrumbsInputActionsAndStepperAndLongTitle:()=>T,WithBreadcrumbsInputActionsAndTabs:()=>S,WithInput:()=>y,WithStepper:()=>b,WithTabs:()=>x,WithoutBorder:()=>d,__namedExportsOrder:()=>D,default:()=>o}),a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O=t((()=>{n(),a={aligned:`left`,border:!0,heading:`Latte recipe`,"reverse-order":!1,size:`medium`,sticky:!1,"sticky-desktop-only":!1,subheading:`A Latte is a popular Italian coffee, made with espresso, steamed milk and a thin layer of foam.`,theme:`inherit`,"--ic-page-header-text-primary":``,"--ic-page-header-background":``,"--ic-page-header-border":``,"--ic-page-header-text-tertiary":``,"--ic-page-header-placeholder-text-field":``},o={title:`Web Components/Page header`,component:`ic-page-header`,parameters:{layout:`fullscreen`}},s={render:e=>r`<ic-page-header
        aligned=${e.aligned}
        border=${e.border}
        heading=${e.heading}
