import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";var i=e({CenterAligned:()=>f,ComponentOverrides:()=>w,DarkTheme:()=>E,FullWidth:()=>p,HeadingWithAdornment:()=>c,LeftAligned:()=>l,Playground:()=>s,Small:()=>u,Sticky:()=>m,StickyForLargeAndExtraLargeBreakpointsOnly:()=>g,StickyWithContentAndFooter:()=>h,WithActions:()=>v,WithBreadcrumbs:()=>_,WithBreadcrumbsInputActionsAndStepper:()=>C,WithBreadcrumbsInputActionsAndStepperAndLongTitle:()=>T,WithBreadcrumbsInputActionsAndTabs:()=>S,WithInput:()=>y,WithStepper:()=>b,WithTabs:()=>x,WithoutBorder:()=>d,__namedExportsOrder:()=>D,default:()=>o}),a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O=t((()=>{n(),a={aligned:`left`,border:!0,heading:`Latte recipe`,"reverse-order":!1,size:`medium`,sticky:!1,"sticky-desktop-only":!1,subheading:`A Latte is a popular Italian coffee, made with espresso, steamed milk and a thin layer of foam.`,theme:`inherit`,"--ic-page-header-text-primary":``,"--ic-page-header-background":``,"--ic-page-header-border":``,"--ic-page-header-text-tertiary":``,"--ic-page-header-placeholder-text-field":``},o={title:`Web Components/Page header`,component:`ic-page-header`,parameters:{layout:`fullscreen`}},s={render:e=>r`<ic-page-header
        aligned=${e.aligned}
        border=${e.border}
        heading=${e.heading}
        ...
        size=${e.size}
        sticky=${e.sticky}
        sticky-desktop-only=${e[`sticky-desktop-only`]}
        subheading=${e.subheading}
        theme=${e.theme}
        style="
      ${e[`--ic-page-header-text-primary`]===``?``:`--ic-page-header-text-primary: ${e[`--ic-page-header-text-primary`]};`}
      ${e[`--ic-page-header-background`]===``?``:`--ic-page-header-background: ${e[`--ic-page-header-background`]};`}
      ${e[`--ic-page-header-border`]===``?``:`--ic-page-header-border: ${e[`--ic-page-header-border`]};`}
      ${e[`--ic-page-header-text-tertiary`]===``?``:`--ic-page-header-text-tertiary: ${e[`--ic-page-header-text-tertiary`]};`}
      ${e[`--ic-page-header-placeholder-text-field`]===``?``:`--ic-page-header-placeholder-text-field: ${e[`--ic-page-header-placeholder-text-field`]};`}"
      >
      ...
      <ic-section-container aligned=${e.aligned}>
        <ic-typography
        ...
        <ic-typography
          ...
          ante non diam sodales hendrerit.</ic-typography
        >
      </ic-section-container>`,args:a,name:`Playground`,parameters:{layout:`fullscreen`},argTypes:{aligned:{options:[`center`,`full-width`,`left`],control:{type:`inline-radio`}},size:{options:[`medium`,`small`],control:{type:`inline-radio`}},theme:{options:[`inherit`,`dark`,`light`],control:{type:`radio`}},"--ic-page-header-text-primary":{control:{type:`color`}},"--ic-page-header-background":{control:{type:`color`}},"--ic-page-header-border":{control:{type:`color`}},"--ic-page-header-text-tertiary":{control:{type:`color`}},"--ic-page-header-placeholder-text-field":{control:{type:`color`}}}},c={render:()=>r`
    <ic-page-header heading="Page header">
      <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>
    </ic-page-header>
  `,name:`Heading with adornment`},l={render:()=>r`
    <ic-page-header
      aligned="left"
      heading="Page header"
  ...
  `,name:`Small`},d={render:()=>r`
    <ic-page-header heading="Page header" border="false">
      <ic-status-tag slot="heading-adornment" label="Beta"></ic-status-tag>
    </ic-page-header>
  `,name:`Without border`},f={render:()=>r`
    <ic-page-header
      aligned="center"
      heading="Page header"
      subheading="This is a simple page header component and this is the text."
  ...
  `,name:`Center aligned`},p={render:()=>r`
    <ic-page-header
      aligned="full-width"
      heading="Page header"
      subheading="This is a simple page header component and this is the text."
  ...
  `,name:`Sticky with content and footer`},g={render:()=>r`
    <ic-top-navigation app-title="ApplicationName">
      <svg
        slot="app-icon"
        xmlns="http://www.w3.org/2000/svg"
  ...
  `,name:`Sticky for large and extra-large breakpoints only`},_={render:()=>r`
    <ic-page-header
      heading="Page header"
  ...
  `,name:`With breadcrumbs`},v={render:()=>r`
    <ic-page-header
      heading="Page header"
      subheading="This is a page header component with additional functionality and this is the text."
      reverse-order
  ...
  `,name:`With breadcrumbs, input, actions and tabs`},C={render:()=>r`
    <ic-page-header
      heading="Coffee recipes"
  ...
  `,name:`With breadcrumbs, input, actions and stepper`},w={render:()=>r`
    <ic-page-header>
  ...
  `,name:`Component overrides`},T={render:()=>r`
    <ic-page-header
  ...
  `,name:`With breadcrumbs, input, actions and stepper and long title`},E={render:()=>r`
    <ic-page-header
      heading="Coffee recipes"
      subheading="This is a page header component that has breadcrumbs, an input area, actions & stepper."
      reverse-order="true"
  ...
  `,name:`Dark theme`},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  ...
  \`,
  name: "Dark theme"
}`,...E.parameters?.docs?.source}}},D=[`Playground`,`HeadingWithAdornment`,`LeftAligned`,`Small`,`WithoutBorder`,`CenterAligned`,`FullWidth`,`Sticky`,`StickyWithContentAndFooter`,`StickyForLargeAndExtraLargeBreakpointsOnly`,`WithBreadcrumbs`,`WithActions`,`WithInput`,`WithStepper`,`WithTabs`,`WithBreadcrumbsInputActionsAndTabs`,`WithBreadcrumbsInputActionsAndStepper`,`ComponentOverrides`,`WithBreadcrumbsInputActionsAndStepperAndLongTitle`,`DarkTheme`]}));O();export{f as CenterAligned,w as ComponentOverrides,E as DarkTheme,p as FullWidth,c as HeadingWithAdornment,l as LeftAligned,s as Playground,u as Small,m as Sticky,g as StickyForLargeAndExtraLargeBreakpointsOnly,h as StickyWithContentAndFooter,v as WithActions,_ as WithBreadcrumbs,C as WithBreadcrumbsInputActionsAndStepper,T as WithBreadcrumbsInputActionsAndStepperAndLongTitle,S as WithBreadcrumbsInputActionsAndTabs,y as WithInput,b as WithStepper,x as WithTabs,d as WithoutBorder,D as __namedExportsOrder,o as default,O as n,i as t};