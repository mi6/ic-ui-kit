var k=Object.freeze,Z=Object.defineProperty;var e=(t,E)=>k(Z(t,"raw",{value:k(E||t.slice())}));import{x as n}from"./lit-html-CWQq0DyO.js";const T={message:"Custom Button",disabled:!1,loading:!1,theme:"inherit",size:"medium",variant:"secondary",fullWidth:!1,iconPlacement:"right-icon",monochrome:!1,dropdown:!1,transparentBackground:!0},F={title:"Web Components/Button",component:"ic-button"},o={render:()=>n`<div
      ...
      </div>`,name:"Primary"},a={render:()=>n` <div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
          style="padding: 1rem; display: flex; flex-direction: column; gap: 0.5rem"
      ...
      </div>`,name:"Secondary"},r={render:()=>n` <div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
          style="padding: 1rem; display: flex; flex-direction: column; gap: 0.5rem"
      ...
      </div>`,name:"Tertiary"},l={render:()=>n` <div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
          style="padding: 1rem; display: flex; flex-direction: column; gap: 0.5rem"
      ...
      </div>`,name:"Destructive"},c={render:()=>n`<div style="display:flex; gap: 1rem; flex-direction:column;">
      <div>
    ...
    </div>`,name:"Icon variants"},s={render:()=>n`<div style="padding: 1rem; display: flex; gap: 1rem">
      ...
      </div> `,name:"With icon"},d={render:()=>n`<div>
    ...
    </div>`,name:"Dropdown"};var C;const h={render:()=>n(C||(C=e([`<script>
      ...
      </div>`]))),name:"Dropdown example"},p={render:()=>n` <ic-button variant="primary" size="small">Small</ic-button>
      ...
      </ic-button>`,name:"Size"},v={render:()=>n`<div style="padding: 8px">
      ...
      </div>`,name:"Router link",parameters:{layout:"fullscreen"}},g={render:()=>n`<div style="padding: 8px">
        <ic-button size="small">
          <a slot="router-item" href="/">
            <svg
              slot="left-icon"
      ...
      </div>`,name:"Router link - with slotted content",parameters:{layout:"fullscreen"}},u={render:()=>n`<ic-button variant="primary" size="small"
        >Small
        <svg
          slot="left-icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      </ic-button>`,name:"Icon without viewBox"},m={render:()=>n`
  ...
  `,name:"Height"},x={render:()=>n`<ic-button
        variant="icon"
        aria-label="refresh"
      ...
      >`,name:"Tooltips"};var S;const y={render:()=>n(S||(S=e([` <script>
      ...
      </div>`]))),name:"Tooltip positioning strategy"},i="inline-radio",f={render:t=>n`<ic-button
      disabled=${t.disabled}
      variant=${t.variant}
      ...
      dropdown=${t.dropdown}
      transparent-background=${t.transparentBackground}
      >${t.message}</ic-button
    >`,args:T,argTypes:{variant:{options:["primary","secondary","tertiary","destructive"],control:{type:"select"}},size:{options:["medium","large","small"],control:{type:i}},theme:{options:["inherit","dark","light"],control:{type:i}},fullWidth:{control:{type:"boolean"}},monochrome:{control:{type:"boolean"}},dropdown:{control:{type:"boolean"}},transparentBackground:{control:{type:"boolean"}}},name:"Playground"},V={render:t=>n`<ic-button
      disabled=${t.disabled}
      variant=${t.variant}
      size=${t.size}
      full-width=${t.fullWidth}
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-button>`,args:{...T},argTypes:{variant:{options:["primary","secondary","tertiary","destructive"],control:{type:"select"}},size:{options:["medium","large","small"],control:{type:i}},theme:{options:["default","dark","light"],control:{type:i}},fullWidth:{control:{type:"boolean"}},iconPlacement:{options:["left-icon","right-icon","top-icon"],control:{type:i}},monochrome:{control:{type:"boolean"}}},name:"Playground with icon"},z={render:t=>n`<ic-button
      disable-tooltip=${t.disableTooltip}
      disabled=${t.disabled}
      full-width=${t.fullWidth}
      href=${t.href}
      loading=${t.loading}
  ...
  `,name:"Loading"};var D;const H={render:()=>n(D||(D=e([`
    <script>
      function btnClick() {
  ...
  `]))),name:"Aria-describedby"};var $;const L={render:()=>n($||($=e([`
    ...
    <\/script>
  `]))),name:"File upload in a form"};var P;const B={render:()=>n(P||(P=e([`
    <span id="selected-file">No File Selected</span>
    <div style="padding: 6px">
      <ic-button
        variant="primary"
    ...
    <\/script>
  `]))),name:"File upload"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: () => html\`<div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
  ...
  \`,
  name: "File upload"
}`,...B.parameters?.docs?.source}}};const A=["Primary","Secondary","Tertiary","Destructive","IconVariants","WithIcon","Dropdown","DropdownExample","Size","RouterLink","RouterLinkWithSlottedContent","IconWithoutViewBox","FullWidth","MinWidth","Height","Tooltips","PositioningStrategy","Playground","PlaygroundWithIcon","PlaygroundIconOnly","Loading","AriaDescribedby","FileUploadInAForm","FileUpload"],I=Object.freeze(Object.defineProperty({__proto__:null,AriaDescribedby:H,Destructive:l,Dropdown:d,DropdownExample:h,FileUpload:B,FileUploadInAForm:L,FullWidth:m,Height:w,IconVariants:c,IconWithoutViewBox:u,Loading:M,MinWidth:b,Playground:f,PlaygroundIconOnly:z,PlaygroundWithIcon:V,PositioningStrategy:y,Primary:o,RouterLink:v,RouterLinkWithSlottedContent:g,Secondary:a,Size:p,Tertiary:r,Tooltips:x,WithIcon:s,__namedExportsOrder:A,default:F},Symbol.toStringTag,{value:"Module"}));export{I};
