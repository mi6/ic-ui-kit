var C=Object.freeze,F=Object.defineProperty;var t=(M,V)=>C(F(M,"raw",{value:C(V||M.slice())}));import{x as e}from"./lit-html-DDAUtwXN.js";const O=""+new URL("readme-92snEs-t.md",import.meta.url).href,Z={title:"Web Components/Time Input",component:"ic-time-input",parameters:{componentAPI:{data:O}}},i={render:()=>e`<ic-time-input
    label="What time would you like to collect your coffee?"
  ></ic-time-input>`,name:"Default"};var H;const n={render:()=>e(H||(H=t([`<ic-time-input
      label="What time would you like to collect your coffee?"
    ></ic-time-input>
    <script>
    ...
    value="13:45:00"
  ></ic-time-input>`,name:"With value"};var x;const o={render:()=>e(x||(x=t([`<ic-time-input
    ...
    <\/script>`]))),name:"Date object"};var D;const w={render:()=>e(D||(D=t([`<div>
      <ic-time-input
  ...
  ></ic-time-input>`,name:"Hide label"},c={render:()=>e`<ic-time-input
    label="What time would you like to collect your coffee?"
    disabled="true"
  ></ic-time-input>`},u={render:()=>e`<ic-time-input
      label="What time would you like to collect your coffee?"
      size="small"
    ></ic-time-input>
    <br />
    ...
    <ic-time-input
      label="What time would you like to collect your coffee?"
      size="large"
    ></ic-time-input>`,name:"Sizes"},s={render:()=>e`<ic-time-input
      label="What time would you like to collect your coffee?"
  ...
  ></ic-time-input>`,name:"Hide helper text"},m={render:()=>e`<ic-time-input
    ...
    ></ic-time-input>`,name:"Custom validation"};var q;const T={render:M=>e(q||(q=t([`<ic-time-input
        id="field-1"
        label="What time would you like to collect your coffee?"
      ...
      <\/script>`]))),name:"Aria-live behaviour"};var P;const d={render:()=>e(P||(P=t([`<ic-time-input
  ...
  `,name:"Time period"},k={render:()=>e`
    ...
    ></ic-time-input>
  `,name:"Time period - with AM/PM toggle"};var L;const W={render:()=>e(L||(L=t([`<ic-time-input
      emit-time-part-change="true"
      label="What time would you like to collect your coffee?"
      time-period="12"
      show-am-pm-toggle="true"
    ...
    <\/script>`]))),name:"IcTimeChange with emitTimePartChange - 12 hour"};var A;const E={render:()=>e(A||(A=t([`<ic-time-input
      emit-time-part-change="true"
      label="What time would you like to collect your coffee?"
      time-period="12"
      show-am-pm-toggle="true"
    ...
    <\/script>`]))),name:"IcTimeChange with emitTimePartChange - 12 hour milliseconds"},h={render:()=>e`<ic-time-input
    label="What time would you like to collect your coffee?"
    time-format="HH:MM"
  ></ic-time-input>`,name:"Time format HH:MM"},f={render:()=>e`<ic-time-input
    label="What time would you like to collect your coffee?"
    time-format="HH:MM:SS.SSS"
  ></ic-time-input>`,name:"Time format HH:MM:SS.SSS"};var j;const I={render:()=>e(j||(j=t([`<ic-time-input
      emit-time-part-change="true"
      label="What time would you like to collect your coffee?"
      time-format="HH:MM:SS.SSS"
    ></ic-time-input>
  ...
  ></ic-time-input>`,name:"Min time"},y={render:()=>e`<ic-time-input
    ...
    max="16:00:00"
  ></ic-time-input>`,name:"Max time"};var z;const v={render:()=>e(z||(z=t([`<div>
      <ic-time-input
    ...
    <\/script>`]))),name:"Disable times"};var B;const g={render:()=>e(B||(B=t([`<ic-time-input
...
- [Zulu time](#zulu-time)`,...o.parameters?.docs?.description}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  ...
  render: () => html\`<ic-time-input
    ...
    disabled="true"
  ></ic-time-input>\`
}`,...c.parameters?.docs?.source},description:{story:"Set the `disabled` attribute to `true` to prevent interaction with the time input.",...c.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  render: () => html\`<ic-time-input
      label="What time would you like to collect your coffee?"
      size="small"
    ></ic-time-input>
    ...
    ></ic-time-input>\`,
  name: "Sizes"
}`,...u.parameters?.docs?.source},description:{story:"The time input is available in three different sizes:\n- `small`\n- `medium` (default)\n- `large`",...u.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => html\`<ic-time-input
      label="What time would you like to collect your coffee?"
      helper-text="We will have your order ready for you at this time"
    ></ic-time-input>
...
}`,...s.parameters?.docs?.source},description:{story:"Use the helper text to add additional detail for the time input. Display custom content using the `helper-text` slot.",...s.parameters?.docs?.description}}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  render: () => html\`<ic-time-input
    label="What time would you like to collect your coffee?"
    helper-text="You cannot see me, but you can hear me"
    hide-helper-text="true"
...
}`,...f.parameters?.docs?.source},description:{story:"Demonstrates the time format HH:MM:SS.SSS.",...f.parameters?.docs?.description}}};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: () => html\`<ic-time-input
      emit-time-part-change="true"
      label="What time would you like to collect your coffee?"
      time-format="HH:MM:SS.SSS"
...
}`,...g.parameters?.docs?.source},description:{story:"The time input can be cleared by setting the the value attribute to one of the following:\n- empty string\n- `null`\n- `undefined`",...g.parameters?.docs?.description}}};const _=["Default","IcTimeChangeEvent","WithValue","DateObject","ZuluTime","Required","HideLabel","Disabled","Sizes","CustomHelperText","HideHelperText","Validation","AriaLiveBehaviour","IcTimeChangeEmitTimePartChanges","TimePeriod","TimePeriodAMPMToggle","IcTimeChangeTimeParts12Hour","IcTimeChangeTimeParts12HourMilliseconds","HHMM","Milliseconds","IcTimeChangeTimePartsMilliseconds","MinTime","MaxTime","DisableTimes","WithClearingValue"],Y=Object.freeze(Object.defineProperty({__proto__:null,AriaLiveBehaviour:T,CustomHelperText:s,DateObject:o,Default:i,DisableTimes:v,Disabled:c,HHMM:h,HideHelperText:S,HideLabel:l,IcTimeChangeEmitTimePartChanges:d,IcTimeChangeEvent:n,IcTimeChangeTimeParts12Hour:W,IcTimeChangeTimeParts12HourMilliseconds:E,IcTimeChangeTimePartsMilliseconds:I,MaxTime:y,Milliseconds:f,MinTime:b,Required:a,Sizes:u,TimePeriod:p,TimePeriodAMPMToggle:k,Validation:m,WithClearingValue:g,WithValue:r,ZuluTime:w,__namedExportsOrder:_,default:Z},Symbol.toStringTag,{value:"Module"}));export{Y as I};
