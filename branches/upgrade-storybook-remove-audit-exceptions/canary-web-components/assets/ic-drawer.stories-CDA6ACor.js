import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";import{n as i,t as a}from"./taggedTemplateLiteral-2dP4OITE.js";var o,s=t((()=>{o=``+new URL(`readme-BOG0sMFl.md`,import.meta.url).href})),c=e({BottomPosition:()=>D,ContainedWithinParent:()=>k,ControlledTrigger:()=>A,ControlledTriggerContainedWithinParent:()=>j,Expanded:()=>O,Large:()=>N,LeftPosition:()=>T,Playground:()=>I,RightPosition:()=>w,ShowHideInteractiveElements:()=>F,SlottedContent:()=>P,Small:()=>M,TopPosition:()=>E,__namedExportsOrder:()=>L,default:()=>S}),l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R=t((()=>{n(),s(),i(),S={title:`Web Components/Drawer`,component:`ic-drawer`,parameters:{componentAPI:{data:o},layout:`fullscreen`}},C={boundary:`viewport`,chevronButtonAriaLabel:``,closeButtonAriaLabel:``,closeOnBackdropClick:!0,expanded:!1,heading:`Roasted coffee`,hideCloseButton:!1,message:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut pharetra tortor, sed lacinia lectus. Aliquam elementum risus ipsum, sit amet tincidunt elit pharetra quis. Morbi maximus dolor sit amet nulla feugiat, sed congue ligula dignissim. Nullam ac augue nec erat suscipit scelerisque. Aliquam at tellus fringilla, faucibus est posuere, convallis magna. Integer vel ornare lectus. Vestibulum convallis mauris vel quam vehicula maximus. Fusce et consequat lacus, non auctor tellus. In ut lacus aliquet, accumsan tellus a, volutpat ante. Aliquam erat volutpat. Nam non lectus mauris. In eu libero ut augue viverra accumsan. Praesent non felis tortor. Nullam rutrum odio justo, bibendum pulvinar leo dictum a. Donec sodales sagittis ultricies. Duis posuere a mauris vitae auctor. Pellentesque porta, massa ac pellentesque feugiat, diam mauris commodo neque, quis gravida risus est sit amet lacus. Fusce rhoncus leo nec lobortis mattis. Donec risus leo, eleifend efficitur purus ac, sollicitudin dictum neque. Suspendisse potenti. Etiam mattis felis nisi, non laoreet ipsum sollicitudin at. Quisque metus nibh, imperdiet nec euismod a, convallis et sem. Maecenas cursus porttitor fringilla. Ut gravida ante at orci sagittis tincidunt. Integer porta nisl nisi, in vehicula felis aliquet sit amet. Praesent eleifend libero in vulputate convallis. Aenean aliquet ante a venenatis convallis. Donec quis felis semper, imperdiet tellus eu, imperdiet nisi. Sed aliquet felis nec tellus aliquet, et sodales sem varius. Etiam justo mauris, dapibus a ornare id, volutpat sit amet orci. Nam eu condimentum tortor, rhoncus fermentum nunc. Duis mollis justo a tortor tempus dictum. Quisque vulputate, risus non tempor varius, eros velit rutrum dui, non gravida elit erat eget ex. Ut cursus congue enim eget eleifend. Nullam iaculis neque non ligula aliquam, vitae rutrum arcu ultrices. Etiam porttitor condimentum dolor, ut luctus risus condimentum sit amet. Duis faucibus commodo leo nec bibendum. Nam faucibus, lectus vitae pulvinar ullamcorper, risus orci tempus sapien, varius pulvinar nulla odio eget ipsum. Mauris vestibulum sem vitae lectus feugiat, in tincidunt neque fringilla. Fusce lacus eros, elementum sit amet sapien et, congue venenatis metus. Nullam mauris velit, pharetra et ligula faucibus, pulvinar luctus nisl. Etiam ante odio, fermentum ac accumsan eget, luctus a libero. Phasellus maximus risus ac viverra scelerisque.`,position:`right`,size:`medium`,theme:`inherit`,trigger:`chevron`,actionsSlot:!0,headingAdornmentSlot:!0,headingSlot:!1,messageSlot:!1,"--ic-drawer-height":``,"--ic-drawer-width":``},w={render:e=>r(l||=a([`<ic-drawer
    ...
    <\/script>`])),name:`Right position`},T={render:e=>r(u||=a([`<ic-drawer
      heading="Roasted coffee"
      message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
      position="left"
    >
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Left position`},E={render:e=>r(d||=a([`<ic-drawer
      heading="Roasted coffee"
      message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
      position="top"
    >
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Top position`},D={render:e=>r(f||=a([`<ic-drawer
      heading="Roasted coffee"
      message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
      position="bottom"
    >
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Bottom position`},O={render:e=>r(p||=a([`<ic-drawer
      heading="Roasted coffee"
      message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
      expanded="true"
    >
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Expanded`},k={render:()=>r(m||=a([`<div
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Contained within parent`},A={render:()=>r(h||=a([`<div style="margin: 16px; display: flex; gap: 16px;">
    ...
    <\/script>`],[`<div style="margin: 16px; display: flex; gap: 16px;">
      <ic-button onclick="toggleDrawer('right')">Toggle right drawer</ic-button>
      <ic-button onclick="toggleDrawer('left')">Toggle left drawer</ic-button>
      <ic-button onclick="toggleDrawer('top')">Toggle top drawer</ic-button>
      <ic-button onclick="toggleDrawer('bottom')"
    ...
    <\/script>`])),name:`Controlled trigger`},j={render:()=>r(g||=a([`<div
    ...
    <\/script>`])),name:`Controlled trigger - contained within parent`},M={render:e=>r(_||=a([`<ic-drawer
      heading="Roasted coffee"
      message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
      size="small"
    >
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Small`},N={render:e=>r(v||=a([`<ic-drawer
      heading="Roasted coffee"
      message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
      size="large"
    >
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`])),name:`Large`},P={render:e=>r(y||=a([`<ic-drawer>
    <svg
      slot="heading-adornment"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
  ...
  <script>
    ...
    <\/script>`])),name:`Slotted content`},F={render:e=>r(b||=a([`<script>
    ...
    <script>
      ...
      document
        .querySelector("ic-drawer")
        .addEventListener("icDrawerExpanded", handleDrawerExpanded);
    <\/script>`]),`<div>`),name:`Show / hide interactive elements`},I={render:e=>r(x||=a([`<div style="display: flex; height: 100%">
    ...
    <\/script>
  </div>`]),e.trigger===`controlled`?r`<ic-button variant="secondary" onclick="toggleDrawer()"
                  >Learn more about roasted coffee</ic-button
                >`:``,e.boundary,e.chevronButtonAriaLabel,e.closeButtonAriaLabel,e.closeOnBackdropClick,e.expanded,e.heading,e.hideCloseButton,e.message,e.position,e.size,e.theme,e.trigger,e[`--ic-drawer-width`]===``?``:`--ic-drawer-width: ${e[`--ic-drawer-width`]};`,e[`--ic-drawer-height`]===``?``:`--ic-drawer-height: ${e[`--ic-drawer-height`]};`,e.headingAdornmentSlot?r`<svg
                  slot="heading-adornment"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                  <path
                    d="M2,21H20V19H2M20,8H18V5H20M20,3H4V13A4,4 0 0,0 8,17H14A4,4 0 0,0 18,13V10H20A2,2 0 0,0 22,8V5C22,3.89 21.1,3 20,3Z"
                  />
                </svg>`:``,e.headingSlot?r`<ic-typography slot="heading" variant="h4">
                  <h4>(Slotted) Roasted coffee</h4>
                </ic-typography>`:``,e.messageSlot?r`<ic-typography slot="message">
                  <p>
                    (Slotted)
                    <br />
                ...
                </ic-typography>`:``,e.actionsSlot?r`<ic-button slot="actions" variant="secondary"
                    >Learn even more</ic-button
                  >
                  <ic-button slot="actions" variant="secondary"
                    >Add to favourites</ic-button
                  >
                  <ic-button slot="actions">Add to order</ic-button>`:``),name:`Playground`,args:C,argTypes:{boundary:{options:[`viewport`,`parent`],control:{type:`inline-radio`}},position:{options:[`top`,`bottom`,`left`,`right`],control:{type:`inline-radio`}},size:{options:[`small`,`medium`,`large`],control:{type:`inline-radio`}},theme:{options:[`inherit`,`light`,`dark`],control:{type:`inline-radio`}},trigger:{options:[`chevron`,`controlled`],control:{type:`inline-radio`}}}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
      ...
      >
        ...
        <div style="display: flex; flex: 1; position: relative">
          <ic-section-container aligned="center">
            ...
            <br />
            \${args.trigger === "controlled" ? html\`<ic-button variant="secondary" onclick="toggleDrawer()"
                  >Learn more about roasted coffee</ic-button
                >\` : ""}
          </ic-section-container>
          <ic-drawer
            ...
            style="
            \${args["--ic-drawer-width"] !== "" ? \`--ic-drawer-width: \${args["--ic-drawer-width"]};\` : ""}
            \${args["--ic-drawer-height"] !== "" ? \`--ic-drawer-height: \${args["--ic-drawer-height"]};\` : ""}"
          >
            \${args.headingAdornmentSlot ? html\`<svg
                  slot="heading-adornment"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
            ...
            \${args.headingSlot ? html\`<ic-typography slot="heading" variant="h4">
                  <h4>(Slotted) Roasted coffee</h4>
                </ic-typography>\` : ""}
            \${args.messageSlot ? html\`<ic-typography slot="message">
                  <p>
                    (Slotted)
                    <br />
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            ...
            \${args.actionsSlot ? html\`<ic-button slot="actions" variant="secondary"
                    >Learn even more</ic-button
                  >
                  <ic-button slot="actions" variant="secondary"
                    >Add to favourites</ic-button
...
}`,...I.parameters?.docs?.source}}},L=[`RightPosition`,`LeftPosition`,`TopPosition`,`BottomPosition`,`Expanded`,`ContainedWithinParent`,`ControlledTrigger`,`ControlledTriggerContainedWithinParent`,`Small`,`Large`,`SlottedContent`,`ShowHideInteractiveElements`,`Playground`]}));R();export{D as BottomPosition,k as ContainedWithinParent,A as ControlledTrigger,j as ControlledTriggerContainedWithinParent,O as Expanded,N as Large,T as LeftPosition,I as Playground,w as RightPosition,F as ShowHideInteractiveElements,P as SlottedContent,M as Small,E as TopPosition,L as __namedExportsOrder,S as default,R as n,c as t};