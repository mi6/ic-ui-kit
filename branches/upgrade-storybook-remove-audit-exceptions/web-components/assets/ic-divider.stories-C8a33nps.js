import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";var i=e({BorderStyle:()=>l,LabelPlacement:()=>f,MaxContent:()=>d,Playground:()=>p,Theme:()=>s,Vertical:()=>u,Weight:()=>c,__namedExportsOrder:()=>m,default:()=>o}),a,o,s,c,l,u,d,f,p,m,h=t((()=>{n(),a={"border-style":`solid`,label:``,"label-placement":`none`,monochrome:!1,orientation:`horizontal`,theme:`inherit`,weight:`thin`,"--ic-divider-horizontal-width":`100%`,"--ic-divider-vertical-height":`400px`,"--ic-divider-background":``,"--ic-divider-background-monochrome":``,"--ic-divider-label":``,"--ic-divider-label-monochrome":``,"--ic-divider-label-width":``},o={title:`Web Components/Divider`,component:`ic-divider`},s={render:()=>r` <div
  ...
  `,name:`Vertical`},d={render:()=>r` <div
      ...
      >
        ...
        🎶 In west Philadelphia, born and raised; in the coffee shop was where I spent most of my days. Chillin’ out, maxin’, relaxin’ all cool, sippin’ on some cappuccinos outside of the school 🎶"
          ...
          orientation="vertical"
        ></ic-divider>
      </div>`,name:`Max content`},f={render:()=>r` <div
        style="display: flex; flex-direction: column; gap: var(--ic-space-lg)"
      >
      ...
      >
        ...
        >
      </div>`,name:`Label placement`},p={render:e=>r`<div
      style="display: flex; width: 100%; height: 100%; padding: var(--ic-space-md); background-color: ${e.theme===`dark`?`var(--ic-color-page-background-dark)`:e.theme===`light`?`var(--ic-color-background-primary-light)`:`transparent`}; box-sizing: border-box;"
    >
      <ic-divider
      ...
      ></ic-divider>
    </div>`,args:a,argTypes:{"border-style":{options:[`solid`,`dashed`],control:{type:`inline-radio`}},label:{mapping:{none:``}},"label-placement":{options:[`none`,`left`,`center`,`right`,`top`,`bottom`],mapping:{none:``},control:{type:`radio`}},orientation:{options:[`horizontal`,`vertical`],control:{type:`inline-radio`}},theme:{options:[`inherit`,`dark`,`light`],control:{type:`radio`}},weight:{options:[`thin`,`medium`,`thick`,`very-thick`],control:{type:`radio`}},"--ic-divider-background":{control:{type:`color`}},"--ic-divider-background-monochrome":{control:{type:`color`}},"--ic-divider-label":{control:{type:`color`}},"--ic-divider-label-monochrome":{control:{type:`color`}}},name:`Playground`},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => html\` <div
      style="display: flex; flex-direction: column; gap: var(--ic-space-md)"
    >
      <ic-divider
  ...
  name: "Playground"
}`,...p.parameters?.docs?.source}}},m=[`Theme`,`Weight`,`BorderStyle`,`Vertical`,`MaxContent`,`LabelPlacement`,`Playground`]}));h();export{l as BorderStyle,f as LabelPlacement,d as MaxContent,p as Playground,s as Theme,u as Vertical,c as Weight,m as __namedExportsOrder,o as default,h as n,i as t};