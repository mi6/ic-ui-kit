import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";import{n as i,t as a}from"./taggedTemplateLiteral-2dP4OITE.js";var o=e({AriaDescribedby:()=>I,Destructive:()=>_,Dropdown:()=>b,DropdownExample:()=>x,FileUpload:()=>R,FileUploadInAForm:()=>L,FullWidth:()=>E,Height:()=>O,IconVariants:()=>v,IconWithoutViewBox:()=>T,Loading:()=>F,MinWidth:()=>D,Playground:()=>M,PlaygroundIconOnly:()=>P,PlaygroundWithIcon:()=>N,PositioningStrategy:()=>A,Primary:()=>m,RouterLink:()=>C,RouterLinkWithSlottedContent:()=>w,Secondary:()=>h,Size:()=>S,Tertiary:()=>g,Tooltips:()=>k,WithIcon:()=>y,__namedExportsOrder:()=>z,default:()=>p}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B=t((()=>{n(),i(),f={message:`Custom Button`,disabled:!1,loading:!1,theme:`inherit`,size:`medium`,variant:`secondary`,fullWidth:!1,iconPlacement:`right-icon`,monochrome:!1,dropdown:!1,transparentBackground:!0},p={title:`Web Components/Button`,component:`ic-button`},m={render:()=>r`<div
      ...
      </div>`,name:`Primary`},h={render:()=>r` <div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
          style="padding: 1rem; display: flex; flex-direction: column; gap: 0.5rem"
      ...
      </div>`,name:`Secondary`},g={render:()=>r` <div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
          style="padding: 1rem; display: flex; flex-direction: column; gap: 0.5rem"
      ...
      </div>`,name:`Tertiary`},_={render:()=>r` <div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
          style="padding: 1rem; display: flex; flex-direction: column; gap: 0.5rem"
      ...
      </div>`,name:`Destructive`},v={render:()=>r`<div style="display:flex; gap: 1rem; flex-direction:column;">
      <div>
    ...
    </div>`,name:`Icon variants`},y={render:()=>r`<div style="padding: 1rem; display: flex; gap: 1rem">
      ...
      </div> `,name:`With icon`},b={render:()=>r`<div>
    ...
    </div>`,name:`Dropdown`},x={render:()=>r(s||=a([`<script>
      ...
      </div>`])),name:`Dropdown example`},S={render:()=>r` <ic-button variant="primary" size="small">Small</ic-button>
      ...
      </ic-button>`,name:`Size`},C={render:()=>r`<div style="padding: 8px">
      ...
      </div>`,name:`Router link`,parameters:{layout:`fullscreen`}},w={render:()=>r`<div style="padding: 8px">
        <ic-button size="small">
          <a slot="router-item" href="/">
            <svg
              slot="left-icon"
      ...
      </div>`,name:`Router link - with slotted content`,parameters:{layout:`fullscreen`}},T={render:()=>r`<ic-button variant="primary" size="small"
        >Small
        <svg
          slot="left-icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      </ic-button>`,name:`Icon without viewBox`},E={render:()=>r`
  ...
  `,name:`Height`},k={render:()=>r`<ic-button
        variant="icon"
        aria-label="refresh"
      ...
      >`,name:`Tooltips`},A={render:()=>r(c||=a([` <script>
      ...
      </div>`])),name:`Tooltip positioning strategy`},j=`inline-radio`,M={render:e=>r`<ic-button
      disabled=${e.disabled}
      variant=${e.variant}
      ...
      >${e.message}</ic-button
    >`,args:f,argTypes:{variant:{options:[`primary`,`secondary`,`tertiary`,`destructive`],control:{type:`select`}},size:{options:[`medium`,`large`,`small`],control:{type:j}},theme:{options:[`inherit`,`dark`,`light`],control:{type:j}},fullWidth:{control:{type:`boolean`}},monochrome:{control:{type:`boolean`}},dropdown:{control:{type:`boolean`}},transparentBackground:{control:{type:`boolean`}}},name:`Playground`},N={render:e=>r`<ic-button
      disabled=${e.disabled}
      variant=${e.variant}
      size=${e.size}
      full-width=${e.fullWidth}
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-button>`,args:{...f},argTypes:{variant:{options:[`primary`,`secondary`,`tertiary`,`destructive`],control:{type:`select`}},size:{options:[`medium`,`large`,`small`],control:{type:j}},theme:{options:[`default`,`dark`,`light`],control:{type:j}},fullWidth:{control:{type:`boolean`}},iconPlacement:{options:[`left-icon`,`right-icon`,`top-icon`],control:{type:j}},monochrome:{control:{type:`boolean`}}},name:`Playground with icon`},P={render:e=>r`<ic-button
      disable-tooltip=${e.disableTooltip}
      disabled=${e.disabled}
      full-width=${e.fullWidth}
      href=${e.href}
      loading=${e.loading}
    ...
    >
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-button>`,args:{disableTooltip:!1,disabled:!1,fullWidth:!1,href:``,loading:!1,monochrome:!1,size:`medium`,theme:`inherit`,tooltipPlacement:`bottom`,transparentBackground:!1,variant:`icon-primary`},argTypes:{variant:{options:[`icon-primary`,`icon-secondary`,`icon-tertiary`,`icon-destructive`],control:{type:`select`}},size:{options:[`medium`,`large`,`small`],control:{type:j}},theme:{options:[`inherit`,`dark`,`light`],control:{type:j}},tooltipPlacement:{options:[`top`,`right`,`bottom`,`left`],control:{type:j}}},name:`Playground - icon only`},F={render:()=>r`
    <div style="padding: 6px">
  ...
  `])),name:`Aria-describedby`},L={render:()=>r(u||=a([`
    ...
    <\/script>
  `])),name:`File upload in a form`},R={render:()=>r(d||=a([`
    <span id="selected-file">No File Selected</span>
    <div style="padding: 6px">
      <ic-button
        variant="primary"
    ...
    <\/script>
  `])),name:`File upload`},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => html\`<div
        style="display: flex; flex-direction: row; width: fit-content; background-color: #ececec;"
      >
        <div
  ...
  render: args => html\`<ic-button
      disable-tooltip=\${args.disableTooltip}
      disabled=\${args.disabled}
      full-width=\${args.fullWidth}
      href=\${args.href}
      loading=\${args.loading}
  ...
  \`,
  name: "File upload"
}`,...R.parameters?.docs?.source}}},z=[`Primary`,`Secondary`,`Tertiary`,`Destructive`,`IconVariants`,`WithIcon`,`Dropdown`,`DropdownExample`,`Size`,`RouterLink`,`RouterLinkWithSlottedContent`,`IconWithoutViewBox`,`FullWidth`,`MinWidth`,`Height`,`Tooltips`,`PositioningStrategy`,`Playground`,`PlaygroundWithIcon`,`PlaygroundIconOnly`,`Loading`,`AriaDescribedby`,`FileUploadInAForm`,`FileUpload`]}));B();export{I as AriaDescribedby,_ as Destructive,b as Dropdown,x as DropdownExample,R as FileUpload,L as FileUploadInAForm,E as FullWidth,O as Height,v as IconVariants,T as IconWithoutViewBox,F as Loading,D as MinWidth,M as Playground,P as PlaygroundIconOnly,N as PlaygroundWithIcon,A as PositioningStrategy,m as Primary,C as RouterLink,w as RouterLinkWithSlottedContent,h as Secondary,S as Size,g as Tertiary,k as Tooltips,y as WithIcon,z as __namedExportsOrder,p as default,B as n,o as t};