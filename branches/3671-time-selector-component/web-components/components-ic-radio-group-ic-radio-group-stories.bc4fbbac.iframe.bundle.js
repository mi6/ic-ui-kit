/*! For license information please see components-ic-radio-group-ic-radio-group-stories.bc4fbbac.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[1873,582,6199,6763],{"./src/components/ic-radio-group/ic-radio-group.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AriaLiveBehaviour:()=>AriaLiveBehaviour,ConditionalDynamic:()=>ConditionalDynamic,ConditionalStatic:()=>ConditionalStatic,Default:()=>Default,Disabled:()=>Disabled,Form:()=>Form,HelperText:()=>HelperText,Horizontal:()=>Horizontal,Playground:()=>Playground,RTL:()=>RTL,Required:()=>Required,Small:()=>Small,Validation:()=>Validation,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Radio button",component:"Radio"},Default={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `,name:"Validation"},AriaLiveBehaviour={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-radio-group
        id="field-1"
        label="This is a label"
        name="1"
      ...
      </script>`,name:"Aria-live behaviour"},Form={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <form>
      <ic-radio-group label="This is a label" name="1">
        <ic-radio-option
          value="valueName1"
