var g=Object.freeze,v=Object.defineProperty;var u=(i,b)=>g(v(i,"raw",{value:g(b||i.slice())}));import{x as o}from"./lit-html-CWQq0DyO.js";const x={accessibleButtonLabel:"accordions",expanded:!1,label:"Accordion group",singleExpansion:!1,size:"medium",disabled:!1,heading:"Accordion 1",message:"This is an example of the main body text.",theme:"inherit",expandedAccordion:!1,sizeAccordion:"medium",themeAccordion:"inherit"},w={title:"Web Components/Accordion",component:"ic-accordion"},n={render:()=>o` <ic-accordion heading="Accordion 1">
      ...
      </ic-accordion>`,name:"Default"},e={render:()=>o` <ic-accordion expanded="true" heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text.
        </ic-typography>
      </ic-accordion>
      ...
      </ic-accordion>`,name:"Expanded"},c={render:()=>o` <ic-accordion heading="Accordion 1">
        <svg
          slot="icon"
          width="20"
          height="1em"
      ...
      </ic-accordion>`,name:"Icon"},a={render:()=>o` <ic-accordion-group label="Title of the Accordion Group">
    ...
    </ic-accordion-group>`,name:"Group Title"},t={render:()=>o` <ic-accordion-group label="Small Accordion Group" size="small">
        <ic-accordion heading="Accordion 1">
          <svg
            slot="icon"
            width="20"
      ...
      </ic-accordion-group>`,name:"Sizes"},r={render:()=>o` <ic-accordion-group
    ...
    >
    ...
    </ic-accordion-group>`,name:"Single expansion"},d={render:()=>o` <ic-accordion-group label="Title of the Accordion Group">
      <ic-accordion heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text
        </ic-typography>
    ...
    </ic-accordion-group>`,name:"Parent"},l={render:()=>o` <ic-accordion heading="Accordion 1">
        <ic-typography variant="body">
          This is an example of the main body text.
        </ic-typography>
      </ic-accordion>
      ...
      </ic-accordion>`,name:"Disabled"};var y;const s={render:()=>o(y||(y=u([`
    ...
    <\/script>
  `]))),name:"With popover content"},p={render:()=>o`<ic-accordion-group>
    ...
    </ic-accordion-group>`,name:"Slotted headings"},m="inline-radio",h={render:i=>o`<ic-accordion-group
      accessible-button-label=${i.accessibleButtonLabel}
      label=${i.label}
      expanded=${i.expanded}
      single-expansion=${i.singleExpansion}
      size=${i.size}
      theme=${i.theme}
    >
      <ic-accordion
        ...
        size=${i.sizeAccordion}
        message=${i.message}
        theme=${i.themeAccordion}
      >
        <svg
          slot="icon"
          width="20"
    ...
    </ic-accordion-group>`,args:x,name:"Playground",argTypes:{size:{options:["small","medium","large"],control:{type:m}},theme:{options:["inherit","light","dark"],control:{type:m}},sizeAccordion:{options:["small","medium","large"],control:{type:m}},themeAccordion:{options:["inherit","light","dark"],control:{type:m}}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...h.parameters?.docs?.source}}};const L=["Default","Expanded","Icon","GroupTitle","Sizes","SingleExpansion","Parent","Disabled","WithPopoverContent","SlottedHeadings","Playground"],C=Object.freeze(Object.defineProperty({__proto__:null,Default:n,Disabled:l,Expanded:e,GroupTitle:a,Icon:c,Parent:d,Playground:h,SingleExpansion:r,Sizes:t,SlottedHeadings:p,WithPopoverContent:s,__namedExportsOrder:L,default:w},Symbol.toStringTag,{value:"Module"}));export{C as I};
