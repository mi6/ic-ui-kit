var k=Object.freeze,Z=Object.defineProperty;var e=(t,E)=>k(Z(t,"raw",{value:k(E||t.slice())}));import{x as n}from"./lit-html-CWQq0DyO.js";const T={message:"Custom Button",disabled:!1,loading:!1,theme:"inherit",size:"medium",variant:"secondary",fullWidth:!1,iconPlacement:"right-icon",monochrome:!1,dropdown:!1,transparentBackground:!0},F={title:"Web Components/Button",component:"ic-button"},o={render:()=>n`<div
    ...
    </div>`,name:"Icon variants"},d={render:()=>n`<div style="padding: 1rem; display: flex; gap: 1rem">
      ...
      </div> `,name:"With icon"},s={render:()=>n`<div>
  ...
  `,name:"Height"},y={render:()=>n`<ic-button
        variant="icon"
        aria-label="refresh"
      ...
      >`,name:"Tooltips"};var S;const x={render:()=>n(S||(S=e([` <script>
  ...
  \`,
  name: "File upload"
}`,...B.parameters?.docs?.source}}};const A=["Primary","Secondary","Tertiary","Destructive","IconVariants","WithIcon","Dropdown","DropdownExample","Size","RouterLink","RouterLinkWithSlottedContent","IconWithoutViewBox","FullWidth","MinWidth","Height","Tooltips","PositioningStrategy","Playground","PlaygroundWithIcon","PlaygroundIconOnly","Loading","AriaDescribedby","FileUploadInAForm","FileUpload"],I=Object.freeze(Object.defineProperty({__proto__:null,AriaDescribedby:H,Destructive:l,Dropdown:s,DropdownExample:h,FileUpload:B,FileUploadInAForm:L,FullWidth:m,Height:w,IconVariants:c,IconWithoutViewBox:u,Loading:M,MinWidth:b,Playground:f,PlaygroundIconOnly:z,PlaygroundWithIcon:V,PositioningStrategy:x,Primary:o,RouterLink:v,RouterLinkWithSlottedContent:g,Secondary:a,Size:p,Tertiary:r,Tooltips:y,WithIcon:d,__namedExportsOrder:A,default:F},Symbol.toStringTag,{value:"Module"}));export{I};
