var p=Object.freeze,y=Object.defineProperty;var f=(n,b)=>p(y(n,"raw",{value:p(b||n.slice())}));import{x as e}from"./lit-html-CWQq0DyO.js";const w={dismissible:!1,heading:"Heading",message:"Message",titleAbove:!1,variant:"neutral",showAction:!1,showDefaultIcon:!0,showSlottedIcon:!1,theme:"inherit"},T={title:"Web Components/Alert",component:"ic-alert"},a={render:()=>e`<ic-alert
        heading="Neutral"
      ...
      ></ic-alert>`,name:"Variants"},s={render:()=>e`<ic-alert
      message="This alert is for displaying miscellaneous messages"
    ...
    </ic-alert>`,name:"Custom message"},d={render:()=>e`<ic-alert
  ...
  </ic-alert>`,name:"Custom message and title above"};var v;const m={render:()=>e(v||(v=f([`
    <ic-alert
      id="alert"
      heading="Neutral"
      message="This alert is for displaying miscellaneous messages"
  ...
  `,name:"Slotted icon"},h={render:()=>e`
    <ic-alert
      ...
      show-default-icon="false"
    ></ic-alert>
  `,name:"No icon"},u={render:n=>e`<ic-alert
      dismissible=${n.dismissible}
      variant=${n.variant}
      heading=${n.heading}
      message=${n.message}
      title-above=${n.titleAbove}
      show-default-icon=${n.showDefaultIcon}
      theme=${n.theme}
    >
      ${n.showAction&&e`<ic-button slot="action" variant="secondary" monochrome="true"
        >Button</ic-button
      >`}
      ${n.showSlottedIcon&&e`<svg
        slot="neutral-icon"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
        viewBox="0 0 24 24"
    ...
    </ic-alert>`,args:w,argTypes:{variant:{options:["neutral","info","warning","error","success","ai"],control:{type:"inline-radio"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...u.parameters?.docs?.source}}};const A=["Variants","MessageOnly","Dismissible","WithAction","DismissibleWithAction","TitleAbove","ResponsiveTitle","CustomMessage","CustomMessageAndTitleAbove","Announced","SlottedIcon","NoIcon","Playground"],k=Object.freeze(Object.defineProperty({__proto__:null,Announced:m,CustomMessage:c,CustomMessageAndTitleAbove:d,Dismissible:t,DismissibleWithAction:r,MessageOnly:s,NoIcon:h,Playground:u,ResponsiveTitle:l,SlottedIcon:g,TitleAbove:o,Variants:a,WithAction:i,__namedExportsOrder:A,default:T},Symbol.toStringTag,{value:"Module"}));export{k as I};
