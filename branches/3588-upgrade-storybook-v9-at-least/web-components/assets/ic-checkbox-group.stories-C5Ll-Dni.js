var S=Object.freeze,w=Object.defineProperty;var a=(e,D)=>S(w(e,"raw",{value:S(D||e.slice())}));import{x as c}from"./lit-html-CWQq0DyO.js";const{useArgs:q}=__STORYBOOK_MODULE_PREVIEW_API__,H={additionalFieldDisplay:"dynamic",additionalFieldSlot:"additional-field",checked:!1,disabled:!1,dynamicText:"Dynamic text",groupLabel:"Checkbox group label",helperText:"Helper text",hideLabel:!1,hideGroupLabel:!1,indeterminate:!1,label:"Checkbox label",nativeIndeterminateBehaviour:!1,required:!1,size:"medium",validationAriaLive:"polite",validationStatus:"no status",validationText:"",value:"checkbox-value",theme:"inherit"},$={title:"Web Components/Checkbox",component:"Checkbox"},n={render:()=>c`
  ...
  `,name:"Hidden group label"},r={render:()=>c`
    <ic-checkbox-group label="This is a label" name="group1">
      <ic-checkbox
        value="valueName1"
        label="Unselected / Default"
  ...
  `,name:"Hidden checkbox label"};var C;const d={render:()=>c(C||(C=a([`
    <script>
  ...
  `]))),name:"Conditional dynamic"},b={render:()=>c`
    <ic-checkbox-group label="This is a label" name="group1">
  ...
  `,name:"Conditional static"},s={render:()=>c`
  ...
  `,name:"Validation"};var T;const k={render:()=>c(T||(T=a([`<ic-checkbox-group
        id="field-1"
        label="This is a label"
        name="1"
      ...
      <\/script>`]))),name:"Aria-live behaviour"};var E;const x={render:()=>c(E||(E=a([`
    <form>
      <ic-checkbox-group label="This is a label" name="group1">
        <ic-checkbox
          name="checkbox1"
    ...
    <\/script>
  `]))),name:"Form"};var I;const m={render:()=>c(I||(I=a([`
    <script>
  ...
  `]))),name:"Indeterminate"};var L;const v={render:()=>c(L||(L=a([`
    <script>
  ...
  `]))),name:"Indeterminate with children"};var U;const p={render:()=>c(U||(U=a([`
    <script>
  ...
  `]))),name:"TextField value change"},g={render:()=>c`
 ...
 `,name:"Internationalisation"},N="inline-radio",y={render:e=>{const[{checked:D},z]=q();return c` <ic-checkbox-group
      disabled=${e.disabled}
      label=${e.groupLabel}
      size=${e.size}
    ...
    </ic-checkbox-group>`},args:H,argTypes:{additionalFieldDisplay:{options:["dynamic","static"],control:{type:N}},additionalFieldSlot:{options:["additional-field",""],control:{type:"select"}},size:{options:["medium","large","small"],control:{type:N}},validationAriaLive:{options:["polite","assertive","off"],control:{type:N}},validationStatus:{options:["no status","warning","error","success"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:N}}},name:"Playground"};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <ic-checkbox-group label="This is a label" name="group1">
      <ic-checkbox
        value="valueName1"
 ...
 \`,
  ...
  name: "Playground"
}`,...y.parameters?.docs?.source}}};const A=["Default","Required","Disabled","Sizes","HiddenGroupLabel","HiddenCheckboxLabel","ConditionalDynamic","ConditionalStatic","SlottedLabel","HelperText","Validation","AriaLiveBehaviour","Form","Indeterminate","IndeterminateWithChildren","TextFieldValueChange","RTL","Internationalisation","Playground"],M=Object.freeze(Object.defineProperty({__proto__:null,AriaLiveBehaviour:k,ConditionalDynamic:d,ConditionalStatic:b,Default:n,Disabled:l,Form:x,HelperText:u,HiddenCheckboxLabel:r,HiddenGroupLabel:o,Indeterminate:m,IndeterminateWithChildren:v,Internationalisation:f,Playground:y,RTL:g,Required:i,Sizes:t,SlottedLabel:s,TextFieldValueChange:p,Validation:h,__namedExportsOrder:A,default:$},Symbol.toStringTag,{value:"Module"}));export{M as I};
