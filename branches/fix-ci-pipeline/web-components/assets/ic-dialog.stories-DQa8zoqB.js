var b=Object.freeze,q=Object.defineProperty;var t=(e,M)=>b(q(e,"raw",{value:b(M||e.slice())}));import{x as i}from"./lit-html-CWQq0DyO.js";const E={closeOnBackdropClick:!0,destructive:!1,dismissLabel:"Dismiss",disableHeightConstraint:!1,disableWidthConstraint:!1,hideCloseButton:!1,hideDefaultControls:!1,heading:"This is a dialog",label:"Dialog",open:!0,size:"medium",theme:"inherit"},W={title:"Web Components/Dialog",component:"ic-dialog"};var y;const n={render:()=>i(y||(y=t([`
    <script>
  ...
  `]))),name:"Sizes"};var v;const o={render:()=>i(v||(v=t([`
    <script>
      function showDialog() {
  ...
  `]))),name:"Slotted content"};var f;const a={render:()=>i(f||(f=t([`
  <script>
      function showDialog() {
        dialog = document.querySelector("ic-dialog");
        dialog.open = true;
    ...
    </>`]))),name:"Slotted tabs"};var w;const s={render:()=>i(w||(w=t([`
    <script>
  ...
  `]))),name:"Background close prevented"};var k;const l={render:()=>i(k||(k=t([`
    <script>
  ...
  `]))),name:"Scrollable"};var L;const r={render:()=>i(L||(L=t([`
    <script>
      function showDialog() {
        dialog = document.querySelector("ic-dialog");
        dialog.open = true;
  ...
  `]))),name:"Events example"};var I;const d={render:()=>i(I||(I=t([`
    <script>
  ...
  `]))),name:"Popover"};var C;const c={render:()=>i(C||(C=t([`
    <script>
      function dropdownItems() {
        return Array.from(Array(10).keys()).map((i) => {
          return {
  ...
  `]))),name:"Disable Height Constraint"};var S;const u={render:()=>i(S||(S=t([`
    <script>
      document
  ...
  `]))),name:"Disable Width Constraint"};var x;const h={render:()=>i(x||(x=t([`
    <script>
  ...
  `])),"<div>"),name:"Show / hide interactive elements"};var T;const p={render:()=>i(T||(T=t([`
    <script>
  ...
  `]))),name:"Hidden close button"};var D;const m={render:()=>i(D||(D=t([`
    <script>
  ...
  `]))),name:"Auto Opening"},g={render:e=>i`<ic-dialog
      heading=${e.heading}
      label=${e.label}
      size=${e.size}
      open=${e.open}
    ...
    </ic-dialog>`,args:E,argTypes:{size:{options:["small","medium","large"],control:{type:"radio"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <script>
      function showSmallDialog() {
        dialog = document.querySelector("#small-dialog");
  ...
  name: "Playground"
}`,...g.parameters?.docs?.source}}};const P=["Sizes","SlottedContent","SlottedTabs","BackgroundClosePrevented","Scrollable","EventsExample","Popover","DisableHeightConstraint","DisableWidthConstraint","ShowHideInteractiveElements","HiddenCloseButton","AutoOpening","Playground"],z=Object.freeze(Object.defineProperty({__proto__:null,AutoOpening:m,BackgroundClosePrevented:s,DisableHeightConstraint:c,DisableWidthConstraint:u,EventsExample:r,HiddenCloseButton:p,Playground:g,Popover:d,Scrollable:l,ShowHideInteractiveElements:h,Sizes:n,SlottedContent:o,SlottedTabs:a,__namedExportsOrder:P,default:W},Symbol.toStringTag,{value:"Module"}));export{z as I};
