import{b as e}from"./lit-html-B6sBSybp.js";const o={target:"topEl",theme:"inherit",variant:"default",position:"right"},l="inline-radio",c={title:"Web Components/Back to top",component:"ic-back-to-top"},i={render:()=>e`
  ...
  `,name:"Position left"},a={render:()=>e`
    ...
    <ic-classification-banner
      classification="official"
    ></ic-classification-banner>
  `,name:"Position center"},u={render:()=>e`
    <div id="topEl" style="margin-top:-20px;">
      <ic-typography variant="h2">Top of the page</ic-typography>
    </div>
    <div style="height:1200px;"></div>
    <ic-back-to-top target="topEl" variant="icon"></ic-back-to-top>
  `,name:"Icon Only"},n={render:()=>e`
    <div
      id="header"
    ...
    <ic-classification-banner
      classification="official"
    ></ic-classification-banner>
  `,name:"Page example"},r={render:s=>e`
    <div
      id="header"
      style="width:100%;height:100px;background-color:#23508e;color:var(--ic-architectural-white)"
    >
    ...
    <ic-classification-banner
      classification="official"
    ></ic-classification-banner>
  `,args:o,argTypes:{target:{table:{disable:!0}},theme:{options:["inherit","light","dark"],control:{type:l}},variant:{options:["default","icon"],control:{type:l}},position:{options:["left","center","right"],control:{type:l}}},name:"Playground"};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div id="topEl" style="margin-top:-20px;">
      <ic-typography variant="h2">Top of the page</ic-typography>
    </div>
  ...
  name: "Playground"
}`,...r.parameters?.docs?.source}}};const p=["Default","PositionLeft","PositionCenter","IconOnly","PageExample","Playground"],d=Object.freeze(Object.defineProperty({__proto__:null,Default:i,IconOnly:u,PageExample:n,Playground:r,PositionCenter:a,PositionLeft:t,__namedExportsOrder:p,default:c},Symbol.toStringTag,{value:"Module"}));export{d as I};
