var C=Object.freeze,q=Object.defineProperty;var a=(e,D)=>C(q(e,"raw",{value:C(D||e.slice())}));import{x as c}from"./lit-html-CWQq0DyO.js";const{useArgs:H}=__STORYBOOK_MODULE_PREVIEW_API__,$={additionalFieldDisplay:"dynamic",additionalFieldSlot:"additional-field",checked:!1,checkboxDisabled:!1,checkboxSize:"medium",disabled:!1,dynamicText:"Dynamic text",groupLabel:"Checkbox group label",helperText:"Helper text",hideLabel:!1,hideGroupLabel:!1,indeterminate:!1,label:"Checkbox label",name:"checkbox-group",nativeIndeterminateBehaviour:!1,required:!1,size:"medium",validationAriaLive:"polite",validationStatus:"no status",validationText:"",value:"checkbox-value",theme:"inherit"},z={title:"Web Components/Checkbox",component:"Checkbox"},i={render:()=>c`
  ...
  `,name:"Hidden checkbox label"};var T;const b={render:()=>c(T||(T=a([`
    <script>
  ...
  `,name:"Slotted group label"},x={render:()=>c`
    <ic-checkbox-group
  ...
  `,name:"Validation"};var E;const m={render:()=>c(E||(E=a([`<ic-checkbox-group
        id="field-1"
        label="This is a label"
        name="1"
      ...
      <\/script>`]))),name:"Aria-live behaviour"};var I;const v={render:()=>c(I||(I=a([`
    <form>
      <ic-checkbox-group label="This is a label" name="group1">
        <ic-checkbox
          name="checkbox1"
    ...
    <\/script>
  `]))),name:"Form"};var L;const p={render:()=>c(L||(L=a([`
    <script>
  ...
  `]))),name:"Indeterminate"};var U;const g={render:()=>c(U||(U=a([`
    <script>
  ...
  `]))),name:"Indeterminate with children"};var w;const f={render:()=>c(w||(w=a([`
    <script>
  ...
  `]))),name:"TextField value change"},y={render:()=>c`
 ...
 `,name:"Internationalisation"},n="inline-radio",N={render:e=>{const[{checked:D},F]=H();return c` <ic-checkbox-group
      disabled=${e.disabled}
      label=${e.groupLabel}
      size=${e.size}
 ...
 \`,
  ...
  name: "Playground"
}`,...N.parameters?.docs?.source}}};const A=["Default","Required","Disabled","Sizes","HiddenGroupLabel","HiddenCheckboxLabel","ConditionalDynamic","ConditionalStatic","SlottedLabel","HelperText","SlottedGroupLabel","Validation","AriaLiveBehaviour","Form","Indeterminate","IndeterminateWithChildren","TextFieldValueChange","RTL","Internationalisation","Playground"],B=Object.freeze(Object.defineProperty({__proto__:null,AriaLiveBehaviour:m,ConditionalDynamic:b,ConditionalStatic:s,Default:i,Disabled:t,Form:v,HelperText:h,HiddenCheckboxLabel:d,HiddenGroupLabel:r,Indeterminate:p,IndeterminateWithChildren:g,Internationalisation:S,Playground:N,RTL:y,Required:l,Sizes:o,SlottedGroupLabel:k,SlottedLabel:u,TextFieldValueChange:f,Validation:x,__namedExportsOrder:A,default:z},Symbol.toStringTag,{value:"Module"}));export{B as I};
