...
| `dismissLabel`    | `dismiss-label`     | The text in the dismiss button tooltip. Makes the user aware of the action resulting from clicking the 'Dismiss' button.                | `string \| undefined`                                              | `"Dismiss"` |
