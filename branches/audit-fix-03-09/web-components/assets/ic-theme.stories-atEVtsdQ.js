import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";var i=e({Playground:()=>u,SwitchBrand:()=>c,ThemeVisualisationPlayground:()=>d,__namedExportsOrder:()=>f,default:()=>s}),a,o,s,c,l,u,d,f,p=t((()=>{n(),a={brandColor:`rgba(27, 60, 121, 1)`,theme:`light`},o={theme:`light`,componentTheme:`light`},s={title:`Web Components/Theme`,component:`ic-theme`},c={render:()=>r` <ic-theme brand-color="rgba(27, 60, 121, 1)">
      <ic-button
        variant="primary"
        id="default-btn"
    ...
    </ic-theme>`,name:`Switch brand`},l=`inline-radio`,u={render:e=>r` <ic-theme brand-color=${e.brandColor} theme=${e.theme}>
      <div style="padding-top:10px">
        <ic-top-navigation
          app-title="ApplicationName"
          status="alpha"
    ...
    </ic-theme>`,name:`Playground`,args:a,parameters:{layout:`fullscreen`},argTypes:{theme:{options:[`system`,`light`,`dark`],control:{type:l}}}},d={render:e=>r`<div
      style="background-color: ${e.theme==`dark`?`black`:e.theme==`light`?`white`:null};width:450px;height:150px"
    >
      <ic-theme theme=${e.theme}>
        <div
          style="background-color: ${e.componentTheme==`dark`?`black`:e.componentTheme==`light`?`white`:null};width:250px"
        >
          <ic-typography theme=${e.componentTheme}>Theme test</ic-typography>
        </div>
      </ic-theme>
    </div>`,name:`Theme visualisation playground`,args:o,parameters:{layout:`fullscreen`},argTypes:{theme:{options:[`system`,`light`,`dark`],control:{type:l}},componentTheme:{options:[`inherit`,`light`,`dark`],control:{type:l}}}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source}}},f=[`SwitchBrand`,`Playground`,`ThemeVisualisationPlayground`]}));p();export{u as Playground,c as SwitchBrand,d as ThemeVisualisationPlayground,f as __namedExportsOrder,s as default,p as n,i as t};