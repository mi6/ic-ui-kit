import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./lit-html-CMAkC4Hj.js";var i=e({AllPropTextStyles:()=>g,Bold:()=>f,ComponentOverride:()=>l,Default:()=>s,Italic:()=>p,MinAndMaxContent:()=>_,Playground:()=>v,Strikethrough:()=>m,Truncation:()=>d,Underline:()=>h,Variants:()=>c,VerticalMargins:()=>u,__namedExportsOrder:()=>y,default:()=>o}),a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b=t((()=>{n(),a={applyVerticalMargins:!1,bold:!1,italic:!1,strikethrough:!1,underline:!1,variant:`body`,theme:`inherit`},o={title:`Web Components/Typography`,component:`ic-typography`},s={render:()=>r`<ic-typography>I am typography</ic-typography>`,name:`Default`},c={render:()=>r`
  ...
  `,name:`Component override`},u={render:()=>r`
    ...
    >
  `,name:`Vertical margins`},d={render:()=>r`
  ...
  `,name:`Underline`},g={render:()=>r`
    ...
    <ic-typography
      ...
      >Code extra small</ic-typography
    >
  `,name:`All prop text styles`},_={render:()=>r`
    ...
    >
  `,name:`Min and max content`},v={render:e=>r`<ic-typography
      apply-vertical-margins=${e.applyVerticalMargins}
      variant=${e.variant}
      bold=${e.bold}
      italic=${e.italic}
    ...
    >`,args:a,argTypes:{variant:{options:[`body`,`caption`,`h1`,`h2`,`h3`,`h4`,`label`,`subtitle-large`,`subtitle-small`,`label-uppercase`,`caption-uppercase`,`code-large`,`code-small`,`code-extra-small`],control:{type:`select`}},theme:{options:[`inherit`,`light`,`dark`],control:{type:`inline-radio`}}},name:`Playground`},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...v.parameters?.docs?.source}}},y=[`Default`,`Variants`,`ComponentOverride`,`VerticalMargins`,`Truncation`,`Bold`,`Italic`,`Strikethrough`,`Underline`,`AllPropTextStyles`,`MinAndMaxContent`,`Playground`]}));b();export{g as AllPropTextStyles,f as Bold,l as ComponentOverride,s as Default,p as Italic,_ as MinAndMaxContent,v as Playground,m as Strikethrough,d as Truncation,h as Underline,c as Variants,u as VerticalMargins,y as __namedExportsOrder,o as default,b as n,i as t};