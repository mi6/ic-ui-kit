import{r as D,R as e,I,a as L,b as B}from"./iframe-Cq5p9vYd.js";import{r as z}from"./readme-svjI2Lnt.js";import{I as a}from"./components-uE6bXDv7.js";const q={title:"React Components/Time Input",component:a,parameters:{componentAPI:{data:z}}},o={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?"}),name:"Default"},i={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",onIcTimeChange:t=>console.log("icTimeChange",t.detail.value)}),name:"icTimeChange event"},n={render:()=>e.createElement(a,{id:"time-input-default-time-with-value",label:"What time would you like to collect your coffee?",value:"13:45:00"}),name:"With value"},l={render:()=>e.createElement(a,{id:"time-input-default-time-date",label:"What time would you like to collect your coffee?",value:new Date("2025-07-14T15:30:45")}),name:"Date object"},C={render:()=>e.createElement(a,{id:"time-input-default-zulu-time",label:"What time would you like to collect your coffee?",value:"15:30:45Z"}),name:"Zulu time"},s={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",hideLabel:!0}),name:"Hide label"},c={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",required:"true"}),name:"Required"},m={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",disabled:!0})},u={render:()=>e.createElement(e.Fragment,null,e.createElement(a,{label:"What time would you like to collect your coffee?",size:"small"}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?"}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?",size:"large"})),name:"Sizes"},d={render:()=>e.createElement(e.Fragment,null,e.createElement(a,{label:"What time would you like to collect your coffee?",helperText:"We will have your order ready for you at this time"}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?"},e.createElement(L,{variant:"caption",slot:"helper-text"},e.createElement("span",null,"For special requests,",e.createElement(B,{href:"#"},"contact us")," before choosing a time")))),name:"Custom helper text"},k={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",helperText:"You cannot see me, but you can hear me",hideHelperText:!0}),name:"Hide helper text"},p={render:()=>e.createElement(e.Fragment,null,e.createElement(a,{label:"What time would you like to collect your coffee?",validationStatus:"error",validationText:"There is a coffee shortage forecast for that time. Please choose a different time."}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?",validationStatus:"warning",validationText:"Please be aware that there may be a coffee shortage at that time."}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?",validationStatus:"success",validationText:"Your coffee will be available for you to collect at this time."})),name:"Custom validation"},M={render:()=>{const[t,A]=D.useState(!1),[r,E]=D.useState(!1);return e.createElement(e.Fragment,null,e.createElement(a,{label:"What time would you like to collect your coffee?",helperText:"Error already set on page load and aria-live overridden as 'assertive'",validationStatus:t?"":"error",validationText:t?"":"First error message",validationAriaLive:"assertive"}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?",helperText:"Error set after page load and aria-live overridden as 'assertive'",validationStatus:t?"error":"",validationText:t?"Second error message":"",validationAriaLive:"assertive"}),e.createElement("br",null),e.createElement(I,{onClick:()=>A(!t)},"Toggle errors"),e.createElement("br",null),e.createElement("br",null),e.createElement("br",null),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?",helperText:"Default aria-live behaviour (i.e. 'polite')",validationStatus:r?"error":"",validationText:r?"Third error message":""}),e.createElement("br",null),e.createElement(a,{label:"What time would you like to collect your coffee?",helperText:"Default aria-live behaviour (i.e. 'polite')",validationStatus:r?"error":"",validationText:r?"Fourth error message":""}),e.createElement("br",null),e.createElement(I,{onClick:()=>E(!r)},"Toggle errors"))},name:"Aria-live behaviour"},h={render:()=>e.createElement(a,{emitTimePartChange:!0,label:"What time would you like to collect your coffee?",onIcTimeChange:t=>console.log("icTimeChange with time parts",t.detail)}),name:"IcTimeChange with emitTimePartChange"},f={render:()=>e.createElement(a,{label:"12-hour time",timePeriod:"12"}),name:"Time period"},W={render:()=>e.createElement(a,{label:"12-hour time",timePeriod:"12",showAmPmToggle:!0}),name:"Time period - with AM/PM toggle"},x={render:()=>e.createElement(a,{emitTimePartChange:!0,label:"What time would you like to collect your coffee?",timePeriod:"12",showAmPmToggle:!0,onIcTimeChange:t=>console.log("icTimeChange with time parts",t.detail)}),name:"IcTimeChange with emitTimePartChange - 12 hour"},H={render:()=>e.createElement(a,{emitTimePartChange:!0,label:"What time would you like to collect your coffee?",timePeriod:"12",showAmPmToggle:!0,timeFormat:"HH:MM:SS.SSS",onIcTimeChange:t=>console.log("icTimeChange with time parts",t.detail)}),name:"IcTimeChange with emitTimePartChange - 12 hour milliseconds"},T={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",timeFormat:"HH:MM"}),name:"Time format HH:MM"},g={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee?",timeFormat:"HH:MM:SS.SSS"}),name:"Time format HH:MM:SS.SSS"},P={render:()=>e.createElement(a,{emitTimePartChange:!0,label:"What time would you like to collect your coffee?",timeFormat:"HH:MM:SS.SSS",onIcTimeChange:t=>console.log("icTimeChange with time parts",t.detail)}),name:"IcTimeChange with emitTimePartChange - Milliseconds"},y={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee? We are closed before 08:00.",min:"08:00:00"}),name:"Min time"},b={render:()=>e.createElement(a,{label:"What time would you like to collect your coffee? We are closed after 16:00.",max:"16:00:00"}),name:"Max time"},v={render:()=>e.createElement(a,{id:"time-input-default-disable-time",label:"What time would you like to collect your coffee? We are closed between 08:00 and 10:00.",disableTimes:[{start:"08:00",end:"10:00"}]}),name:"Disable times"},S={render:()=>{const[t,A]=D.useState("08:30:00"),r=()=>{A("08:30:00")},E=F=>{A(F)};return e.createElement(e.Fragment,null,e.createElement(a,{label:"When would you like to collect your coffee?",value:t}),e.createElement("br",null),e.createElement("div",{style:{display:"flex",gap:"8px"}},e.createElement(I,{onClick:()=>r()},"Update time"),e.createElement(I,{onClick:()=>E(null)},"Set null"),e.createElement(I,{onClick:()=>E("")},"Set Empty String"),e.createElement(I,{onClick:()=>E(void 0)},"Set undefined")))},name:"With clearing value"},V={disabled:!1,disableTimes:[{start:"08:00",end:"10:00"}],helperText:"Please enter a time in HH:MM:SS format.",hideLabel:!1,hideHelperText:!1,invalidTimeMessage:"Please enter a different time.",label:"What time would you like to collect your coffee?",max:"",min:"",required:!1,showClearButton:!0,showAmPmToggle:!1,size:"medium",theme:"inherit",timeFormat:"HH:MM:SS",timePeriod:"24",value:"",validationAriaLive:"polite",validationStatus:"no status",validationText:""},w={render:t=>e.createElement(a,{disabled:t.disabled,disableTimes:t.disableTimes,helperText:t.helperText,hideLabel:t.hideLabel,hideHelperText:t.hideHelperText,invalidTimeMessage:t.invalidTimeMessage,label:t.label,max:t.max,min:t.min,required:t.required,showAmPmToggle:t.showAmPmToggle,showClearButton:t.showClearButton,size:t.size,theme:t.theme,timeFormat:t.timeFormat,timePeriod:t.timePeriod,validationAriaLive:t.validationAriaLive,validationStatus:t.validationStatus==="no status"?"":t.validationStatus,validationText:t.validationText,value:t.value}),args:V,argTypes:{validationAriaLive:{options:["polite","assertive","off"],control:{type:"inline-radio"}},validationStatus:{options:["no status","error","success","warning"],control:{type:"inline-radio"}},size:{options:["small","medium","large"],control:{type:"inline-radio"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}},timeFormat:{options:["HH:MM:SS","HH:MM","HH:MM:SS.SSS"],control:{type:"inline-radio"}},timePeriod:{options:["24","12"],control:{type:"inline-radio"}}},name:"Playground"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
- [Zulu time](#zulu-time)`,...l.parameters?.docs?.description}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source},description:{story:"Use the helper text to add additional detail for the time input. Display custom content using the `helper-text` slot.",...d.parameters?.docs?.description}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  ...
  name: "Time period"
}`,...f.parameters?.docs?.source},description:{story:"Demonstrates the `timePeriod` prop for 12-hour selection.",...f.parameters?.docs?.description}}};W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
...
}`,...T.parameters?.docs?.source},description:{story:"Demonstrates the time format HH:MM.",...T.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
...
}`,...g.parameters?.docs?.source},description:{story:"Demonstrates the time format HH:MM:SS.SSS.",...g.parameters?.docs?.description}}};P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  ...
  name: "Min time"
}`,...y.parameters?.docs?.source},description:{story:"Setting min time allows you to restrict the earliest time that can be selected.\nThe value can be in any format supported as `timeFormat`, in ISO 8601 time string format (`HH:MM:SS`) or as a JavaScript `Date` object.",...y.parameters?.docs?.description}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: () => <IcTimeInput label="What time would you like to collect your coffee? We are closed after 16:00." max="16:00:00" />,
  name: "Max time"
}`,...b.parameters?.docs?.source},description:{story:"Setting max time allows you to restrict the latest time that can be selected.\nThe value can be in any format supported as `timeFormat`, in ISO 8601 time string format (`HH:MM:SS`) or as a JavaScript `Date` object.",...b.parameters?.docs?.description}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...w.parameters?.docs?.source},description:{story:'Go to the <ic-link href="/?path=/story/react-components-time-input--playground">separate page for the playground example</ic-link> to view the prop controls.',...w.parameters?.docs?.description}}};const j=["Default","IcTimeChangeEvent","WithValue","DateObject","ZuluTime","HideLabel","Required","Disabled","Sizes","CustomHelperText","HideHelperText","Validation","AriaLiveBehaviour","IcTimeChangeEmitTimePartChanges","TimePeriod","TimePeriodAMPMToggle","IcTimeChangeEmitTimePartChanges12Hour","IcTimeChangeEmitTimePartChanges12HourMilliseconds","HHMM","Milliseconds","IcTimeChangeEmitTimePartChangesMilliseconds","MinTime","MaxTime","DisableTimes","WithClearingValue","Playground"],Z=Object.freeze(Object.defineProperty({__proto__:null,AriaLiveBehaviour:M,CustomHelperText:d,DateObject:l,Default:o,DisableTimes:v,Disabled:m,HHMM:T,HideHelperText:k,HideLabel:s,IcTimeChangeEmitTimePartChanges:h,IcTimeChangeEmitTimePartChanges12Hour:x,IcTimeChangeEmitTimePartChanges12HourMilliseconds:H,IcTimeChangeEmitTimePartChangesMilliseconds:P,IcTimeChangeEvent:i,MaxTime:b,Milliseconds:g,MinTime:y,Playground:w,Required:c,Sizes:u,TimePeriod:f,TimePeriodAMPMToggle:W,Validation:p,WithClearingValue:S,WithValue:n,ZuluTime:C,__namedExportsOrder:j,default:q},Symbol.toStringTag,{value:"Module"}));export{Z as I};
