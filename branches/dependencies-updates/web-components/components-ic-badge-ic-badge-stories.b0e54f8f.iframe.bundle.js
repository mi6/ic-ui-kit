/*! For license information please see components-ic-badge-ic-badge-stories.b0e54f8f.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[5509,3707,6895,6591],{"./src/components/ic-badge/ic-badge.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AccessibleLabel:()=>AccessibleLabel,Custom:()=>Custom,Error:()=>Error,HideBadge:()=>HideBadge,Info:()=>Info,Light:()=>Light,MaxNumber:()=>MaxNumber,Neutral:()=>Neutral,Playground:()=>Playground,PositionInline:()=>PositionInline,PositionNear:()=>PositionNear,Success:()=>Success,Warning:()=>Warning,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Badge",component:"ic-badge"},Success={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="padding:16px;">
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Info"},Custom={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            text-label="1"
            slot="badge"
