/*! For license information please see components-ic-side-navigation-ic-side-navigation-stories.5d7751d6.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[9807,582,6199,6763],{"./src/components/ic-side-navigation/ic-side-navigation.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{CloseOnNavItemClick:()=>CloseOnNavItemClick,CollapsedIconsWithLabels:()=>CollapsedIconsWithLabels,Default:()=>Default,DisableAutoParentStyling:()=>DisableAutoParentStyling,DisableTopBarBehaviour:()=>DisableTopBarBehaviour,Expanded:()=>Expanded,LongContent:()=>LongContent,Playground:()=>Playground,ShortTitle:()=>ShortTitle,SideNavExpandedEvent:()=>SideNavExpandedEvent,Slots:()=>Slots,SlotsUsingAppTitle:()=>SlotsUsingAppTitle,SlotsUsingAppTitleExpanded:()=>SlotsUsingAppTitleExpanded,Static:()=>Static,UsingUnnamedSlots:()=>UsingUnnamedSlots,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Side navigation",component:"ic-side-navigation"},Default={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `,name:"Expanded",parameters:{layout:"fullscreen"}},LongContent={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="display:flex; height:100%;">
      <ic-side-navigation
  ...
  `,name:"Long content",parameters:{layout:"fullscreen"}},ShortTitle={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="display:flex; height:100%;">
      <ic-side-navigation
        app-title="Application Name"
  ...
  `,name:"Disable auto parent styling",parameters:{layout:"fullscreen"}},SideNavExpandedEvent={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<script>
      ...
      </div> `,name:"Side nav expanded event",parameters:{layout:"fullscreen"}},CloseOnNavItemClick={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="display:flex; height:100%;">
      <ic-side-navigation
        app-title="Application Name"
        version="v0.0.0"
  ...
  `,name:"Close on nav item click",parameters:{layout:"fullscreen"}},Playground={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
      <ic-side-navigation
