"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[2828],{"./src/components/ic-card/ic-card.stories.mdx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:()=>__namedExportsOrder,additionalHeight:()=>additionalHeight,adornment:()=>adornment,clickableButton:()=>clickableButton,clickableLink:()=>clickableLink,default:()=>ic_card_stories,defaultArgs:()=>defaultArgs,disabled:()=>disabled,expandable:()=>expandable,fullWidth:()=>fullWidth,heading:()=>heading,icon:()=>icon,interactionControls:()=>interactionControls,message:()=>message,middleImage:()=>middleImage,playground:()=>playground,reducedWidth:()=>reducedWidth,slottedHeadingMessageAndSubheading:()=>slottedHeadingMessageAndSubheading,topImage:()=>topImage,withBadge:()=>withBadge,withInteractionButton:()=>withInteractionButton,withSubheading:()=>withSubheading,wrappedByLink:()=>wrappedByLink});__webpack_require__("./node_modules/react/index.js");var lib=__webpack_require__("./node_modules/@storybook/addon-docs/node_modules/@mdx-js/react/lib/index.js"),dist=__webpack_require__("./node_modules/@storybook/addon-docs/dist/index.mjs"),lit_html=__webpack_require__("./node_modules/lit-html/lit-html.js");const readme_namespaceObject='# ic-card\n\n\n\n\x3c!-- Auto Generated Below --\x3e\n\n\n## Properties\n\n| Property         | Attribute        | Description                                                                                                                                 | Type                                                                                                                                                                                     | Default     |\n| ---------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |\n| `clickable`      | `clickable`      | If `true`, the card will be a clickable variant, instead of static.                                                                         | `boolean`                                                                                                                                                                                | `false`     |\n| `disabled`       | `disabled`       | If `true`, the card will be disabled if it is clickable.                                                                                    | `boolean`                                                                                                                                                                                | `false`     |\n| `expandable`     | `expandable`     | If `true`, the card will have an expandable area and expansion toggle button.                                                               | `boolean`                                                                                                                                                                                | `false`     |\n| `fullWidth`      | `full-width`     | If `true`, the card will fill the width of the container.                                                                                   | `boolean`                                                                                                                                                                                | `false`     |\n| `heading`        | `heading`        | The heading for the card. This is required, unless a slotted heading is used.                                                               | `string`                                                                                                                                                                                 | `undefined` |\n| `href`           | `href`           | The URL that the clickable card link points to. If set, the clickable card will render as an "a" tag, otherwise it will render as a button. | `string`                                                                                                                                                                                 | `undefined` |\n| `hreflang`       | `hreflang`       | The human language of the linked URL.                                                                                                       | `string`                                                                                                                                                                                 | `""`        |\n| `message`        | `message`        | The main body message of the card.                                                                                                          | `string`                                                                                                                                                                                 | `""`        |\n| `referrerpolicy` | `referrerpolicy` | How much of the referrer to send when following the link.                                                                                   | `"" \\| "no-referrer" \\| "no-referrer-when-downgrade" \\| "origin" \\| "origin-when-cross-origin" \\| "same-origin" \\| "strict-origin" \\| "strict-origin-when-cross-origin" \\| "unsafe-url"` | `undefined` |\n| `rel`            | `rel`            | The relationship of the linked URL as space-separated link types.                                                                           | `string`                                                                                                                                                                                 | `undefined` |\n| `subheading`     | `subheading`     | The subheading for the card.                                                                                                                | `string`                                                                                                                                                                                 | `undefined` |\n| `target`         | `target`         | The place to display the linked URL, as the name for a browsing context (a tab, window, or iframe).                                         | `string`                                                                                                                                                                                 | `undefined` |\n\n\n## Methods\n\n### `setFocus() => Promise<void>`\n\nSets focus on the card.\n\n#### Returns\n\nType: `Promise<void>`\n\n\n\n\n## Slots\n\n| Slot                     | Description                                                                               |\n| ------------------------ | ----------------------------------------------------------------------------------------- |\n| `"adornment"`            | Content will be placed below the card subheading.                                         |\n| `"badge"`                | Badge component overlaying the top right of the card.                                     |\n| `"expanded-content"`     | Content will be placed below the interaction controls but will not initially be rendered. |\n| `"heading"`              | Content will be placed at the top of the card to the right of the icon.                   |\n| `"icon"`                 | Content will be placed to the left of the card heading.                                   |\n| `"image-mid"`            | Content will be placed below the card heading section.                                    |\n| `"image-top"`            | Content will be placed at the top of the card above all other content.                    |\n| `"interaction-button"`   | Content will be placed in the top right corner of the heading section.                    |\n| `"interaction-controls"` | Content will be placed below the card message.                                            |\n| `"message"`              | Content will be placed in the main body of the card.                                      |\n| `"subheading"`           | Content will be placed below the card heading.                                            |\n\n\n## Dependencies\n\n### Depends on\n\n- [ic-typography](../ic-typography)\n- [ic-tooltip](../ic-tooltip)\n\n### Graph\n```mermaid\ngraph TD;\n  ic-card --\x3e ic-typography\n  ic-card --\x3e ic-tooltip\n  ic-tooltip --\x3e ic-typography\n  style ic-card fill:#f9f,stroke:#333,stroke-width:4px\n```\n\n----------------------------------------------\n\n\n';__webpack_require__("./src/components/ic-status-tag/readme.md"),__webpack_require__("./src/components/ic-typography/readme.md"),__webpack_require__("./src/components/ic-button/readme.md");var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const defaultArgs={clickable:!1,disabled:!1,expandable:!1,fullWidth:!1,heading:"Heading",href:"/",message:"Message",subheading:"Subheading",iconSlot:!0,badgeSlot:!0,imageTopSlot:!0,imageMidSlot:!0,interactionButtonSlot:!0,interactionControlsSlot:!0,adornmentSlot:!0,expandedContentSlot:!0};function _createMdxContent(props){const _components=Object.assign({h3:"h3"},(0,lib.ah)(),props.components);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(dist.h_,{title:"Web Components/Card",component:"ic-card"}),"\n",(0,jsx_runtime.jsx)(dist.dk,{markdown:readme_namespaceObject}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"heading",children:"Heading"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Heading",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card heading="This is the card heading"></ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"icon",children:"Icon"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Icon",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card heading="This is the card heading">
    ...
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"message",children:"Message"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Message",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
    ...
    >
    ...
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-subheading",children:"With subheading"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"With subheading",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      message="This is an example of a new card component with text included."
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"slotted-heading-message-and-subheading",children:"Slotted heading, message, and subheading"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Slotted heading, message, and subheading",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card>
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-badge",children:"With badge"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"With badge",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
        heading="This is the card heading"
        clickable="true"
      ...
      </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"with-interaction-button",children:"With interaction button"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"With interaction button",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
    >
    ...
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"adornment",children:"Adornment"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Adornment",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
    >
    ...
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"top-image",children:"Top image"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Top image",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      style="width:360px;"
    ...
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"middle-image",children:"Middle image"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Middle image",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      style="width:360px;"
    ...
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"interaction-controls",children:"Interaction controls"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Interaction controls",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      style="width:360px;"
    >
      ...
      <ic-button slot="interaction-controls" variant="secondary"
        >Hide</ic-button
      >
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"reduced-width",children:"Reduced width"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Reduced width",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
    ...
    >
      ...
      <ic-button slot="interaction-controls" variant="secondary"
        >Hide</ic-button
      >
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"additional-height",children:"Additional height"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Additional height",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
    ...
    >
      ...
      <ic-button slot="interaction-controls" variant="secondary"
        >Hide</ic-button
      >
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"expandable",children:"Expandable"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Expandable",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      expandable
    ...
    >
      ...
      <ic-typography slot="expanded-content" variant="body"
        ...
        included.</ic-typography
      >
    </ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"clickable-link",children:"Clickable link"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Clickable link",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      clickable="true"
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"clickable-button",children:"Clickable button"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Clickable button",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      clickable="true"
      ...
      >
        ...
        <path
          d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
        /></svg
    ></ic-card>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"disabled",children:"Disabled"}),"\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{name:"Disabled",parameters:{loki:{skip:!0}},children:lit_html.dy`<ic-card
      heading="This is the card heading"
      subheading="This is the subheading"
      message="This is an example of a new card component with text included."
      clickable="true"
      ...
      ><ic-card
        ...
        >
          ...
          <path
            d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
          /></svg></ic-card
    ></a>`})}),"\n",(0,jsx_runtime.jsx)(_components.h3,{id:"playground",children:"Playground"}),"\n","\n",(0,jsx_runtime.jsx)(dist.Xz,{children:(0,jsx_runtime.jsx)(dist.oG,{args:defaultArgs,parameters:{loki:{skip:!0}},argTypes:{iconSlot:{mapping:{true:"icon",false:""}},badgeSlot:{mapping:{true:"badge",false:""}},imageTopSlot:{mapping:{true:"image-top",false:""}},imageMidSlot:{mapping:{true:"image-mid",false:""}},interactionButtonSlot:{mapping:{true:"interaction-button",false:""}},interactionControlsSlot:{mapping:{true:"interaction-controls",false:""}},adornmentSlot:{mapping:{true:"adornment",false:""}},expandedContentSlot:{mapping:{true:"expanded-content",false:""}}},name:"Playground",children:args=>lit_html.dy`<ic-card
      ...
      >
        ...
        <ic-badge label="1" slot=${args.badgeSlot}></ic-badge>
        <ic-button
          variant="icon"
          title="More information"
        ...
        <ic-typography slot=${args.expandedContentSlot} variant="body"
          ...
          included.</ic-typography
        >
      </ic-card>`})})]})}const heading=()=>lit_html.dy`<ic-card heading="This is the card heading"></ic-card>`;heading.storyName="Heading",heading.parameters={storySource:{source:'html`<ic-card heading="This is the card heading"></ic-card>`'},loki:{skip:!0}};const icon=()=>lit_html.dy`<ic-card heading="This is the card heading">
      <svg
        slot="icon"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
