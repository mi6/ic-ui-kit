import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";var i=e({CentreAligned:()=>p,MaxLines:()=>h,Playground:()=>v,RightAligned:()=>m,SlottedContent:()=>g,WithActions:()=>c,WithIcon:()=>f,WithImage:()=>l,WithLargeImage:()=>d,WithSmallImage:()=>u,WithSubheadingAndBodyText:()=>s,WithinDiv:()=>_,__namedExportsOrder:()=>y,default:()=>o}),a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b=t((()=>{n(),a={aligned:`left`,body:`This is the body text for the empty state.`,maxLines:3,heading:`This is the heading`,imageSize:`default`,subheading:`This is the subheading`,showImage:!1,showActions:!1,theme:`inherit`},o={title:`Web Components/Empty state`,component:`ic-empty-state`},s={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    ></ic-empty-state>`,name:`With subheading and body text`},c={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    >
    ...
    >`,name:`With actions`},l={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    >
    ...
    ></ic-empty-state>`,name:`With image`},u={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
    ...
    >
      ...
      >
        ...
        <polygon fill="#aa00aa" points="1210 900 971 687 725 900" />
        <polygon fill="#880088" points="943 900 1210 900 971 687" /></svg
    ></ic-empty-state>`,name:`With small image`},d={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for empty state."
      image-size="large"
    >
      ...
      >
        ...
        <polygon fill="#aa00aa" points="1210 900 971 687 725 900" />
        <polygon fill="#880088" points="943 900 1210 900 971 687" /></svg
    ></ic-empty-state>`,name:`With large image`},f={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    >
    ...
    </ic-empty-state>`,name:`With icon`},p={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for empty state."
      aligned="center"
    >
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:`Centre aligned`},m={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for empty state."
      aligned="right"
    >
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:`Right aligned`},h={render:()=>r`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
...
Dripper caramelization java saucer grounds galão, mocha, and robusta kopi-luwak, percolator, instant, qui saucer latte in brewed café au lait. Con panna, cup, cream, body americano affogato cup espresso, rich milk seasonal saucer grinder spoon that cultivar strong redeye frappuccino barista extraction redeye mazagran. Grounds, french press dripper organic and foam id saucer, crema, black rich dark, grounds breve coffee steamed caramelization percolator."
    ...
    >
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:`Max lines`},g={render:()=>r`<ic-empty-state>
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:`Slotted content`},_={render:()=>r`<div style="width:357px;border:1px solid black;background:#D3D3D3;">
      <ic-empty-state
        heading="Empty state title"
        subheading="Empty state subtitle"
        body="Body text for empty state."
      >
        ...
        ></ic-empty-state
      >
    </div>`},v={render:e=>r`<ic-empty-state
      heading=${e.heading}
    ...
    >
      ...
      `}
    </ic-empty-state>`,args:a,argTypes:{aligned:{options:[`left`,`center`,`right`],control:{type:`radio`}},imageSize:{options:[`medium`,`small`,`large`],control:{type:`radio`}},theme:{options:[`inherit`,`light`,`dark`],control:{type:`inline-radio`}}},name:`Playground`},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
Dripper caramelization java saucer grounds galão, mocha, and robusta kopi-luwak, percolator, instant, qui saucer latte in brewed café au lait. Con panna, cup, cream, body americano affogato cup espresso, rich milk seasonal saucer grinder spoon that cultivar strong redeye frappuccino barista extraction redeye mazagran. Grounds, french press dripper organic and foam id saucer, crema, black rich dark, grounds breve coffee steamed caramelization percolator."
  ...
  name: "Playground"
}`,...v.parameters?.docs?.source}}},y=[`WithSubheadingAndBodyText`,`WithActions`,`WithImage`,`WithSmallImage`,`WithLargeImage`,`WithIcon`,`CentreAligned`,`RightAligned`,`MaxLines`,`SlottedContent`,`WithinDiv`,`Playground`]}));b();export{p as CentreAligned,h as MaxLines,v as Playground,m as RightAligned,g as SlottedContent,c as WithActions,f as WithIcon,l as WithImage,d as WithLargeImage,u as WithSmallImage,s as WithSubheadingAndBodyText,_ as WithinDiv,y as __namedExportsOrder,o as default,b as n,i as t};