import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";import{n as i,t as a}from"./taggedTemplateLiteral-pWa2IaV6.js";var o=e({CustomTopPosition:()=>d,Default:()=>l,FullWidth:()=>u,HideBackground:()=>p,Inline:()=>f,Playground:()=>h,__namedExportsOrder:()=>g,default:()=>c}),s,c,l,u,d,f,p,m,h,g,_=t((()=>{n(),i(),c={title:`Web Components/Skip link`,component:`ic-skip-link`},l={render:()=>r`<ic-skip-link target="page-content"></ic-skip-link>
      ...
      <ic-button>Should receive next focus</ic-button>`,name:`Default`},u={render:()=>r`<ic-skip-link target="page-content" full-width="true"></ic-skip-link>
      <ic-top-navigation app-title="Application Name">
        <svg
          slot="app-icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <main id="page-content">Target element</main>
      <ic-button>Should receive next focus</ic-button>`,name:`Full width`},d={render:()=>r(s||=a([`<div style="display: flex; flex-direction: column; min-height: 100vh;">
        <div
          id="cookie-banner"
      ...
      <\/script>`])),name:`Custom top position`,parameters:{layout:`fullscreen`}},f={render:()=>r`<ic-skip-link target="page-content"></ic-skip-link>
      <div>
        ...
        <ic-footer
          ...
          caption="All content is available under the Open Government Licence v3.0, except source code and code examples which are available under the MIT Licence."
        ></ic-footer>
      </div>`,name:`Inline`,parameters:{layout:`fullscreen`}},p={render:()=>r`<ic-skip-link
        target="page-content"
      ...
      <main id="page-content">Target element</main>
      <ic-button>Should receive next focus</ic-button>`,name:`Hide background`},m={fullWidth:!1,inline:!1,label:`Skip to main content`,monochrome:!1,target:``,theme:`inherit`,transparentBackground:!1},h={render:e=>r`<ic-skip-link
      ...
      <main id=${e.target}>Target element</main>
      <ic-button>Should receive next focus</ic-button>`,args:m,argTypes:{theme:{options:[`inherit`,`light`,`dark`],control:{type:`inline-radio`}}},name:`Playground`},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...h.parameters?.docs?.source}}},g=[`Default`,`FullWidth`,`CustomTopPosition`,`Inline`,`HideBackground`,`Playground`]}));_();export{d as CustomTopPosition,l as Default,u as FullWidth,p as HideBackground,f as Inline,h as Playground,g as __namedExportsOrder,c as default,_ as n,o as t};