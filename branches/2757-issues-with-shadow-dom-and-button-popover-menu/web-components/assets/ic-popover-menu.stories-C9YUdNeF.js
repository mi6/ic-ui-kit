var d=Object.freeze,k=Object.defineProperty;var n=(e,y)=>d(k(e,"raw",{value:d(y||e.slice())}));import{b as i}from"./lit-html-B6sBSybp.js";const x={open:!0,groupLabel:"View",description:"",disabled:!1,href:"/",keyboardShortcutLabel:"Cmd + C",label:"Copy code",variant:"default",iconSlot:!0,theme:"inherit"},P={title:"Web Components/Popover menu",component:"Popover Menu"};var s;const o={render:()=>i(s||(s=n([`
  ...
  `]))),name:"Default"};var b;const t={render:()=>i(b||(b=n([`
    <style>
      ic-popover-menu {
        --max-height: 100px;
      }
  ...
  `]))),name:"Max height"};var v;const c={render:()=>i(v||(v=n([`
  ...
  `]))),name:"Left placement"};var h;const m={render:()=>i(h||(h=n([`
  ...
  `]))),name:"Top placement"};var g;const u={render:()=>i(g||(g=n([` <ic-link href="/">Link1</ic-link>
      ...
      </div>`]))),name:"Multiple popovers on page"};var w;const r={render:()=>i(w||(w=n([`
    <ic-button id="button-1" onclick="buttonClick()"
      >Show/Hide popover</ic-button
    >
    <script>
  ...
  `]))),name:"Auto opening"};var f;const l={render:()=>i(f||(f=n([`
    <script>
  ...
  `]))),name:"Positioning strategy"};var C;const a={render:()=>i(C||(C=n([`
    <script>
      var icPopover = document.querySelector("ic-popover-menu");
      function buttonClick() {
        icPopover.open = !icPopover.open;
  ...
  `]))),name:"Slotted Anchor"},p={render:e=>i`<div>
      <ic-popover-menu
        aria-label="popover"
        open=${e.open}
        theme=${e.theme}
    ...
    </div>`,args:x,argTypes:{variant:{options:["default","toggle","destructive"],control:{type:"radio"}},iconSlot:{mapping:{true:"icon",false:""}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <ic-button id="button-1" onclick="buttonClick()"
      >Show/Hide popover</ic-button
    >
  ...
  name: "Playground"
}`,...p.parameters?.docs?.source}}};const S=["Default","MaxHeight","LeftPlacement","TopPlacement","MultiplePopoversOnPage","AutoOpening","PositioningStrategy","SlottedAnchor","Playground"],L=Object.freeze(Object.defineProperty({__proto__:null,AutoOpening:r,Default:o,LeftPlacement:c,MaxHeight:t,MultiplePopoversOnPage:u,Playground:p,PositioningStrategy:l,SlottedAnchor:a,TopPlacement:m,__namedExportsOrder:S,default:P},Symbol.toStringTag,{value:"Module"}));export{L as I};
