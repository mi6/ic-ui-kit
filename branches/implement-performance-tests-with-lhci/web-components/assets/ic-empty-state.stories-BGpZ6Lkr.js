import{b as t}from"./lit-html-B6sBSybp.js";const d={aligned:"left",body:"This is the body text for the empty state.",maxLines:3,heading:"This is the heading",imageSize:"default",subheading:"This is the subheading",showImage:!1,showActions:!1,theme:"inherit"},h={title:"Web Components/Empty state",component:"ic-empty-state"},o={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    ></ic-empty-state>`,name:"With subheading and body text"},i={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    >
    ...
    >`,name:"With actions"},l={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    >
    ...
    ></ic-empty-state>`,name:"With image"},e={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
    ...
    >
      ...
      >
        ...
        <polygon fill="#aa00aa" points="1210 900 971 687 725 900" />
        <polygon fill="#880088" points="943 900 1210 900 971 687" /></svg
    ></ic-empty-state>`,name:"With small image"},s={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for empty state."
      image-size="large"
    >
      ...
      >
        ...
        <polygon fill="#aa00aa" points="1210 900 971 687 725 900" />
        <polygon fill="#880088" points="943 900 1210 900 971 687" /></svg
    ></ic-empty-state>`,name:"With large image"},a={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for the empty state."
    >
    ...
    </ic-empty-state>`,name:"With icon"},p={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for empty state."
      aligned="center"
    >
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:"Centre aligned"},g={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
      body="Body text for empty state."
      aligned="right"
    >
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:"Right aligned"},y={render:()=>t`<ic-empty-state
      heading="Empty state title"
      subheading="Empty state subtitle"
...
Dripper caramelization java saucer grounds galão, mocha, and robusta kopi-luwak, percolator, instant, qui saucer latte in brewed café au lait. Con panna, cup, cream, body americano affogato cup espresso, rich milk seasonal saucer grinder spoon that cultivar strong redeye frappuccino barista extraction redeye mazagran. Grounds, french press dripper organic and foam id saucer, crema, black rich dark, grounds breve coffee steamed caramelization percolator."
    ...
    >
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:"Max lines"},r={render:()=>t`<ic-empty-state>
      ...
      ><ic-button slot="actions">Action</ic-button>
      <ic-link href="/" slot="actions">Standalone link</ic-link></ic-empty-state
    >`,name:"Slotted content"},c={render:()=>t`<div style="width:357px;border:1px solid black;background:#D3D3D3;">
      <ic-empty-state
        heading="Empty state title"
        subheading="Empty state subtitle"
        body="Body text for empty state."
      >
        ...
        ></ic-empty-state
      >
    </div>`},f={render:n=>t`<ic-empty-state
      heading=${n.heading}
      subheading=${n.subheading}
      body=${n.body}
      image-size=${n.imageSize}
      max-lines=${n.maxLines}
      aligned=${n.aligned}
      theme=${n.theme}
    >
      ${n.showImage&&t`
      ...
      `}
    </ic-empty-state>`,args:d,argTypes:{aligned:{options:["left","center","right"],control:{type:"radio"}},imageSize:{options:["medium","small","large"],control:{type:"radio"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
Dripper caramelization java saucer grounds galão, mocha, and robusta kopi-luwak, percolator, instant, qui saucer latte in brewed café au lait. Con panna, cup, cream, body americano affogato cup espresso, rich milk seasonal saucer grinder spoon that cultivar strong redeye frappuccino barista extraction redeye mazagran. Grounds, french press dripper organic and foam id saucer, crema, black rich dark, grounds breve coffee steamed caramelization percolator."
  ...
  name: "Playground"
}`,...f.parameters?.docs?.source}}};const m=["WithSubheadingAndBodyText","WithActions","WithImage","WithSmallImage","WithLargeImage","WithIcon","CentreAligned","RightAligned","MaxLines","SlottedContent","WithinDiv","Playground"],u=Object.freeze(Object.defineProperty({__proto__:null,CentreAligned:p,MaxLines:y,Playground:f,RightAligned:g,SlottedContent:r,WithActions:i,WithIcon:a,WithImage:l,WithLargeImage:s,WithSmallImage:e,WithSubheadingAndBodyText:o,WithinDiv:c,__namedExportsOrder:m,default:h},Symbol.toStringTag,{value:"Module"}));export{u as I};
