import{x as t}from"./lit-html-CWQq0DyO.js";const s={applyVerticalMargins:!1,bold:!1,italic:!1,strikethrough:!1,underline:!1,variant:"body",theme:"inherit"},d={title:"Web Components/Typography",component:"ic-typography"},r={render:()=>t`<ic-typography>I am typography</ic-typography>`,name:"Default"},e={render:()=>t`
  ...
  `,name:"Component override"},p={render:()=>t`
    ...
    >
  `,name:"Vertical margins"},n={render:()=>t`
  ...
  `,name:"Underline"},g={render:()=>t`
    ...
    <ic-typography
      ...
      >Code extra small</ic-typography
    >
  `,name:"All prop text styles"},h={render:()=>t`
    ...
    >
  `,name:"Min and max content"},u={render:a=>t`<ic-typography
      apply-vertical-margins=${a.applyVerticalMargins}
      variant=${a.variant}
      bold=${a.bold}
      italic=${a.italic}
  ...
  name: "Playground"
}`,...u.parameters?.docs?.source}}};const m=["Default","Variants","ComponentOverride","VerticalMargins","Truncation","Bold","Italic","Strikethrough","Underline","AllPropTextStyles","MinAndMaxContent","Playground"],b=Object.freeze(Object.defineProperty({__proto__:null,AllPropTextStyles:g,Bold:o,ComponentOverride:i,Default:r,Italic:y,MinAndMaxContent:h,Playground:u,Strikethrough:l,Truncation:n,Underline:c,Variants:e,VerticalMargins:p,__namedExportsOrder:m,default:d},Symbol.toStringTag,{value:"Module"}));export{b as I};
