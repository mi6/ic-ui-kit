import{x as t}from"./lit-html-CWQq0DyO.js";const i={title:"Patterns/Single Column"},e={render:()=>t`<div>
      ...
      ></ic-footer>
    </div>`,name:"Single Column with Top Navigation and Footer",parameters:{layout:"fullscreen"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => html\`<div>
      <div style="display: flex; flex-direction: column; min-height: 100vh;">
        <ic-top-navigation
          app-title="Application Name"
...
}`,...e.parameters?.docs?.source}}};const n=["SingleColumnWithTopNavigationAndFooter"],o=Object.freeze(Object.defineProperty({__proto__:null,SingleColumnWithTopNavigationAndFooter:e,__namedExportsOrder:n,default:i},Symbol.toStringTag,{value:"Module"}));export{e as S,o as T};
