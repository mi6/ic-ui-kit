/*! For license information please see components-ic-button-ic-button-stories.75162331.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ukic_web_components=self.webpackChunk_ukic_web_components||[]).push([[3707],{"./src/components/ic-button/ic-button.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AriaDescribedby:()=>AriaDescribedby,Destructive:()=>Destructive,Dropdown:()=>Dropdown,DropdownExample:()=>DropdownExample,FileUpload:()=>FileUpload,FileUploadInAForm:()=>FileUploadInAForm,FullWidth:()=>FullWidth,Height:()=>Height,IconOnly:()=>IconOnly,IconVariants:()=>IconVariants,IconWithoutViewBox:()=>IconWithoutViewBox,Loading:()=>Loading,MinWidth:()=>MinWidth,Playground:()=>Playground,PlaygroundWithIcon:()=>PlaygroundWithIcon,Primary:()=>Primary,RouterLink:()=>RouterLink,Secondary:()=>Secondary,Size:()=>Size,Tertiary:()=>Tertiary,Tooltips:()=>Tooltips,WithIcon:()=>WithIcon,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit_html__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit-html/lit-html.js");const defaultArgs={message:"Custom Button",disabled:!1,loading:!1,appearance:"default",size:"default",variant:"secondary",fullWidth:!0,iconPlacement:"right-icon"},__WEBPACK_DEFAULT_EXPORT__={title:"Web Components/Button",component:"ic-button"},Primary={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `,name:"Primary"},RouterLink={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="padding: 8px">
      ...
      </div>`,name:"Router link",parameters:{layout:"fullscreen"}},Secondary={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="padding: 6px">
  ...
  `,name:"Secondary"},Tertiary={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="padding: 6px">
  ...
  `,name:"Tertiary"},Destructive={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`
    <ic-button variant="destructive">Button</ic-button>
    <ic-button variant="destructive" disabled>Button</ic-button>
  `,name:"Destructive"},WithIcon={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div>
      ...
      </ic-button>`,name:"Size"},IconWithoutViewBox={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-button variant="primary" size="small"
        >Small
        <svg
          slot="left-icon"
          xmlns="http://www.w3.org/2000/svg"
  ...
  `,name:"Height"},IconOnly={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-button
        variant="icon"
        size="small"
        aria-label="refresh"
        id="testbutton"
      ...
      >
        ...
        <ic-button
          ...
          >
            ...
            /></svg
        ></ic-button>
      </div> `,name:"Icon only"},IconVariants={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<div style="display:flex; gap: 1rem; flex-direction:column;">
      <div>
        <h1>Default</h1>
    ...
    </div>`,name:"Icon variants"},Tooltips={render:()=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-button
        variant="icon"
        aria-label="refresh"
    ...
    >`,args:defaultArgs,argTypes:{variant:{options:["primary","secondary","tertiary","destructive"],control:{type:"select"}},size:{options:["default","large","small"],control:{type:"inline-radio"}},appearance:{options:["default","dark","light"],control:{type:"inline-radio"}},fullWidth:{control:{type:"boolean"}}},name:"Playground"},PlaygroundWithIcon={render:args=>lit_html__WEBPACK_IMPORTED_MODULE_0__.qy`<ic-button
      disabled=${args.disabled}
      variant=${args.variant}
      size=${args.size}
      full-width=${args.fullWidth}
