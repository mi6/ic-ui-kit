var n=Object.freeze,s=Object.defineProperty;var a=(e,o)=>n(s(e,"raw",{value:n(o||e.slice())}));import{x as l}from"./lit-html-CWQq0DyO.js";const r={title:"Patterns/Component z-index"};var t;const i={render:()=>l(t||(t=a([`
    <style>
      ic-toast {
    ...
    <\/script>
  `]))),name:"Component z-index",parameters:{layout:"fullscreen"}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      ic-toast {
        --bottom-position: 50px;
...
}`,...i.parameters?.docs?.source}}};const u=["ComponentZIndex"],g=Object.freeze(Object.defineProperty({__proto__:null,ComponentZIndex:i,__namedExportsOrder:u,default:r},Symbol.toStringTag,{value:"Module"}));export{i as C,g as Z};
