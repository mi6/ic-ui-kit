var m=Object.freeze,x=Object.defineProperty;var h=(t,v)=>m(x(t,"raw",{value:m(v||t.slice())}));import{x as o}from"./lit-html-CWQq0DyO.js";const T={disableHover:!1,maxLines:3,placement:"bottom",label:"This is a description of the button",theme:"inherit",fixedPositioning:!1},w={title:"Web Components/Tooltip",component:"ic-tooltip"},i={render:()=>o`<ic-tooltip
      ...
      > `,name:"Default",height:"100px"};var g;const e={render:()=>o(g||(g=h([`<script>
        let display = true;
        document
    ...
    >`,name:"Disabled Hover",height:"100px"},a={render:()=>o` <div style="margin: 40px">
      ...
      >
    </div>`,name:"Top placements"},l={render:()=>o` <div style="margin: 40px">
      <ic-tooltip
      ...
      >
    </div>`,name:"Left placements"},c={render:()=>o`<ic-tooltip
    ...
    >`,name:"Truncation",height:"100px"},p={render:()=>o`<div style="height: 100px;background-color:#333333;">
      <ic-tooltip
        label="This is a description of the button"
    ...
    </div>`,name:"Dark background"};var f;const d={render:()=>o(f||(f=h([`<script>
      ...
      </div> `]))),name:"Changing label"};var y;const b={render:()=>o(y||(y=h([` <script>
      ...
      </div>`]))),name:"Positioning strategy"},u={render:t=>o`<div style="margin: 250px">
      <ic-tooltip
        label=${t.label}
    ...
    </div> `,args:T,argTypes:{placement:{options:["bottom","top-start","top","top-end","right-start","right","right-end","bottom-end","bottom-start","left-end","left","left-start"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...u.parameters?.docs?.source}}};const k=["Default","UsingExternalMethod","DisabledHover","TopPlacements","BottomPlacements","RightPlacements","LeftPlacements","Truncation","DarkBackground","ChangingLabel","PositioningStrategy","Playground"],L=Object.freeze(Object.defineProperty({__proto__:null,BottomPlacements:l,ChangingLabel:d,DarkBackground:p,Default:i,DisabledHover:n,LeftPlacements:r,Playground:u,PositioningStrategy:b,RightPlacements:s,TopPlacements:a,Truncation:c,UsingExternalMethod:e,__namedExportsOrder:k,default:w},Symbol.toStringTag,{value:"Module"}));export{L as I};
