var O=Object.freeze,ie=Object.defineProperty;var e=(l,ce)=>O(ie(l,"raw",{value:O(ce||l.slice())}));import{b as t}from"./lit-html-B6sBSybp.js";const oe={disabled:!1,"full-width":!1,"helper-text":"Select one option from the list","hide-label":!1,loading:!1,loadingLabel:"Loading...",label:"What is your favourite coffee?",placeholder:"Select an option",readonly:!1,required:!1,size:"medium",validationAriaLive:"polite",validationStatus:"no status","validation-text":"","show-clear-button":!1,theme:"inherit"},se={title:"Web Components/Select/Single",component:"ic-select"};var z;const n={render:()=>t(z||(z=e([`<ic-select
        id="select-default"
      ...
      <\/script>`]))),name:"Default"};var k;const a={render:()=>t(k||(k=e([`<ic-select
        label="What is your favourite coffee?"
        loading
        id="select-async"
      ></ic-select>
      ...
      <\/script>`]))),name:"With clear button"};var D;const o={render:()=>t(D||(D=e([`<ic-select
      ...
      <\/script>`]))),name:"With descriptions"};var H;const s={render:()=>t(H||(H=e([`<ic-select
        label="What is your favourite coffee?"
      ...
      <\/script>`]))),name:"Helper text"};var I;const r={render:()=>t(I||(I=e([`<ic-select
        id="select-7"
        label="What is your favourite coffee?"
      ...
      <\/script>`]))),name:"Custom placeholder"};var V;const u={render:()=>t(V||(V=e([`<ic-select
        id="select-1"
        label="What is your favourite coffee?"
      ></ic-select>
      <script>
      ...
      <\/script>`]))),name:"Custom components"};var R;const d={render:()=>t(R||(R=e([`<div style="display: flex; flex-direction: column; gap: 16px;">
      <ic-select
      ...
      <\/script>
    </div>`]))),name:"Sizes"};var P;const v={render:()=>t(P||(P=e([`<ic-select
        id="select-disabled"
        label="What is your favourite coffee?"
        disabled
      ></ic-select>
      ...
      <\/script>`]))),name:"Disabled"};var T;const p={render:()=>t(T||(T=e([`<ic-select
      ...
      <\/script>`]))),name:"Disabled options"};var Z;const m={render:()=>t(Z||(Z=e([`<ic-select
        id="select-disabled-options"
        label="What is your favourite coffee?"
        select-on-enter
      ></ic-select>
      ...
      <\/script>`]))),name:"Disabled options select on enter"};var _;const b={render:()=>t(_||(_=e([`<ic-select
      ...
      <\/script>`]))),name:"Full width"};var G;const h={render:()=>t(G||(G=e([`<ic-select
      ...
      <\/script>`]))),name:"Hidden label"};var J;const f={render:()=>t(J||(J=e([`<ic-select
        id="select-required"
        label="What is your favourite coffee?"
        required
      ></ic-select>
      ...
      <\/script>`]))),name:"Required"};var j;const g={render:()=>t(j||(j=e([`<ic-select
        id="select-read-only"
        label="What is your favourite coffee?"
        readonly
        value="Cap"
      ...
      <\/script>`]))),name:"Read-only"};var N;const C={render:()=>t(N||(N=e([`<ic-select
        id="select-groups"
        label="What is your favourite coffee?"
      ></ic-select>
      <script>
      ...
      <\/script>`]))),name:"Groups"};var K;const L={render:()=>t(K||(K=e([`<ic-select
      ...
      <\/script>`]))),name:"Recommended"};var Q;const y={render:()=>t(Q||(Q=e([`<ic-select
      ...
      <\/script>`]))),name:"Hidden menu option labels"};var U;const S={render:()=>t(U||(U=e([`<ic-select
        id="select-success"
        label="What is your favourite coffee?"
      ...
      <\/script>`]))),name:"Validation"};var X;const E={render:()=>t(X||(X=e([`<ic-select
        id="field-1"
        label="What is your favourite coffee?"
      ...
      <\/script>`]))),name:"Aria-live behaviour"};var Y;const A={render:()=>t(Y||(Y=e([`<ic-select
        id="select-scroll"
        label="What is your favourite coffee?"
      ></ic-select>
      <script>
      ...
      <\/script>`]))),name:"Scroll behaviour"};var ee;const w={render:()=>t(ee||(ee=e([`<ic-select
        id="select-loading"
        label="What is your favourite coffee?"
        loading
        timeout="1000"
      ...
      <\/script>`]))),name:"Loading with error"};var te;const q={render:()=>t(te||(te=e([`
    <form>
      <ic-select
        id="select-form"
        label="What is your favourite coffee?"
    ...
    <\/script>
  `]))),name:"In form"};var le;const F={render:()=>t(le||(le=e([`<ic-select
      ...
      <\/script>`]))),name:"Emitting icOptionSelect on enter"};var ne;const W={render:()=>t(ne||(ne=e([` <p>
      ...
      <\/script>`]))),name:"Internationalisation (+ options with htmlProps)"},x="inline-radio";var ae;const M={render:l=>t(ae||(ae=e([` <ic-select
...
}`,...M.parameters?.docs?.source}}};const re=["Default","AsyncDefault","DefaultValue","WithClearButton","WithDescriptions","HelperText","CustomPlaceholder","CustomComponents","Sizes","Disabled","DisabledOptions","DisabledOptionsSelectOnEnter","FullWidth","HiddenLabel","Required","ReadOnly","Groups","Recommended","HiddenMenuOptionLabels","Validation","AriaLiveBehaviour","ScrollBehaviour","LoadingWithError","InForm","EmittingIcOptionSelectOnEnter","Internationalisation","Playground"],ve=Object.freeze(Object.defineProperty({__proto__:null,AriaLiveBehaviour:E,AsyncDefault:a,CustomComponents:u,CustomPlaceholder:r,Default:n,DefaultValue:c,Disabled:v,DisabledOptions:p,DisabledOptionsSelectOnEnter:m,EmittingIcOptionSelectOnEnter:F,FullWidth:b,Groups:C,HelperText:s,HiddenLabel:h,HiddenMenuOptionLabels:y,InForm:q,Internationalisation:W,LoadingWithError:w,Playground:M,ReadOnly:g,Recommended:L,Required:f,ScrollBehaviour:A,Sizes:d,Validation:S,WithClearButton:i,WithDescriptions:o,__namedExportsOrder:re,default:se},Symbol.toStringTag,{value:"Module"}));export{ve as I};
