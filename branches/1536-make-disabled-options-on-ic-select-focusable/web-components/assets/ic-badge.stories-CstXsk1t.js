var u=Object.freeze,w=Object.defineProperty;var y=(a,x)=>u(w(a,"raw",{value:u(x||a.slice())}));import{b as n}from"./lit-html-B6sBSybp.js";const L={accessibleLabel:"notification",customColor:null,maxNumber:1e3,position:"far",size:"medium",label:"1",type:"text",variant:"neutral",theme:"inherit"},z={title:"Web Components/Badge",component:"ic-badge"},t={render:()=>n`<div style="padding:16px;">
      ...
      <div style="padding:16px">
        ...
        >
      </div>`,name:"Success"},i={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Error"},e={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Warning"},o={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Neutral"},c={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Light"},l={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Info"},r={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
      ...
      </div>`,name:"AI"},s={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1"
            slot="badge"
      ...
      <div style="padding:16px">
        ...
        <ic-button variant="secondary"
          ...
          >Large Icon</ic-button
        >
      </div>`,name:"Custom"},g={render:()=>n`<div style="padding:16px;">
        <ic-button variant="secondary" style="margin-right:16px"
          ><ic-badge
            label="1000"
            slot="badge"
      ...
      <div style="padding:16px;">
        ...
        <ic-button variant="secondary"
          ...
          >Large</ic-button
        >
      </div>`,name:"Max number"},d={render:()=>n`<div style="padding:16px;">
      ...
      <div style="padding:16px;">
        ...
        <ic-chip label="Large Dot"
          ...
          ></ic-badge
        ></ic-chip>
      </div>`,name:"Position near"},b={render:()=>n`<ic-tab-context>
    ...
    </ic-tab-context>`,name:"Position inline"};var m;const p={render:()=>n(m||(m=y([`<script>
      ...
      <div style="padding:16px;">
        <ic-button variant="secondary" onclick="showHideBadge()"
          ...
          badge</ic-button
        >
      </div> `]))),name:"Hide badge"},v={render:()=>n`<div style="padding:16px;">
      <ic-button variant="secondary" style="margin-right:16px"
        ><ic-badge
          label="1"
          slot="badge"
      ...
      <ic-chip label="Default dot" dismissible="true"
        ...
        ></ic-badge
      ></ic-chip>
    </div> `,name:"Accessible label"},h={render:a=>n`<ic-button variant="secondary">
      <ic-badge
        slot="badge"
        accessible-label=${a.accessibleLabel}
        custom-color=${a.customColor}
        max-number=${a.maxNumber}
        position=${a.position}
        size=${a.size}
        label=${a.label}
        type=${a.type}
      ...
      Default
    </ic-button>`,args:L,argTypes:{customColor:{control:{type:"text"}},position:{options:["far","near","inline"],control:{type:"radio"}},size:{options:["small","medium","large"],control:{type:"radio"}},type:{options:["text","dot","icon"],control:{type:"radio"}},variant:{options:["neutral","success","warning","error","info","ai","light","custom"],control:{type:"select"}},theme:{options:["inherit","light","dark"],control:{type:"inline-radio"}}},name:"Playground"};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  ...
  name: "Playground"
}`,...h.parameters?.docs?.source}}};const f=["Success","Error","Warning","Neutral","Light","Info","AI","Custom","MaxNumber","PositionNear","PositionInline","HideBadge","AccessibleLabel","Playground"],C=Object.freeze(Object.defineProperty({__proto__:null,AI:r,AccessibleLabel:v,Custom:s,Error:i,HideBadge:p,Info:l,Light:c,MaxNumber:g,Neutral:o,Playground:h,PositionInline:b,PositionNear:d,Success:t,Warning:e,__namedExportsOrder:f,default:z},Symbol.toStringTag,{value:"Module"}));export{C as I};
