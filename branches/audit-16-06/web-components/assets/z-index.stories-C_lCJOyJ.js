import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";import{n as i,t as a}from"./taggedTemplateLiteral-pWa2IaV6.js";var o=e({ComponentZIndex:()=>l,__namedExportsOrder:()=>u,default:()=>c}),s,c,l,u,d=t((()=>{n(),i(),c={title:`Patterns/Component z-index`},l={render:()=>r(s||=a([`
    <style>
      ic-toast {
    ...
    <\/script>
  `])),name:`Component z-index`,parameters:{layout:`fullscreen`}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      ic-toast {
        --bottom-position: 50px;
...
}`,...l.parameters?.docs?.source}}},u=[`ComponentZIndex`]}));d();export{l as ComponentZIndex,u as __namedExportsOrder,c as default,o as n,d as t};