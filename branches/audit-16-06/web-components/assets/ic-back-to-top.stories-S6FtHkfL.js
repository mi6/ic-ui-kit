import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./lit-html-CwvQb_NC.js";var i=e({Default:()=>c,IconOnly:()=>d,PageExample:()=>f,Playground:()=>p,PositionCenter:()=>u,PositionLeft:()=>l,__namedExportsOrder:()=>m,default:()=>s}),a,o,s,c,l,u,d,f,p,m,h=t((()=>{n(),a={target:`topEl`,theme:`inherit`,variant:`default`,position:`right`},o=`inline-radio`,s={title:`Web Components/Back to top`,component:`ic-back-to-top`},c={render:()=>r`
  ...
  `,name:`Position left`},u={render:()=>r`
    ...
    <ic-classification-banner
      classification="official"
    ></ic-classification-banner>
  `,name:`Position center`},d={render:()=>r`
    <div id="topEl" style="margin-top:-20px;">
      <ic-typography variant="h2">Top of the page</ic-typography>
    </div>
    <div style="height:1200px;"></div>
    <ic-back-to-top target="topEl" variant="icon"></ic-back-to-top>
  `,name:`Icon Only`},f={render:()=>r`
    <div
      id="header"
    ...
    <ic-classification-banner
      classification="official"
    ></ic-classification-banner>
  `,name:`Page example`},p={render:e=>r`
    <div
      id="header"
      style="width:100%;height:100px;background-color:#23508e;color:var(--ic-architectural-white)"
    >
    ...
    <ic-classification-banner
      classification="official"
    ></ic-classification-banner>
  `,args:a,argTypes:{target:{table:{disable:!0}},theme:{options:[`inherit`,`light`,`dark`],control:{type:o}},variant:{options:[`default`,`icon`],control:{type:o}},position:{options:[`left`,`center`,`right`],control:{type:o}}},name:`Playground`},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div id="topEl" style="margin-top:-20px;">
      <ic-typography variant="h2">Top of the page</ic-typography>
    </div>
  ...
  name: "Playground"
}`,...p.parameters?.docs?.source}}},m=[`Default`,`PositionLeft`,`PositionCenter`,`IconOnly`,`PageExample`,`Playground`]}));h();export{c as Default,d as IconOnly,f as PageExample,p as Playground,u as PositionCenter,l as PositionLeft,m as __namedExportsOrder,s as default,h as n,i as t};