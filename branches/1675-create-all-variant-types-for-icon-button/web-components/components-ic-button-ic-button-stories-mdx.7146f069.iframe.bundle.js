      ...
      >`;playground.storyName="Playground",playground.argTypes={variant:{options:["primary","secondary","tertiary","destructive"],control:{type:"select"}},size:{options:["default","large","small"],control:{type:"inline-radio"}},appearance:{options:["default","dark","light"],control:{type:"inline-radio"}}},playground.args=defaultArgs,playground.parameters={storySource:{source:"args => html`<ic-button\n        disabled=${args.disabled}\n        variant=${args.variant}\n        size=${args.size}\n        loading=${args.loading}\n        appearance=${args.appearance}\n        >${args.message}</ic-button\n      >`"},loki:{skip:!0}};const playgroundWithIcon=args=>lit_html__WEBPACK_IMPORTED_MODULE_2__.dy`<ic-button
        ...
        >
          ...
          <path
            d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"
          /></svg
      ></ic-button>`;playgroundWithIcon.storyName="Playground with icon",playgroundWithIcon.argTypes={variant:{options:["primary","secondary","tertiary","destructive"],control:{type:"select"}},size:{options:["default","large","small"],control:{type:"inline-radio"}},appearance:{options:["default","dark","light"],control:{type:"inline-radio"}}},playgroundWithIcon.args={...defaultArgs},playgroundWithIcon.parameters={storySource:{source:'args => html`<ic-button\n        disabled=${args.disabled}\n        variant=${args.variant}\n        size=${args.size}\n        loading=${args.loading}\n        appearance=${args.appearance}\n        >${args.message}\n        <svg\n          slot="left-icon"\n          xmlns="http://www.w3.org/2000/svg"\n          height="24px"\n          viewBox="0 0 24 24"\n          width="24px"\n          fill="#000000"\n        >\n          <path d="M0 0h24v24H0V0z" fill="none" />\n          <path\n            d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"\n          /></svg\n      ></ic-button>`'},loki:{skip:!0}};const loading=()=>lit_html__WEBPACK_IMPORTED_MODULE_2__.dy`
      <div style="padding: 6px">
        <ic-button variant="primary" loading onclick="alert('test')"
          >Button</ic-button
        >
...
//# sourceMappingURL=components-ic-button-ic-button-stories-mdx.7146f069.iframe.bundle.js.map