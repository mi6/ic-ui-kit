...
import { type IcDataTableCustomEvent, type IcDataTableDataType, type IcDataTableTitleBarCustomEvent, type IcDateInputCustomEvent, type IcDatePickerCustomEvent, type IcDensityUpdateEventDetail, type IcPageChangeEventDetail, type IcPaginationBarCustomEvent, type IcSortEventDetail, type IcTimeInputCustomEvent } from "@ukic/canary-web-components";
...
export type IcTimeInputEvents = {
    ...
    onIcChange: EventName<IcTimeInputCustomEvent<{
        value: Date | null;
        timeObject: {
            hour: string | null;
            minute: string | null;
...
export const IcTimeInput: StencilReactComponent<IcTimeInputElement, IcTimeInputEvents> = /*@__PURE__*/ createComponent<IcTimeInputElement, IcTimeInputEvents>({
