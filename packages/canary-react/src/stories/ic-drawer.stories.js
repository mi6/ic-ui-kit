...
export const Playground = {
  ...
  //       <IcSideNavigation appTitle="Déja-brew" version="v0.0.7" status="BETA">
  //         <SlottedSVG
  //           slot="app-icon"
  //           xmlns="http://www.w3.org/2000/svg"
  //           height={24}
  ...
  //                 <br />
  //                 <br />
  //                 Etiam a hendrerit ante. Nullam sed lectus ac magna vestibulum congue at quis quam. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nam commodo aliquet nisl, nec pulvinar sapien fringilla vitae. Proin maximus sed eros at maximus. Duis convallis, purus ac porttitor faucibus, diam ante finibus diam, ac ornare nunc tortor ac neque. Integer eros sem, ultrices a sodales ut, convallis in leo. Morbi augue nulla, scelerisque eu dui feugiat, rhoncus sodales sapien. Nam vulputate leo consequat sagittis varius. Proin laoreet nibh a odio volutpat, eget semper urna aliquam.
  //                 <br />
  //                 <br />
  //                 Donec porta pellentesque libero. Nam iaculis feugiat commodo. Vivamus nibh dolor, varius eget finibus eleifend, ullamcorper eget tortor. Proin congue viverra lacinia. Praesent maximus odio ut risus gravida interdum. Curabitur orci magna, condimentum vel hendrerit ac, sollicitudin mattis ligula. Ut hendrerit tristique condimentum.
  //               </p>
  //             </IcTypography>
  //           </IcSectionContainer>
  //           <IcDrawer
...
//     const expandDrawer = () => {
//       if (drawerRef.current) {
//         drawerRef.current.expanded = true;
//       };
//     };
//     return (
//       <>
...
//                   charactersUntilSuggestion={1}
//                   slot="input"
//                   label="What is your favourite coffee?"
//                 ></IcSearchBar>
//               </IcPageHeader>
//               <IcSectionContainer id="top-target">
//                 {args.trigger === 'controlled' && (
//                   <IcCardHorizontal heading="Roasted coffee" size="large">
//                     <SlottedSVG
//                       slot="icon"
//                       xmlns="http://www.w3.org/2000/svg"
//                       height={24}
...
//                       slot="message"
//                     >
//                       <IcButton variant="secondary" onClick={expandDrawer}>
//                         Learn more
//                       </IcButton>
//                     </div>
//                   </IcCardHorizontal>
...
//                     congue velit nisl, vitae congue ligula rutrum id. <br />
//                     <br />
...
//                     malesuada purus, at pulvinar mauris. Nam non lorem ante.
//                     <br />
//                     <br />
...
//                     pretium ac tortor. Morbi blandit lacus a leo vehicula aliquet.
//                     <br />
//                     <br />
...
//                     ornare nulla, at tempor massa. Sed et aliquam nisi.
//                     <br />
//                     <br />
...
//                 trigger={args.trigger}
//               >
//                 <IcButton variant="secondary" slot={args.actionsSlot}>
//                   Secondary action
//                 </IcButton>
//                 <IcButton slot={args.actionsSlot}>Primary action</IcButton>
//               </IcDrawer>
//             </main>
//             <IcBackToTop target="main"></IcBackToTop>
//             <IcFooter
//               description="The ICDS is maintained by the Design Practice Team. If you've got a question or want to feedback,
//                 please get in touch."
//               caption="All content is available under the Open Government Licence v3.0, except source code and code examples which are available under the MIT Licence."
...
// export const LeftPosition = {
//   render: () => <IcDrawer heading="Menu" message="test" position="left" />,
//   name: "Left position",
// }
...
// export const TopPosition = {
//   render: () => <IcDrawer heading="Menu" message="test" position="top" />,
//   name: "Top position",
// }
...
// export const BottomPosition = {
//   render: () => <IcDrawer heading="Menu" message="test" position="bottom" />,
//   name: "Bottom position",
// }
...
// /** A basic example of drawer with manual trigger. */
...
//                   message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours."
//                 >
//                  <IcButton variant="secondary" slot="actions"
//                     >Secondary action</IcButton>
//                   <IcButton slot="actions">Primary action</IcButton>
//                 </IcDrawer>
//                 <IcTypography>
//                   Lorem ipsum dolor sit amet, consectetur adipiscing elit.
