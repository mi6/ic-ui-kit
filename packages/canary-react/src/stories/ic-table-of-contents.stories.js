...
import { IcTopNavigation, IcNavigationItem, IcPageHeader, IcTypography } from "@ukic/react";
...
/**
 * The table of contents component is used to create a navigable list of sections within a page or document.
 * 
 * It can be positioned on the left, right or on top of the child content.
 */
    ...
    <div>
      ...
      <div style={{ height:'100%', display:'flex', flexDirection:'column'}}>
        ...
        <IcTableOfContents position="right">
          <div id="content" style={{width:'100vh'}}>
  ...
  render: () => (
      ...
      <IcTableOfContents theme="dark">
            <div id="content" style={{width:'100%'}}>
              ...
              <div id="blue" style={{height:'100vh', color: "white", backgroundColor: "black"}}>
                <h2>another test with long label that should truncate</h2>
                <div style={{height:'500px'}}>
                  <h3>another heading sub</h3>
                </div>
              </div>
              <div id="green" style={{height:'100vh', backgroundColor: "black"}}>
                <h2>test</h2>
              </div>
            </div>
          </IcTableOfContents>
