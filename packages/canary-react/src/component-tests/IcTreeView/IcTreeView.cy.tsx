...
describe("IcTreeView", () => {
  ...
  it("should render with disabled tree item", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/disabled-tree-item",
  ...
  it("should render with selected tree item", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/selected-tree-item",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.01),
    });
  });
  ...
  it("should render with tree item as link", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/link-tree-item",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.01),
    });
  });
  ...
  it("should render with expanded tree item", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/expanded-tree-item",
  ...
  it("should render with truncated text", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/truncated-text",
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/truncated-text-hover",
...
describe("IcTreeView visual regression tests in high contrast mode", () => {
  ...
  it("should render", () => {
    ...
    cy.compareSnapshot({
      name: "IcTreeView/default-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.015),
    });
  });
  ...
  it("should render with disabled tree item", () => {
    ...
    cy.compareSnapshot({
      name: "IcTreeView/disabled-tree-item-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.015),
    });
  });
  ...
  it("should render with expanded tree item", () => {
    ...
    cy.compareSnapshot({
      name: "IcTreeView/expanded-tree-item-high-contrast",
  ...
  it("should render with selected tree item", () => {
    ...
    cy.compareSnapshot({
      name: "IcTreeView/selected-tree-item-high-contrast",
  ...
  it("should render with icons", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTreeView/with-icons-high-contrast",
