...
describe("IcDateInput end-to-end, visual regression and a11y tests", () => {
  ...
  it("should render", () => {
    ...
    cy.compareSnapshot({
      name: "IcDateInput/date-input-render",
  ...
  it("should enter complete date and check for accessibility", () => {
    ...
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-values",
  ...
  it("should display validation message if date before min with date string with slashes", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-min-validation",
  ...
  it("should display validation message if date before max with date string with slashes", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-max-validation",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.025),
      delay: 500,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should display custom invalidDateMessage", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-custom-invalid-date-message",
  ...
  it("should display custom disabledDaysMessage if disabled day is set", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-custom-disable-days-message",
  ...
  it("should display a long custom disabledDaysMessage if disabled day is set", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-long-custom-disable-days-message",
  ...
  it("should display custom disabledFutureMessage if disabled future day is set", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-custom-disable-future-message",
  ...
  it("should display long custom disabledFutureMessage if disabled future day is set", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-long-custom-disable-future-message",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.037),
      delay: 500,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should display custom disabledPastMessage if disabled past day is set", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-custom-disable-past-message",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.016),
      delay: 500,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should display long custom disabledPastMessage if disabled past day is set", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-long-custom-disable-past-message",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_THRESHOLD + 0.037),
      delay: 500,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should display error validation", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-error-validation",
  ...
  it("should display warning validation", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-warning-validation",
  ...
  it("should display success validation", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcDateInput/date-input-with-success-validation",
...
describe("IcDateInput visual regression tests in high contrast mode", () => {
  ...
  it("should render default in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcDateInput/date-input-high-contrast",
  ...
  it("should render with custom disabled days message in high contrast mode", () => {
    ...
    cy.wait(500).compareSnapshot({
      name: "IcDateInput/date-input-with-custom-disable-days-message-high-contrast",
  ...
  it("should render with validation in high contrast mode", () => {
    ...
    cy.wait(500).compareSnapshot({
      name: "IcDateInput/date-input-with-validation-high-contrast",
