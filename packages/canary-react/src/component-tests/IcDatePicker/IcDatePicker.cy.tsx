...
describe("IcDatePicker end-to-end, visual regression and a11y tests", () => {
  ...
  describe("Testing IcDatePicker props", () => {
    ...
    it("should emit icChange when emitDatePartChange is true", () => {
      ...
      cy.get(DATE_PICKER).then(($el) => {
        $el[0].addEventListener("icChange", (ev) => {
          // This will log in the browser's console (not Cypress runner)
          console.log("icChange event:", ev.detail);
        });
      });
      ...
      cy.get(DATE_PICKER).then(($el) => {
        $el[0].addEventListener("icChange", (ev) => {
          // This will log in the browser's console (not Cypress runner)
          console.log("icChange event again:", ev);
        });
      });
