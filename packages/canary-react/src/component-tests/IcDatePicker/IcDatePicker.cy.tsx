...
describe("IcDatePicker end-to-end, visual regression and a11y tests", () => {
  ...
  it("should render default variant at max width", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/default-max-width",
  ...
  it("should render default variant - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/default-month-view",
  ...
  it("should render default variant at max width - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/default-max-width-month-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.034),
    });
  });
  ...
  it("should render default variant - year view", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcDatePicker/default-year-view",
  ...
  it("should render default variant at max width - year view", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcDatePicker/default-max-width-year-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.024),
    });
  });
  ...
  it("should render small variant at max width", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/small-max-width",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.031),
    });
  });
  ...
  it("should render small variant - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/small-month-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.034),
    });
  });
  ...
  it("should render small variant at max width - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/small-max-width-month-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.034),
    });
  });
  ...
  it("should render small variant - year view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/small-year-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.024),
    });
  });
  ...
  it("should render small variant at max width - year view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/small-max-width-year-view",
  ...
  it("should render large variant at max width", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/large-max-width",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.032),
    });
  });
  ...
  it("should render large variant - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/large-month-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.034),
    });
  });
  ...
  it("should render large variant at max width - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/large-max-width-month-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.034),
    });
  });
  ...
  it("should render large variant - year view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/large-year-view",
  ...
  it("should render large variant at max width - year view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/large-max-width-year-view",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.026),
    });
  });
  ...
  it("should hide go to today button", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/goto-today-hidden",
  ...
  it("should hide clear button", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/clear-hidden",
  ...
  it("should close picker when Escape pressed", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/escape-to-close",
  ...
  it("should not move focus to calendar button when Escape key pressed in input", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/escape-pressed-in-input",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.002),
    });
  });
  ...
  it("should close on document click", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/click-to-close",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.002),
    });
  });
  ...
  it("should test 'openAtDate' prop", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/open-at-date",
  ...
  it("should test 'disableDays' prop", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/disable-weekends",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.026),
    });
  });
  ...
  it("should test 'showDaysOutsideMonth' and 'startOfWeek' props", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/days-outside-month-hidden",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.026),
    });
    ...
    cy.get(DATE_PICKER)
      ...
      .then(() => {
        cy.wait(SCREENSHOT_DELAY).compareSnapshot({
          name: "IcDatePicker/start-of-week",
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.026),
        });
      });
  });
  ...
  it("should test 'min' and 'max' props - month view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/min-max-month-view",
  ...
  it("should test 'min' and 'max' props - year view", () => {
    ...
    cy.compareSnapshot({
      name: "IcDatePicker/min-max-year-view",
  ...
  it("should test picker opens above input when not enough room below", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/position-above",
...
describe("IcDatePicker visual regression tests in high contrast mode", () => {
  ...
  it("should render default variant in high contrast mode", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/default-high-contrast",
  ...
  it("should render default variant displaying month view in high contrast mode", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/default-month-view-high-contrast",
  ...
  it("should render disabled variant in high contrast mode", () => {
    ...
    cy.checkHydrated(DATE_PICKER);
    cy.compareSnapshot({
      name: "IcDatePicker/disabled-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.002),
    });
  });
  ...
  it("should render with 'disableDays' prop in high contrast mode", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/disable-weekends-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.033),
    });
  });
  ...
  it("should render with 'min' and 'max' props in high contrast mode", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/min-max-month-view-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.028),
    });
  });
  ...
  it("should render with calendar button focused in high contrast mode", () => {
    ...
    cy.wait(SCREENSHOT_DELAY).compareSnapshot({
      name: "IcDatePicker/calendar-button-focused-high-contrast",
