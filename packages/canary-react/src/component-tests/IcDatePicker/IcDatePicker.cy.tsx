...
describe("IcDatePickers", () => {
  ...
  it("should test 'disableFuture' and 'disableFutureMessage' props", () => {
    ...
    cy.findShadowEl(DATE_PICKER, FOCUSSED_DAY_BTN_CLASS).next().should(BE_DISABLED);
    cy.findShadowEl(DATE_PICKER, FOCUSSED_DAY_BTN_CLASS).prev().should("not."+BE_DISABLED);
  });
  ...
  it("should test 'disablePast' and 'disablePastMessage' props", () => {
    ...
    cy.findShadowEl(DATE_PICKER, FOCUSSED_DAY_BTN_CLASS).prev().should(BE_DISABLED);
    cy.findShadowEl(DATE_PICKER, FOCUSSED_DAY_BTN_CLASS).next().should("not."+BE_DISABLED);
  });
