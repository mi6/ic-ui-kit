...
describe("IcDrawer", () => {
  ...
  it("should set the aria label of the chevron button to the value of chevronButtonAriaLabel when chevronButtonAriaLabel is not an empty string", () => {
    mount(
      <IcDrawer heading="Roasted coffee" message="Contrary to popular belief, light roast coffee has more caffeine than dark roast coffee. The longer coffee is roasted, the more caffeine is lost through the cooking of the bean. Light roast coffee is a light brown colour and has no oil on the surface of the beans, and these coffees typically have a crisp acidity, a mellow body, and bright flavours." position="bottom" chevronButtonAriaLabel="Learn more about coffee" />
    );
  ...
  it("should set the aria label of the close button to the value of closeButtonAriaLabel when closeButtonAriaLabel is not an empty string", () => {
    mount(
      ...
      showCloseButton closeButtonAriaLabel="Click to close" trigger="controlled" expanded />
    );
