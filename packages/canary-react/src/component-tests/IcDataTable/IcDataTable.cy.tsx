...
describe("IcDataTables", () => {
  ...
  it("should change page when the pagination items are clicked", () => {
    ...
    const pagination = cy
      .findShadowEl(DATA_TABLE_SELECTOR, PAGINATION_BAR_SELECTOR)
      .find(PAGINATION_SELECTOR);

    pagination
      .findShadowEl(PAGINATION_SELECTOR, "ic-pagination-item")
      .find("ic-typography")
      .contains("Page 1");

    const nextPageButton = pagination.findShadowEl(
      PAGINATION_SELECTOR,
      "#next-page-button"
    );
  ...
  it("should change number of items per page when select dropdown is changed", () => {
    ...
    const paginationBar = cy.findShadowEl(
      DATA_TABLE_SELECTOR,
    ...
    paginationBar.find(".item-pagination-label").contains("1 - 10 of 20 items");
