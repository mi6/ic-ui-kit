...
//   // it.skip("should navigate to today when button pressed", () => {
//   //   mount(<IcCalendar value={DEFAULT_VALUE} />);
...
//   // it.skip("should navigate to previous month when button pressed - day view", () => {
//   //   mount(<IcCalendar value={DEFAULT_VALUE} />);
...
//   // it.skip("should navigate to next month when button pressed - day view", () => {
//   //   mount(<IcCalendar value={DEFAULT_VALUE} />);
...
//   // it.skip("should navigate to previous year when button pressed - day view", () => {
//   //   mount(<IcCalendar value={DEFAULT_VALUE} />);
...
//   // it.skip("should navigate to next year when button pressed - day view", () => {
//   //   mount(<IcCalendar value={DEFAULT_VALUE} />);
...
//     cy.findShadowEl(CALENDAR, FOCUSSED_DAY_BTN_CLASS).focus().type(ESCAPE_KEY);
...
//   //     "January"
//   //   );
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2023");
...
//   //     .focus()
//   //     .type(ARROW_RIGHT_KEY);
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2030");
//   //   cy.findShadowEl(CALENDAR, SELECTED_YEAR_BTN_CLASS).should(
//   //     HAVE_TEXT,
//   //     "2030"
//   //   );
//   //   cy.findShadowEl(CALENDAR, PREV_DECADE_BUTTON_ID).should(HAVE_TEXT, "2020s");
//   //   cy.findShadowEl(CALENDAR, NEXT_DECADE_BUTTON_ID).should(HAVE_TEXT, "2040s");
//   // });
...
//   //     .focus()
//   //     .type(ARROW_LEFT_KEY);
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2019");
//   //   cy.findShadowEl(CALENDAR, SELECTED_YEAR_BTN_CLASS).should(
//   //     HAVE_TEXT,
//   //     "2019"
//   //   );
//   //   cy.findShadowEl(CALENDAR, PREV_DECADE_BUTTON_ID).should(HAVE_TEXT, "2000s");
//   //   cy.findShadowEl(CALENDAR, NEXT_DECADE_BUTTON_ID).should(HAVE_TEXT, "2020s");
//   // });
...
//   //     .focus()
//   //     .type(HOME_KEY);
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2020");
//   //   cy.findShadowEl(CALENDAR, SELECTED_YEAR_BTN_CLASS).should(
//   //     HAVE_TEXT,
//   //     "2020"
//   //   );
...
//   //     .focus()
//   //     .type(END_KEY);
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2029");
//   //   cy.findShadowEl(CALENDAR, SELECTED_YEAR_BTN_CLASS).should(
//   //     HAVE_TEXT,
//   //     "2029"
//   //   );
...
//   //     .focus()
//   //     .type(PAGE_UP_KEY);
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2013");
//   //   cy.findShadowEl(CALENDAR, SELECTED_YEAR_BTN_CLASS).should(
//   //     HAVE_TEXT,
//   //     "2013"
//   //   );
...
//   //     .focus()
//   //     .type(PAGE_DOWN_KEY);
//   //   cy.findShadowEl(CALENDAR, YEAR_PICKER_BTN_CLASS).should(HAVE_TEXT, "2033");
//   //   cy.findShadowEl(CALENDAR, SELECTED_YEAR_BTN_CLASS).should(
//   //     HAVE_TEXT,
//   //     "2033"
//   //   );
...
//   //     .find(BUTTON)
//   //     .click();
//   //   cy.findShadowEl(CALENDAR, NEXT_DECADE_BUTTON_ID).should(HAVE_TEXT, "2030s");
//   // });
...
//   it.skip("should test 'value' prop", () => {
//     mount(<IcCalendar value={DEFAULT_VALUE} />);
...
//   it.only("should test 'showDaysOutsideMonth' and 'startOfWeek' props", () => {
//     mount(
//       <IcCalendar
//         value={DEFAULT_VALUE}
...
//     cy.get(CALENDAR).invoke("prop", "startOfWeek", "4");
//     // .then(() => {
//     //   cy.wait(SCREENSHOT_DELAY).compareSnapshot({
//     //     name: "/start-of-week",
