...
describe("IcSelect - Multi", () => {
  ...
  it("should render default multi select variant", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelect_Multi/default-multi-select",
  ...
  it("should render with default value set", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-default-value",
  ...
  it("should render options with descriptions", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-descriptions",
  ...
  it("should render small", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-small",
  ...
  it("should render large", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-large",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should render with disabled options", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-disabled-options",
  ...
  it("should render as read-only", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-read-only",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should render options as groups", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-groups",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.015),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should select multiple when shift and arrow down pressed", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-shift-arrow-down",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.028),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should select multiple when shift and arrow up pressed", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-shift-arrow-up",
  ...
  it("should select all when shift+ctrl+end pressed", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-shift-ctrl-end",
  ...
  it("should select all when shift+ctrl+home pressed", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-shift-ctrl-home",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.032),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should select multiple when pressing shift and clicking", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-shift-click",
  ...
  it("should select multiple when pressing shift and clicking - from bottom item", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-shift-click-from-bottom",
  ...
  it("should focus select all button", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-select-all-button-focused",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.026),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should focus clear button", () => {
    ...
    cy.checkA11yWithWait(undefined, SCREENSHOT_DELAY);
    cy.compareSnapshot({
      name: "IcSelect_Multi/multi-select-clear-button-focused",
...
describe("IcSelect - Multi visual regression tests in high contrast mode", () => {
  ...
  it("should render with no options selected in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelect_Multi/default-multi-select-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.022),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should render with options selected in high contrast mode", () => {
    ...
    cy.wait(300).compareSnapshot({
      name: "IcSelect_Multi/multi-select-partially-selected-high-contrast",
  ...
  it("should render with option highlighted in high contrast mode", () => {
    ...
    cy.wait(300).compareSnapshot({
      name: "IcSelect_Multi/multi-select-option-highlighted-high-contrast",
  ...
  it("should focus select all button in high contrast mode", () => {
    ...
    cy.wait(300).compareSnapshot({
      name: "IcSelect_Multi/multi-select-select-all-button-focused-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.022),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
  ...
  it("should focus clear button in high contrast mode", () => {
    ...
    cy.wait(300).compareSnapshot({
      name: "IcSelect_Multi/multi-select-clear-button-focused-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
      delay: SCREENSHOT_DELAY,
      cypressScreenshotOptions: {
        capture: "viewport",
