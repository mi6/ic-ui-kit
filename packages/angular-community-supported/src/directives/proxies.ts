...
export class IcPaginationBar {
  ...
  @Output() icPageChange = new EventEmitter<
    CustomEvent<IIcPaginationBarIcPageChangeEventDetail>
  >();
  @Output() icItemsPerPageChange = new EventEmitter<
    CustomEvent<IIcPaginationBarIcItemsPerPageChangeEventDetail>
  >();
  constructor(
    c: ChangeDetectorRef,
    r: ElementRef,
...
The `detail` property contains `value` (i.e. the page number) and a `fromItemsPerPage` flag to indicate if the event was triggered by the `icItemsPerPageChange` event also occurring.
   */
  icPageChange: EventEmitter<
    CustomEvent<IIcPaginationBarIcPageChangeEventDetail>
  >;
  /**
   * Emitted when the items per page option is changed.
   */
  icItemsPerPageChange: EventEmitter<
    CustomEvent<IIcPaginationBarIcItemsPerPageChangeEventDetail>
  >;
}
