...
| ------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | -------------- |
| `activationType`          | `activation-type` | Determines whether options manually set as values (by pressing 'Enter') when they receive focus using keyboard navigation.                      | `"automatic" \| "manual" \| undefined`        | `"automatic"`  |
...
| `closeOnSelect`           | `close-on-select` | If `true`, the menu will close when an option is selected.                                                                                      | `boolean \| undefined`                        | `true`         |
| `fullWidth`               | `full-width`      | If `true`, the menu will fill the width of the container.                                                                                       | `boolean \| undefined`                        | `false`        |
...
| `labelField`              | `label-field`     | The custom name for the label field for IcMenuOption.                                                                                           | `string \| undefined`                         | `"label"`      |
...
| `size`                    | `size`            | The size of the menu.                                                                                                                           | `"large" \| "medium" \| "small" \| undefined` | `"medium"`     |
...
| `valueField`              | `value-field`     | The custom name for the value field for IcMenuOption.                                                                                           | `string \| undefined`                         | `"value"`      |
