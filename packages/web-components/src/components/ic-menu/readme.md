...
| `anchorEl`                | `anchor-el`       | The reference to an anchor element the menu will position itself from when rendered.                                                            | `HTMLElement \| undefined`       | `undefined`    |
...
| `inputEl`                 | `input-el`        | The reference to the input element.                                                                                                             | `HTMLElement \| undefined`       | `undefined`    |
...
| `options` _(required)_    | `options`         | The possible menu selection options.                                                                                                            | `IcMenuOption[]`                 | `undefined`    |
