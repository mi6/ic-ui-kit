...
| `anchorEl`                | --                | The reference to an anchor element the menu will position itself from when rendered.                                                            | `HTMLElement`                                 | `undefined`    |
...
| `inputEl`                 | --                | The reference to the input element.                                                                                                             | `HTMLElement`                                 | `undefined`    |
