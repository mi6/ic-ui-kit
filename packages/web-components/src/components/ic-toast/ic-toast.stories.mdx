...
<Canvas>
  <Story name="With variant" parameters={{ loki: { skip: true } }}>
    {(args) => html`<button onclick="func()">Display toast</button>
      <script>
        var toastRegion = document.querySelector("ic-toast-region");
        function func() {
...
<Canvas>
  <Story name="Multiline message" parameters={{ loki: { skip: true } }}>
    {(args) =>
...
<Canvas>
  <Story name="Slotted action elements" parameters={{ loki: { skip: true } }}>
    {(args) =>
...
<Canvas>
  <Story name="Example on page" parameters={{ loki: { skip: true } }}>
    {(args) => html` <script>
        var toastRegion = document.querySelector("ic-toast-region");
        function func() {
          var x = document.getElementById("toast1");
