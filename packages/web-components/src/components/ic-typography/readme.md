...
| `bold`                 | `bold`                   | If `true`, the typography will have a bold font weight. Note: This will only take affect on h3, body, code-large and code-extra-small variants. | `boolean`                                                                                                                                                                                                  | `false`     |
