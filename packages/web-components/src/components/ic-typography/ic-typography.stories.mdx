...
<Canvas>
  <Story name="Component override" parameters={{ loki: { skip: true } }}>{html`
...
<Canvas>
  <Story name="Bold" parameters={{ loki: { skip: true } }}>
    {html`
...
<Canvas>
  <Story name="Italic" parameters={{ loki: { skip: true } }}>
    {html`
...
<Canvas>
  <Story name="Strikethrough" parameters={{ loki: { skip: true } }}>
    {html`
...
<Canvas>
  <Story name="Underline" parameters={{ loki: { skip: true } }}>
    {html`
...
<Canvas>
  <Story name="All prop text styles" parameters={{ loki: { skip: true } }}>
    {html`
      <ic-typography
        variant="h1"
        strikethrough="true"
