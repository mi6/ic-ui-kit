...
<Canvas>
  <Story name="Inline" parameters={{ loki: { skip: true } }}>
    {html` <ic-tab-context>
...
<Canvas>
  <Story name="Manual activation" parameters={{ loki: { skip: true } }}>
...
<Canvas>
  <Story name="Responsive" parameters={{ loki: { skip: true } }}>
    {html`
      <ic-tab-context>
        <ic-tab-group label="Example tab group">
          <ic-tab>One</ic-tab>
...
<Canvas>
  <Story name="Nested tabs" parameters={{ loki: { skip: true } }}>
...
<Canvas>
  <Story name="icTabSelect event" parameters={{ loki: { skip: true } }}>
    {(args) =>
      html`<ic-tab-context>
          <ic-tab-group label="Example tab group">
            <ic-tab>One</ic-tab>
...
<Canvas>
  <Story name="Min and max content" parameters={{ loki: { skip: true } }}>
