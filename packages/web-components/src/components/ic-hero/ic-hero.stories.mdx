...
<Canvas>
  <Story name="Left aligned" parameters={{ layout: "fullscreen" , loki: { skip: true }}}>
    {html`<ic-hero
...
<Canvas>
  <Story name="Center aligned" parameters={{ layout: "fullscreen" , loki: { skip: true }}}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="center"
...
<Canvas>
  <Story name="Long heading" parameters={{ layout: "fullscreen", loki: { skip: true } }}>
    {html`<ic-hero
...
<Canvas>
  <Story name="Full width" parameters={{ layout: "fullscreen", loki: { skip: true } }}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="full-width"
...
<Canvas>
  <Story name="Content center aligned" parameters={{ layout: "fullscreen" , loki: { skip: true }}}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="center"
...
<Canvas>
  <Story name="Small" parameters={{ layout: "fullscreen", loki: { skip: true } }}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="center"
...
<Canvas>
  <Story name="Deprecated - small" parameters={{ layout: "fullscreen" , loki: { skip: true }}}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="center"
...
<Canvas>
  <Story name="Secondary heading" parameters={{ layout: "fullscreen", loki: { skip: true } }}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
...
<Canvas>
  <Story name="Search bar interaction" parameters={{ layout: "fullscreen" , loki: { skip: true } }}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="center"
...
<Canvas>
  <Story name="Card right content" parameters={{ layout: "fullscreen", loki: { skip: true } }}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
...
<Canvas>
  <Story name="Image right content" parameters={{ layout: "fullscreen" , loki: { skip: true }}}>
    {html`<ic-hero
      heading="Hero heading"
      subheading="Hero description. This is a Hero component, it should be used as a page heading."
      aligned="center"
...
<Canvas>
  <Story name="Theme" parameters={{ layout: "fullscreen", loki: { skip: true } }}>
