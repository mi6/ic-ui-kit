...
| `dismissLabel`    | `dismiss-label`     | The text in the dismiss button tooltip and aria label. Makes the user aware of the action resulting from clicking the 'Dismiss alert' button. | `string \| undefined`                                              | `"Dismiss"` |
...
| `variant`         | `variant`           | The variant of the alert which will be rendered.                                                                                              | `"ai" \| "error" \| "info" \| "neutral" \| "success" \| "warning"` | `"neutral"` |
