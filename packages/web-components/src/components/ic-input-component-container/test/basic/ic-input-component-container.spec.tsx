...
describe("ic-input-component-container", () => {
  ...
  it("renders disabled", async () => {
    ...
    expect(page.root).toEqualHtml(`
    <ic-input-component-container validation-status="success" class="disabled" aria-disabled="true" disabled="true">
      <div class="focus-indicator">
        content
      </div>
    </ic-input-component-container>
  ...
  it("renders with slotted content", async () => {
    ...
    expect(page.root).toEqualHtml(`
    <ic-input-component-container class="disabled" aria-disabled="true" disabled="true" validation-status="success">
      <div class="focus-indicator">
