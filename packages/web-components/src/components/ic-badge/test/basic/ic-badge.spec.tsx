    ...
    const page = await newSpecPage({
      ...
      >
        ...
        <ic-navigation-item label="Six" href="/" slot="navigation">
          <ic-badge textLabel="2" slot="badge" position="far"/>
        </ic-navigation-item>
        <ic-navigation-item label="Seven" href="/" slot="navigation">
          <ic-badge textLabel="2" slot="badge" variant="info" position="near"/>
        </ic-navigation-item>
        <ic-navigation-item label="Eight" href="/" slot="navigation">
          <ic-badge textLabel="2" slot="badge" variant="info" position="inline"/>
        </ic-navigation-item>
      </ic-top-navigation>`,
    });
