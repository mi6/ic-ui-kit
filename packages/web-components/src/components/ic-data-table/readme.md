...
| `stickyColumnHeaders`  | `sticky-column-headers` | Column headers will remain at the top of the table when scrolling vertically if set to `true`. | `boolean`                                                                                                                                                                                                                   | `false`                                                                                                                                                                                                                                                                   |
| `stickyRowHeaders`     | `sticky-row-headers`    | Row headers will remain to the left when scrolling horizontally if set to `true`.              | `boolean`                                                                                                                                                                                                                   | `false`                                                                                                                                                                                                                                                                   |
