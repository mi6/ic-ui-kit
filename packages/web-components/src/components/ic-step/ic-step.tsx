...
export class Step {
  ...
  /**
   * @internal The step variant, managed by ic-stepper.
   */
  ...
  /**
   * @internal The final step in series flag, managed by ic-stepper.
   */
  @Prop() lastStep!: boolean;

  /**
   * @internal The step number of the final step, managed by ic-stepper.
   */
  @Prop() lastStepNum?: number;

  /**
   * @internal The name of the next step, managed by ic-stepper.
   */
  @Prop() nextStepTitle?: string;

  /**
   * @internal The progress of the next step, calculated by dividing the current step number by the total number of steps, managed by ic-stepper.
   */
