...
| --------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------- |
| `height`  | `height`  | Height of the skeleton. Accepts any valid CSS length (e.g. "24px", "2rem", "100%").                                                     | `string \| undefined`                            | `undefined`   |
| `theme`   | `theme`   | Sets the theme color to the dark or light theme color. "inherit" will set the color based on the system settings or ic-theme component. | `"dark" \| "inherit" \| "light" \| undefined`    | `"inherit"`   |
| `variant` | `variant` | The variant of the skeleton that will be displayed.                                                                                     | `"circle" \| "rectangle" \| "text" \| undefined` | `"rectangle"` |
| `width`   | `width`   | Width of the skeleton. Accepts any valid CSS length (e.g. "24px", "2rem", "100%").                                                      | `string \| undefined`                            | `undefined`   |
