...
| `value`                       | `value`                          | The value of the select, reflected by the value of the currently selected option. For the multi-select variant, the value must be an array of option values.                                        | `null \| string \| string[]`              | `null`               |
...
graph TD;
  ...
  ic-select-new --> ic-input-container
  ...
  style ic-select-new fill:#f9f,stroke:#333,stroke-width:4px
```
