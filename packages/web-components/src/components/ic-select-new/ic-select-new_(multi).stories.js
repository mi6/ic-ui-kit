...
export default {
  title: "Web Components/SelectNew/Multi",
...
export const HelperText = {
  render: (args) =>
    html`<ic-select-new
      ...
      ></ic-select-new>
      <br />
      <ic-select-new label="What are your favourite types of coffee?" multiple
        ><ic-typography variant="caption" slot="helper-text">
          <span>
            Slotted helper text with a <ic-link href="#">link</ic-link>
          </span>
        </ic-typography></ic-select-new
      >
      <script>
        document.querySelectorAll("ic-select-new").forEach((el) => {
          el.options = [
            { label: "Cappuccino", value: "Cap" },
            { label: "Latte", value: "Lat" },
            { label: "Americano", value: "Ame" },
