...
| `transparentBackground` | `transparent-background` | If `true`, the secondary variant of button will have a transparent background when not hovered, pressed or loading.                                                   | `boolean`                                                                                                                                                                                             | `true`                                             |
