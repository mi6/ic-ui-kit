...
| `itemsPerPageOptions`     | --                            | The options that will be displayed for the 'items per page' select input. Maximum of 4 options including a required 'All' option with a value equal to the total number of items. | `{ label: string; value: string; }[]`  | `undefined` |
...
| `paginationType`          | `pagination-type`             | Whether the total number of items and current item range is displayed or total number of pages and current page is displayed.                                                     | `"data" \| "page"`                     | `"page"`    |
| `showGoToPageControl`     | `show-go-to-page-control`     | If `true`, the 'go to page' control will be displayed.                                                                                                                            | `boolean`                              | `false`     |
| `showItemsPerPage`        | `show-items-per-page`         | If `true`, the number of total items and current item range or number of total pages and current page will be displayed.                                                          | `boolean`                              | `true`      |
