      ...
      <ic-text-field label="Test label" rows="6" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus=""><textarea aria-describedby="ic-text-field-input-2-remaining-charcount-desc" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-2" inputmode="text" name="ic-text-field-input-2" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      </ic-input-container>
        </mock:shadow-root>
      ...
      <ic-text-field autocapitalize="on" autocomplete="on" autocorrect="on" autofocus="true" label="Test label" rows="6" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus=""><textarea aria-describedby="ic-text-field-input-4-remaining-charcount-desc" aria-invalid="false" aria-label="Test label" autocapitalize="on" class="no-resize" id="ic-text-field-input-4" inputmode="text" name="ic-text-field-input-4" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      </ic-input-container>
        </mock:shadow-root>
  ...
  it("should render textarea with hidden label", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <ic-text-field hide-label="true" label="Test label" rows="6" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            <ic-input-component-container multiline="" size="default" validationstatus=""><textarea aria-describedby="ic-text-field-input-5-remaining-charcount-desc" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-5" inputmode="text" name="ic-text-field-input-5" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      </ic-input-container>
        </mock:shadow-root>
    ...
    <ic-input-validation arialivemode="assertive" for="ic-text-field-input-9" message="Maximum length exceeded" status="error">
            <div slot="validation-message-adornment">
              <ic-typography class="error maxlengthtext" variant="caption">
                ...
                <span aria-live="polite" class="remaining-char-count-desc" hidden="" id="ic-text-field-input-9-remaining-charcount-desc">
    ...
    <ic-input-validation arialivemode="assertive" for="ic-text-field-input-10" message="You have exceeded the maximum length" status="error">
            <div slot="validation-message-adornment">
              <ic-typography class="error maxlengthtext" variant="caption">
                ...
                <span aria-live="polite" class="remaining-char-count-desc" hidden="" id="ic-text-field-input-10-remaining-charcount-desc">
                  -8 characters remaining.
                </span>
      ...
      <ic-text-field class="fullwidth" full-width="true" label="Test label" name="mycontrolname" rows="2" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container fullwidth="" size="default" multiline="" validationstatus=""><textarea aria-describedby="ic-text-field-input-11-remaining-charcount-desc" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-11" inputmode="text" name="mycontrolname" placeholder="" rows="2" value="test value"></textarea>
          </ic-input-component-container>
      </ic-input-container>
        </mock:shadow-root>
      ...
      <ic-text-field label="Test label" rows="6" validation-status="success" validation-text="Good choice!" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus="success"><textarea aria-describedby="ic-text-field-input-12-remaining-charcount-desc ic-text-field-input-12-validation-text" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-12" inputmode="text" name="ic-text-field-input-12" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      ...
      <ic-text-field label="Test label" rows="6" validation-status="warning" validation-text="warning text" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus="warning"><textarea aria-describedby="ic-text-field-input-13-remaining-charcount-desc ic-text-field-input-13-validation-text" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-13" inputmode="text" name="ic-text-field-input-13" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      ...
      <ic-text-field label="Test label" rows="6" validation-status="error" validation-text="error text" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus="error"><textarea aria-describedby="ic-text-field-input-14-remaining-charcount-desc ic-text-field-input-14-validation-text" aria-invalid="true" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-14" inputmode="text" name="ic-text-field-input-14" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      ...
      <ic-text-field label="Test label" resize="true" rows="6" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus=""><textarea aria-describedby="ic-text-field-input-15-remaining-charcount-desc" aria-invalid="false" aria-label="Test label" autocapitalize="off" id="ic-text-field-input-15" inputmode="text" name="ic-text-field-input-15" placeholder="" rows="6" value="test value"></textarea>
          </ic-input-component-container>
      </ic-input-container>
        </mock:shadow-root>
