...
describe("ic-text-field", () => {
      ...
      <ic-text-field label="Test label" max-characters="25" rows="6" value="Test value">
        <mock:shadow-root>
          <ic-input-container>
            ...
            <ic-input-component-container multiline="" size="default" validationstatus=""><textarea aria-describedby="ic-text-field-input-9-char-count-desc" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-9" inputmode="text" name="ic-text-field-input-9" placeholder="" rows="6" value="Test value"></textarea>
            </ic-input-component-container>
  ...
  it("should render textarea with name & full width", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <ic-text-field class="ic-text-field-full-width" full-width="true" label="Test label" name="mycontolname" rows="2" value="test value">
        <mock:shadow-root>
          <ic-input-container>
            <ic-input-label for="ic-text-field-input-11" helpertext="" label="Test label"></ic-input-label>
            <ic-input-component-container fullwidth="" size="default" multiline="" validationstatus=""><textarea aria-describedby="" aria-invalid="false" aria-label="Test label" autocapitalize="off" class="no-resize" id="ic-text-field-input-11" inputmode="text" name="mycontolname" placeholder="" rows="2" value="test value"></textarea>
          </ic-input-component-container>
      </ic-input-container>
        </mock:shadow-root>
