...
| `dismissLabel`          | `dismiss-label`          | The text in the dismiss button tooltip and aria label. Makes the user aware of the resulting action from them clicking the chip.                                                     | `string`                                                                 | `"Dismiss"` |
