...
| `silent`             | `silent`        | Whether the tooltip should be silent to screen readers. Set to true if your tooltip text only duplicates the accessible label of the child element | `boolean`                                                                                                                                                            | `false`     |
