...
<Canvas>
  <Story name="Sticky with content and footer">
    {html`
...
<Canvas>
  <Story name="Sticky for large and extra-large breakpoints only">
    {html`
      <ic-top-navigation app-title="ApplicationName">
        <svg
          slot="app-icon"
...
<Canvas>
  <Story name="With breadcrumbs, input, actions and stepper and long title">
    {html`
      <ic-page-header
