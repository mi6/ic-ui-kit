...
| `href`           | `href`           | The destination of the navigation item.                                                                                                 | `string \| undefined`                                                                                                                                                                                 | `""`        |
...
| `selected`       | `selected`       | If `true`, the navigation item will be set in a selected state.                                                                         | `boolean \| undefined`                                                                                                                                                                                | `false`     |
