...
| ------------------- | -------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| `icRadioCheck`      | Emitted when a radio is selected.                                                                                          | `CustomEvent<IcValueEventDetail>` |
| `radioOptionSelect` | <span style="color:red">**[DEPRECATED]**</span> This event should not be used anymore. Use icRadioCheck instead.<br/><br/> | `CustomEvent<IcValueEventDetail>` |
