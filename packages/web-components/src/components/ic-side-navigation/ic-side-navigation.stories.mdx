...
<Canvas>
  <Story name="Inline" parameters={{ layout: "fullscreen" }}>
    {html`
      <div style="height: 700px; margin: 15px;transform: translateZ(0); overflow: hidden;">
