...
<Canvas>
  <Story name="Disable Height Constraint">
    {html`
      <script>
        function dropdownItems() {
          return Array.from(Array(10).keys()).map((i) => {
...
<Canvas>
  <Story name="Disable Width Constraint">
    {html`
      <script>
        document
...
<Canvas>
  <Story name="show/hide interactive elements">
    {html`
      <script>
        function showSmallDialog() {
...
<Canvas>
  <Story name="Hidden close button">
    {html`
      <script>
