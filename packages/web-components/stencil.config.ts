...
export const config: Config = {
  ...
  outputTargets: [
    ...
    angularOutputTarget({
      ...
      directivesProxyFile:
        "../angular-community-supported/src/directives/proxies.ts",
      directivesArrayFile:
        "../angular-community-supported/src/directives/proxies-list.ts",
    ...
    angularOutputTarget({
      ...
      directivesProxyFile:
        "../angular-community-supported/standalone/src/directives/proxies.ts",
      valueAccessorConfigs: angularValueAccessorBindings,
    }),
    {
      type: "docs-readme",
