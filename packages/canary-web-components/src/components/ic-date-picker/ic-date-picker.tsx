...
export class DatePicker {
  ...
  componentWillLoad(): void {
    ...
    this.hostMutationObserver = new MutationObserver((mutationList) =>
      renderDynamicChildSlots(mutationList, ["helper-text"], this)
    );
  ...
  @Listen("icCalendarDaySelect")
  handleCalendarDaySelect(): void {
    this.calendarOpen = false;
  }

  @Listen("icChange")
  dateChangeHandler(ev: CustomEvent): void {
    if (this.selectedDate !== ev.detail?.value) {
  ...
  private keyDownHandler = (event: KeyboardEvent) => {
    if (event.key === "Escape") {
      ...
      this.calendarEl?.clearDialogDescription();
      event.stopImmediatePropagation();
    }
  };
