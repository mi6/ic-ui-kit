...
/**
 * Use the helper text to add additional detail for the date input. Use custom content for the helper text with the `helper-text` slot.
 */
export const CustomHelperTextExample = {
  render: () => CustomHelperTextExample(),
