...
| `showDaysOutsideMonth`  | `show-days-outside-month`  | If `true`, days outside the current month are visible in the date picker.                                                                                                                                                                              | `boolean`                                                                                                                                                 | `true`                                                                                          |
| `showPickerClearButton` | `show-picker-clear-button` | If `true`, the `Clear` button on the date picker is visible.                                                                                                                                                                                           | `boolean`                                                                                                                                                 | `true`                                                                                          |
| `showPickerTodayButton` | `show-picker-today-button` | If `true`, the `Go to today` button on the date picker is visible.                                                                                                                                                                                     | `boolean`                                                                                                                                                 | `true`                                                                                          |
