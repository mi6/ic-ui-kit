...
| `truncationPattern`             | `truncation-pattern`               | For long text in cells that aren't set to textWrap, define how they should be truncated. `tooltip` adds a tooltip for the rest of the text, `showHide` adds the ic-typography "See More"/"See Less" buttons.                      | `"show-hide" \| "tooltip"`                                                                                                                                                            | `"tooltip"`                                                                                                                                                                                                                                                                                                                                                                                         |
