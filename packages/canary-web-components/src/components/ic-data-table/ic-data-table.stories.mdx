...
<Canvas withSource="none">
  <Story name="Cells with descriptions" parameters={{ loki: { skip: true } }}>
    {CellDescriptions()}
  </Story>
</Canvas>

#### Table with descriptions in cells code example

```html
<ic-data-table
  id="data-table"
  caption="Cells with descriptions"
  width="800px"
  table-layout="auto"
></ic-data-table>
<script>
...
<Canvas withSource="none">
  <Story
    name="Long cells with descriptions"
