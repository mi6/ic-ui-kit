...
<div style="display:flex; gap:8px; margin-top:8px;">
  ...
  <ic-button onClick="updatePagination()">Update page lengths</ic-button>
  <ic-button onClick="clearData()">Reset data</ic-button>
  <ic-button onClick="resetPagination()">Reset page lengths</ic-button>
</div>
<script>
  const dataTable = document.querySelector("#data-table");
  ...
  const updatePagination = () =>{
    dataTable.paginationOptions={...dataTable.paginationOptions, itemsPerPage: [{ label: '10', value: '10' }, { label: '20', value: '20' },{ label: '50', value: '50' }]};
  }

  const resetPagination = () => {
    dataTable.paginationOptions={...dataTable.paginationOptions, itemsPerPage: defaultPagOptions};
  }
