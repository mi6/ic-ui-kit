...
/**
 * @slot label - Content is placed as the tree item label.
...
export class TreeItem {
  ...
  private hasParentExpanded = false;
  ...
  componentDidUpdate(): void {
    if (this.hasParentExpanded === true) {
  ...
  private updateAriaLabel = (): void => {
    if (this.isParent) {
      this.treeItemElement.ariaLabel = `${this.label}, triggers submenu, ${
    ...
    return (
      <Host
        class={{
          ...
          "ic-tree-item-selected": selected,
