...
export const createContainer = (
  ...
  multiSelectArray: HTMLIcSelectWithMultiElement[],
  height: string = "430px",
) => {
  const container = document.createElement("div");
  container.style.height = height;

  multiSelectArray.forEach(multiSelect => container.appendChild(multiSelect));
...
export const Default = (): HTMLDivElement => {
  ...
  multiSelect.addEventListener("icOptionDeselect", function (event: CustomEvent) {
...
export const Sizes = (): HTMLDivElement => {
  ...
  const container = createContainer([multiSelectSmall, multiSelectDefault, multiSelectLarge], "650px");
...
export const Validation = (): HTMLDivElement => {
  ...
  const container = createContainer([multiSelectSuccess, multiSelectWarning, multiSelectError], "640px");
