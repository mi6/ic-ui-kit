...
'Item' can be changed to a custom label by setting the `item-label` attribute. Any occurences of 'Item' in the pagination bar will be replaced with the custom label.
