...
| `hideItemsPerPageLabel`   | `hide-items-per-page-label`   | If `true`, the number of total items and current item range or number of total pages and current page will be hidden.                                                          | `boolean`                              | `false`     |
| `itemLabel`               | `item-label`                  | The label which will be used in place of 'items' if type is data. Should be capitalised.                                                                                       | `string`                               | `"Item"`    |
...
| `labelType`               | `label-type`                  | Whether total number of items and current item range or total number of pages and current page is displayed.                                                                   | `"data" \| "page"`                     | `"page"`    |
