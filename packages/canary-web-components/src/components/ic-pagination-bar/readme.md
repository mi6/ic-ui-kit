...
| `itemsPerPageOptions`              | `items-per-page-options`                 | The options which will be displayed for 'items per page' select input.                                                                  | `undefined \| { label: string; value: string; }[]`  | `undefined` |
