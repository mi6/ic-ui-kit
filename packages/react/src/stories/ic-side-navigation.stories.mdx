...
<Canvas>
  <Story name="Default">
    <IcSideNavigation appTitle="ACME" version="v0.0.0" status="BETA" href="https://www.google.com/">
      <svg
        slot="app-icon"
...
<Canvas>
  <Story name="Disable top bar behaviour">
    <IcSideNavigation
      appTitle="ACME"
      version="v0.0.0"
      status="BETA"
...
<Canvas>
  <Story name="Disable auto parent styling">
    <IcSideNavigation
      appTitle="ACME"
      version="v0.0.0"
      status="BETA"
...
<Canvas>
  <Story name="Updating slotted elements with state">
    <UpdateSlottedItems/>
  </Story>
</Canvas>
