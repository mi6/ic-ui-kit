...
import { IcSelect, IcButton, IcTypography, IcStatusTag } from "../components";
...
export const optionsWithCustomElements = [
  ...
  },
  {
    label: "Latte",
    value: "Lat",
    element: { component: ReactDOMServer.renderToString(<IcStatusTag label="Neutral status tag"></IcStatusTag>), ariaLabel: "Neutral status tag" },
  },
  {
    label: "Americano",
    value: "Ame",
