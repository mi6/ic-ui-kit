...
<Canvas>
  <Story name="Horizontal">
    <IcRadioGroup orientation="horizontal" label="This is a label" name="1">
...
<Canvas>
  <Story name="Basic">
    <IcRadioGroup label="This is a label" name="1">
      <IcRadioOption value="valueName1" />
      <IcRadioOption value="valueName2" />
    </IcRadioGroup>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Small">
    <IcRadioGroup label="This is a label" name="1" small>
      <IcRadioOption value="valueName1" label="Unselected / Default" small />
      <IcRadioOption
        value="valueName2"
