...
<Canvas>
  ...
  >
    {(args) => {
      return (
      <>
      <IcTheme color={args.color} mode={args.mode} theme={args.theme}>
        <IcTopNavigation
        appTitle="ApplicationName"
        status="alpha"
        version="v0.0.7"
      ...
      ></IcCheckbox>
        ...
        <div style={{ border: "1px solid #ffffff", padding: "4px", margin: "4px"}}>
        <span style={{color:"#ffffff"}}>Content in here should always be dark mode</span>
        <IcTheme mode="dark">
