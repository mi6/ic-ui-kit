...
<Canvas>
  <Story name="Appearance">
    ...
    >
      <IcDivider appearance="default" weight="medium" />
      <IcDivider appearance="dark" weight="medium" />
      <div
        style={{
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <IcDivider appearance="light" weight="medium" />
      </div>
      <IcDivider appearance="theme" weight="medium" />
    </div>
  </Story>
</Canvas>
