...
import { IcDataTable, IcButton, IcEmptyState, IcTypography, IcDataTableTitleBar, IcLink } from "../components";
...
<Canvas withSource="none">
  <Story name="Custom Row Heights">
    <IcDataTable
      ...
      data={DATA}
      globalRowHeight={80}
      variableRowHeight={({ firstName, lastName }) => firstName === "Joe" || lastName === "Owens" ? 200 : null}
    />
  </Story>
</Canvas>
