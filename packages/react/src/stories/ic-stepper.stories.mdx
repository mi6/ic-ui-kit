...
<Canvas>
  <Story name="Playground"
    ...
    argTypes={{
      ...
      {(args) => (
        <div>
          <IcStepper aligned={args.aligned} variant={args.variant} connectorWidth={args.connectorWidth} hideStepInfo={args.hideStepInfo} theme={args.theme} id={args.variant === 'compact' ? 'standard-compact-stepper' : 'default-stepper'}>
            <IcStep heading="Create" type="completed" />
