...
export const ButtonStyle = () => (
  <IcSectionContainer>
    <IcTypography variant="h1">Button style</IcTypography>
    <IcTypography>
      This example shows how the button style prop works.
    </IcTypography>
  </IcSectionContainer>
);
...
<Canvas>
  ...
  >
    ...
    <div style={{ paddingTop: "var(--ic-space-md)" }}>
      <IcLink buttonStyle>
        <NavLink to="/button-style" slot="router-item">
          Button style
        </NavLink>
      </IcLink>
    </div>
    <Routes>
      ...
      <Route path="/button-style" element={<ButtonStyle />} />
    </Routes>
  </Story>
</Canvas>
