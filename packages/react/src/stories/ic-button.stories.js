  ...
  render: () => {
    ...
    return (
      ...
      >
        ...
        <IcButton aria-describedby="desc-2">Button with dynamic aria-decribedby</IcButton>
        ...
        <div id="shadow-tooltip" role="tooltip">
          <IcTypography>I'm in the shadow dom</IcTypography>
        </div>
        <IcButton aria-describedby="shadow-tooltip">Button with shadow dom describedby</IcButton>
