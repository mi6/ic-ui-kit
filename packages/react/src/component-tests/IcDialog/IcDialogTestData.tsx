...
export const DialogButtonsWithTooltip = () => {
  const dialogEl = useRef<HTMLIcDialogElement>(null);
  const handleClick = () => {
    dialogEl.current.open = true;
  };
  return (
    <>
      <IcButton onClick={handleClick} id="slotted-dialog-btn">
        Display dialog
      </IcButton>
      <IcDialog
        ref={dialogEl}
      ...
      >
        ...
        <IcTooltip label="This is a tooltip description" target="test-button">
          <IcButton id="test-button">Button with tooltip</IcButton>
        </IcTooltip>
        <IcButton
