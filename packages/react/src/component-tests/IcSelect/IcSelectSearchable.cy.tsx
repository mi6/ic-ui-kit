...
describe("IcSelect searchable end-to-end, visual regression and a11y tests", () => {
  ...
  it("should render default searchable select", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-default",
  ...
  it("should render default searchable select - open", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-default-open",
  ...
  it("should render with a default value", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-default-value-open",
  ...
  it("should render with filtering at the start", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-search-match-position-open",
  ...
  it("should render with descriptions", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-descriptions-open",
  ...
  it("should render with descriptions included in filter", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-descriptions-in-filter-open",
  ...
  it("should render with custom placeholder", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-custom-placeholder",
  ...
  it("should render with custom elements", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-custom-elements-open",
  ...
  it("should render small", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-small",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
  ...
  it("should render small - open", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-small-open",
  ...
  it("should render large", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-large",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
  ...
  it("should render large - open", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-large-open",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.029),
    });
  });
  ...
  it("should render disabled", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-disabled",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
  ...
  it("should render with disabled options", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-disabled-options-open",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.003),
    });
  });
  ...
  it("should render full width", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-full-width",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
  ...
  it("should render full width - open", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-full-width-open",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.009),
    });
  });
  ...
  it("should render with groups", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-groups-open",
  ...
  it("should render with groups included in search", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-groups-in-filter-open",
  ...
  it("should render with recommendations", () => {
    ...
    cy.checkA11yWithWait(undefined, 500);
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-recommended-open",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.009),
    });
  });
});
...
describe("IcSelect searchable visual regression tests in high contrast mode", () => {
  ...
  it("should render with recommendations in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-recommended-open-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.002),
    });
  });
  ...
  it("should render with groups included in search in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-groups-in-filter-open-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.003),
    });
  });
  ...
  it("should render with disabled options in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-disabled-options-open-high-contrast",
  ...
  it("should render with descriptions in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcSelectSearchable/searchable-descriptions-open-high-contrast",
