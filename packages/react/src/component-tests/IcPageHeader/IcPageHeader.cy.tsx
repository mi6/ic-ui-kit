...
describe("IcPageHeader", () => {
  ...
  it("should stay at the top of the page if the sticky variant is used", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/sticky-variant",
  ...
  it("should not stay on top for viewport extra small if stickyDesktopOnly prop is used", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/desktop-only-after-scroll",
  ...
  it("should render center aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/center-page-header",
  ...
  it("should render full width", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/full-width-page-header",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.006),
    });
  });
  ...
  it("should render without border", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/without-border",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.006),
    });
  });
  ...
  it("should render with actions, input and tabs", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/with-action-input-tab",
  ...
  it("should render with actions, input and stepper", () => {
    ...
    cy.compareSnapshot({
      name: "IcPageHeader/with-action-input-step",
  ...
  it("should render with breadcrumbs", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/with-breadcrumb",
  ...
  it("should render with slotted headings", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcPageHeader/with-slotted-headings",
  ...
  describe("IcPageHeader visual regression in high contrast mode", () => {
    ...
    it("should render", () => {
      mount(<PageHeaderDefault />);
      cy.compareSnapshot({
        name: "IcPageHeader/default-high-contrast",
    ...
    it("should render with actions, input and tabs", () => {
      mount(<PageHeaderWithActionsInputTabs />);
      cy.compareSnapshot({
        name: "IcPageHeader/actions-input-tabs-high-contrast",
    ...
    it("should render with breadcrumbs", () => {
      mount(<PageHeaderWithBreadcrumbNav />);
      cy.compareSnapshot({
        name: "IcPageHeader/breadcrumbs-high-contrast",
    ...
    it("should render with stepper", () => {
      mount(<PageHeaderWithStepper />);
      cy.compareSnapshot({
        name: "IcPageHeader/stepper-high-contrast",
