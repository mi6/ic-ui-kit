...
describe("IcTopNavigation desktop visual regression tests", () => {
  ...
  it("should render app icon and title", () => {
    ...
    cy.compareSnapshot({
      name: "/app-icon-title",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.28),
    });
  });
  ...
  it("should render search", () => {
    ...
    cy.compareSnapshot({
      name: "/search",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.26),
    });
  });
  ...
  it("should render with long text values", () => {
    ...
    cy.compareSnapshot({
      name: "/long-text",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.25),
    });
  });
  ...
  it("should render with navigation items", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.35),
    });
  });
  ...
  it("should render IcNavigationGroup correctly when it is included in IcHorizontalScroll", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.36),
    });
  });
  ...
  it("should render app icon and title", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.27
      ),
    });
  });
...
describe("IcTopNavigation mobile visual regression tests in high contrast mode", () => {
  ...
  it("should render with navigation items in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.041
      ),
    });
  });
  ...
  it("should render with menu open in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.058
      ),
    });
  });
});
