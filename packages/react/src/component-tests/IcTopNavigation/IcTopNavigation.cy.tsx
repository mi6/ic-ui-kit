...
describe("IcTopNavigation Desktop Visual Regression Testing", () => {
  ...
  it("renders with long single-word app title", () => {
    ...
    cy.compareSnapshot("long-single-word-app-title", DEFAULT_TEST_THRESHOLD + 0.02);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
  ...
  it("renders with slotted navigation items", () => {
    ...
    cy.compareSnapshot("slotted-navigation-items", DEFAULT_TEST_THRESHOLD + 0.02);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
...
describe("IcTopNavigation Mobile Visual Regression Testing", () => {
  ...
  it("renders with long text values", () => {
    ...
    cy.compareSnapshot("mobile-long-text", DEFAULT_TEST_THRESHOLD_MOBILE + 0.01);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
  ...
  it("renders with long single-word app title", () => {
    ...
    cy.compareSnapshot("mobile-long-single-word-app-title", DEFAULT_TEST_THRESHOLD_MOBILE);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
  ...
  it("renders with navigation items", () => {
    ...
    cy.compareSnapshot("mobile-navigation-items", DEFAULT_TEST_THRESHOLD_MOBILE);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
  ...
  it("renders with slotted navigation items", () => {
    ...
    cy.compareSnapshot("mobile-slotted-navigation-items", DEFAULT_TEST_THRESHOLD_MOBILE);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
  ...
  it("renders with navigation group", () => {
    ...
    cy.compareSnapshot("mobile-navigation-group", DEFAULT_TEST_THRESHOLD_MOBILE);
    cy.checkA11y(undefined, CYPRESS_AXE_OPTIONS);
  });
  ...
  it("renders with menu open", () => {
    ...
    cy.compareSnapshot("mobile-open-menu", DEFAULT_TEST_THRESHOLD_MOBILE + 0.02);
