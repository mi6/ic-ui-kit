...
describe("IcTopNavigation desktop visual regression tests", () => {
  ...
  it("should render app icon and title", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/app-icon-title",
  ...
  it("should render status and version", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/status-version",
  ...
  it("should render icon buttons", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/icon-buttons",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.004),
    });
  });
  ...
  it("should render with long text values", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/long-text",
  ...
  it("should render with long single-word app title", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/long-single-word-app-title",
  ...
  it("should render with navigation items", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/navigation-items",
  ...
  it("should render with slotted navigation items", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/slotted-navigation-items",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.025),
    });
  });
  ...
  it("should render with navigation group", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/navigation-group",
  ...
  it("should render with content centre aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/content-centre",
  ...
  it("should render with content left aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/content-left",
  ...
  it("should render IcNavigationGroup correctly when it is included in IcHorizontalScroll", () => {
    ...
    //cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/nav-group-in-horizontal-scroll",
...
describe("IcTopNavigation mobile visual regression tests", () => {
  ...
  it("should render app icon and title", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-app-icon-title",
  ...
  it("should render status and version", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-status-version",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.004
      ),
    });
  ...
  it("should render search", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-search",
      testThreshold: setThresholdBasedOnEnv(
  ...
  it("should render icon buttons", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-icon-buttons",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.009
      ),
    });
  ...
  it("should render with long text values", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-long-text",
      testThreshold: setThresholdBasedOnEnv(
  ...
  it("should render with long single-word app title", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-long-single-word-app-title",
  ...
  it("should render with navigation items", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-navigation-items",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.009
      ),
    });
  ...
  it("should render with slotted navigation items", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-slotted-navigation-items",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.009
      ),
    });
  ...
  it("should render with navigation group", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-navigation-group",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.009
      ),
    });
  ...
  it("should render with menu open", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-open-menu",
      testThreshold: setThresholdBasedOnEnv(
  ...
  it("should render with content centre aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-content-centre",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.009
      ),
    });
  ...
  it("should render with content left aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-content-left",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.009
      ),
    });
  ...
  it("should render with different theme color - mobile", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-theme",
      testThreshold: setThresholdBasedOnEnv(
...
describe("IcTopNavigation desktop visual regression tests in high contrast mode", () => {
  ...
  it("should render with navigation items in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/navigation-items-high-contrast",
  ...
  it("should render with slotted navigation items in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/slotted-navigation-items-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.029),
    });
  });
  ...
  it("should render icon buttons in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/icon-buttons-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.004),
    });
  });
  ...
  it("should render IcNavigationGroup correctly when it is included in IcHorizontalScroll in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/nav-group-in-horizontal-scroll-high-contrast",
...
describe("IcTopNavigation mobile visual regression tests in high contrast mode", () => {
  ...
  it.skip("should render with navigation items in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-navigation-items-high-contrast",
      testThreshold: setThresholdBasedOnEnv(
  ...
  it("should render with menu open in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcTopNavigation/mobile-open-menu-high-contrast",
      testThreshold: setThresholdBasedOnEnv(
