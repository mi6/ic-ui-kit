...
describe("IcNavigationMenu end-to-end and visual regression tests", () => {
  ...
  describe("Within a top navigation", () => {
    it("should render with expandable navigation groups and navigation items", () => {
      ...
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-expandable-nav-groups-top-nav",
    ...
    it("should render with expandable navigation groups and navigation items - expanded", () => {
      ...
      cy.wait(250).compareSnapshot({
        name: "IcNavigationMenu/with-expandable-nav-groups-top-nav-expanded",
    ...
    it("should render focus state on expandable navigation groups", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/expandable-nav-group-focused-top-nav",
    ...
    it("should render with focus state on navigation item within expandable navigation group", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/nav-item-within-expandable-nav-group-focused-top-nav",
    ...
    it("should render with navigation groups and navigation items", () => {
      ...
      //cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-nav-groups-top-nav",
    ...
    it.skip("should render focus state on navigation group", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/nav-group-focused-top-nav",
    ...
    it("should render navigation items with slotted content", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-nav-items-top-nav",
    ...
    it("should render focus state on navigation item", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/nav-item-focused-top-nav",
        testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
      });
    });
    ...
    it("should render with navigation buttons", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-nav-buttons-top-nav",
    ...
    it("should render focus state on navigation button", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/nav-button-focused-top-nav",
  ...
  describe("Within a side navigation", () => {
    it("should render with expandable navigation groups and navigation items", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-expandable-nav-groups-side-nav",
    ...
    it("should render with expandable navigation groups and navigation items - expanded", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-expandable-nav-groups-side-nav-expanded",
    ...
    it("should render focus state on expandable navigation group", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/expandable-nav-group-focused-side-nav",
        testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.023),
      });
    });
    ...
    it("should render focus state on navigation item within expandable navigation group", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/nav-item-within-expandable-nav-group-focused-side-nav",
        testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.023),
      });
    });
    ...
    it("should render with navigation groups and navigation items", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-nav-groups-side-nav",
        testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.023),
      });
    });
    ...
    it("should render navigation items with slotted content", () => {
      ...
      cy.checkA11yWithWait(undefined, 250);
      cy.compareSnapshot({
        name: "IcNavigationMenu/with-nav-items-side-nav",
        testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.005),
      });
    });
...
describe("IcNavigationMenu visual regression tests in high contrast mode", () => {
  ...
  it("should render within top navigation in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcNavigationMenu/all-nav-types-top-nav-high-contrast",
  ...
  it("should render with focus state within top navigation in high contrast mode", () => {
    ...
    cy.wait(250).compareSnapshot({
      name: "IcNavigationMenu/nav-group-top-nav-focused-high-contrast",
  ...
  it("should render within side navigation in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcNavigationMenu/all-nav-types-side-nav-high-contrast",
  ...
  it("should render with focus state within side navigation in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcNavigationMenu/nav-group-side-nav-focused-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.034),
    });
  });
});
