...
describe("IcEmptyState end-to-end, visual regression and a11y tests", () => {
  ...
  it("should render basic empty state", () => {
    ...
    cy.compareSnapshot({
      name: "IcEmptyState/basic-desktop",
  ...
  it("should render with a slotted image", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcEmptyState/slotted-image",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
  ...
  it("should render right aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcEmptyState/right-aligned",
  ...
  it("should render center aligned", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcEmptyState/center-aligned",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.015),
    });
  });
  ...
  it("should render with truncated text when bodyMaxLines prop is set - before click", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcEmptyState/truncated-text",
  ...
  it("should render with truncated text when bodyMaxLines prop is set - after click", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcEmptyState/truncated-text-after-click",
  ...
  it("should render with slotted content", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcEmptyState/slotted-content",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.02),
    });
  });
});
...
describe("IcEmptyState visual regression tests in high contrast mode", () => {
  ...
  it("should render basic empty state in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcEmptyState/basic-desktop-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.015),
    });
  });
  ...
  it("should render with truncated text when bodyMaxLines prop is set - before click", () => {
    ...
    cy.compareSnapshot({
      name: "IcEmptyState/truncated-text-high-contrast",
