...
describe("IcTextField visual regression tests", () => {
  ...
  it("should render a text field with icon, value and max length", () => {
    ...
    cy.compareSnapshot({
      name: "IcTextField/icon-value-max-length",
    ...
    cy.get(IC_TEXTFIELD)
      ...
      .then(() => {
        cy.checkA11yWithWait(undefined, 500);
        cy.compareSnapshot({
          name: "IcTextField/icon-value-max-length-exceeded",
  ...
  it("should render a text field with custom max length message", () => {
    ...
    cy.get(IC_TEXTFIELD)
      ...
      .then(() => {
        cy.checkA11yWithWait(undefined, 500);
        cy.compareSnapshot({
          name: "IcTextField/max-length-message",
  ...
  it("should render a small text field", () => {
    ...
    cy.compareSnapshot({
      name: "IcTextField/small-text-field",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.03),
    });
  });
  ...
  it("should render a full width text field", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTextField/full-width-text-field",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.03),
    });
  });
  ...
  it("should render a multiline text field", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTextField/multiline-text-area-with-resize",
  ...
  it("should render text field with inline validation with status of success", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTextField/inline-validation-text-field",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.03),
    });
  });
  ...
  it("should render validation status and text", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTextField/validation-text-field",
  ...
  it("should render a readonly text field", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTextField/readonly-text-field",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.028),
    });
  });
  ...
  it("should render a custom text field", () => {
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "IcTextField/custom-text-field",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.03),
    });
  });
  ...
  it("should render a text field with input focused", () => {
    ...
    cy.compareSnapshot({
      name: "IcTextField/focused-input-text-field",
...
describe("IcTextField visual regression in high contrast mode", () => {
  ...
  it("renders a text field with input focused", () => {
    ...
    cy.compareSnapshot({
      name: "IcTextField/focused-input-text-field-high-contrast",
  ...
  it("renders disabled", () => {
    ...
    cy.wait(100).compareSnapshot({
      name: "IcTextField/disabled-text-field-high-contrast",
  ...
  it("renders a readonly text field", () => {
    ...
    cy.wait(100).compareSnapshot({
      name: "IcTextField/readonly-text-field-high-contrast",
  ...
  it("renders validation status and text", () => {
    ...
    cy.wait(100).compareSnapshot({
      name: "IcTextField/validation-text-field-high-contrast",
