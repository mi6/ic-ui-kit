    ...
    describe("Mobile visual regression and a11y tests", () => {
      ...
      it("should not display as top bar when disableTopBarBehaviour prop is set", () => {
        ...
        cy.compareSnapshot({
          ...
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.31),
        });
      });
      ...
      it("should render with a different theme", () => {
        ...
        cy.compareSnapshot({
          name: "/theme",
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.3),
        });
      });
      ...
      it("should render with a different theme - open", () => {
        ...
        cy.compareSnapshot({
          name: "/theme-open",
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.77),
        });
      });
    });
  });
  ...
  describe("Desktop", () => {
    ...
    describe("Desktop visual regression and a11y tests", () => {
      ...
      it("should render a default IcSideNavigation", () => {
        ...
        cy.compareSnapshot({
          name: "/basic-desktop",
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.24),
        });
      });
      ...
      it("should render a default IcSideNavigation - open", () => {
        ...
        cy.compareSnapshot({
          ...
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.56),
        });
      });
      ...
      it("should render a long status and version", () => {
        ...
        cy.compareSnapshot({
          ...
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.54),
        });
      });
      ...
      it("should render with an IcNavigationGroup", () => {
        ...
        cy.compareSnapshot({
          ...
          testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.55),
        });
      });
...
describe("Mobile visual regression tests in high contrast mode", () => {
  ...
  it("should render with an IcNavigationGroup in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.088),
    });
  });
