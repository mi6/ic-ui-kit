...
describe("IcToggleButton visual regression and a11y tests", () => {
  ...
  it("should render with badge", () => {
    ...
    cy.compareSnapshot({
      name: "IcToggleButton/with-badge",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.014),
    });
  });
  ...
  it("should render full width", () => {
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/full-width",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.014),
    });
  });
  ...
  it("should render icon variant", () => {
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/icon-variant",
  ...
  it("should render with icon placement right", () => {
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/icon-right",
  ...
  it("should render various tooltip placements", () => {
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/tooltip-placement-right",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/tooltip-placement-top",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/tooltip-placement-left",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
  ...
  it("should render with appearance set to dark", () => {
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/appearance-dark",
  ...
  it("should render with appearance set to light", () => {
    ...
    cy.checkA11yWithWait(undefined, undefined, TOGGLE_BUTTON_AXE_OPTIONS);
    cy.compareSnapshot({
      name: "IcToggleButton/appearance-light",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.029),
    });
  });
});
...
describe("IcToggleButton visual regression tests in high contrast mode", () => {
  ...
  it("should render default in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcToggleButton/default-high-contrast",
  ...
  it("should render checked in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcToggleButton/checked-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.013),
    });
  });
  ...
  it("should render disabled in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcToggleButton/disabled-high-contrast",
  ...
  it("should render loading in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcToggleButton/loading-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.02),
    });
  });
  ...
  it("should render icon variant in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      name: "IcToggleButton/icon-variant-high-contrast",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD),
    });
  });
});
